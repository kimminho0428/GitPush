 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cousr02cWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter Cousr02cWsCurdateData wsCurdateData = new Cousr02cWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter Cousr02cWsCurdateMmDdYy wsCurdateMmDdYy = new Cousr02cWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter Cousr02cWsCurtimeHhMmSs wsCurtimeHhMmSs = new Cousr02cWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter Cousr02cWsTimestamp wsTimestamp = new Cousr02cWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr02cWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter Cousr02cWsCurdate wsCurdate = new Cousr02cWsCurdate();
        ...
        private @Getter @Setter Cousr02cWsCurtime wsCurtime = new Cousr02cWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cousr02cWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cousr02cWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr02cWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr02cWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr02cWsTimestamp {
