 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cbtrn02cXreffileStatus {
    // [T-Up#INFO][CBTRN02C.cbl, LINE #137] XREFFILE-STAT1 (level: 5)
    private @Getter String xreffileStat1 = StringUtils.repeat(' ', 1);
    // [T-Up#INFO][CBTRN02C.cbl, LINE #138] XREFFILE-STAT2 (level: 5)
