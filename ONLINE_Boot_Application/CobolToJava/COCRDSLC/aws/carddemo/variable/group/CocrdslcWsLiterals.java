...
public @AllArgsConstructor @NoArgsConstructor class CocrdslcWsLiterals {
    // [T-Up#INFO][COCRDSLC.cbl, LINE #163] LIT-THISPGM (level: 5)
    private @Getter String litThispgm = "COCRDSLC";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #165] LIT-THISTRANID (level: 5)
    private @Getter String litThistranid = "CCDL";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #167] LIT-THISMAPSET (level: 5)
    private @Getter String litThismapset = "COCRDSL ";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #169] LIT-THISMAP (level: 5)
    private @Getter String litThismap = "CCRDSLA";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #171] LIT-CCLISTPGM (level: 5)
    private @Getter String litCclistpgm = "COCRDLIC";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #173] LIT-CCLISTTRANID (level: 5)
    private @Getter String litCclisttranid = "CCLI";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #175] LIT-CCLISTMAPSET (level: 5)
    private @Getter String litCclistmapset = "COCRDLI";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #177] LIT-CCLISTMAP (level: 5)
    private @Getter String litCclistmap = "CCRDSLA";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #179] LIT-MENUPGM (level: 5)
    private @Getter String litMenupgm = "COMEN01C";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #181] LIT-MENUTRANID (level: 5)
    private @Getter String litMenutranid = "CM00";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #183] LIT-MENUMAPSET (level: 5)
    private @Getter String litMenumapset = "COMEN01";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #185] LIT-MENUMAP (level: 5)
    private @Getter String litMenumap = "COMEN1A";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #187] LIT-CARDFILENAME (level: 5)
    private @Getter String litCardfilename = "CARDDAT ";
    // [T-Up#INFO][COCRDSLC.cbl, LINE #189] LIT-CARDFILENAME-ACCT-PATH (level: 5)
