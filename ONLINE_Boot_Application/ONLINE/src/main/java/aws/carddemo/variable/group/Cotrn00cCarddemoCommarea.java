...
public @AllArgsConstructor @NoArgsConstructor class Cotrn00cCarddemoCommarea {
    ...
    // *                                                                 
    // [T-Up#INFO][COTRN00C.cbl, LINE #62] CDEMO-CT00-INFO (level: 5)
    ...
    public void set(String source) {
        ...
        cdemoCt00Info.set(source.substring(160, 218));
    }
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cotrn00cCdemoCt00Info {
        // [T-Up#INFO][COTRN00C.cbl, LINE #63] CDEMO-CT00-TRNID-FIRST (level: 10)
        private @Getter String cdemoCt00TrnidFirst = StringUtils
                .repeat(' ', 16);
        // [T-Up#INFO][COTRN00C.cbl, LINE #64] CDEMO-CT00-TRNID-LAST (level: 10)
        private @Getter String cdemoCt00TrnidLast = StringUtils.repeat(' ', 16);
        // [T-Up#INFO][COTRN00C.cbl, LINE #65] CDEMO-CT00-PAGE-NUM (level: 10)
        private @Getter @Setter int cdemoCt00PageNum;
        // [T-Up#INFO][COTRN00C.cbl, LINE #66] CDEMO-CT00-NEXT-PAGE-FLG (level: 10)
        private @Getter String cdemoCt00NextPageFlg = "N";
        // [T-Up#INFO][COTRN00C.cbl, LINE #67] NEXT-PAGE-YES (level: 88)
        public static final String NEXT_PAGE_YES = "Y";
        // [T-Up#INFO][COTRN00C.cbl, LINE #68] NEXT-PAGE-NO (level: 88)
        public static final String NEXT_PAGE_NO = "N";
        // [T-Up#INFO][COTRN00C.cbl, LINE #69] CDEMO-CT00-TRN-SEL-FLG (level: 10)
        private @Getter String cdemoCt00TrnSelFlg = StringUtils.repeat(' ', 1);
        // [T-Up#INFO][COTRN00C.cbl, LINE #70] CDEMO-CT00-TRN-SELECTED (level: 10)
        ...
        public void set(String source) {
            ...
            cdemoCt00TrnidFirst = source.substring(0, 16);
            cdemoCt00TrnidLast = source.substring(16, 32);
            try {
                cdemoCt00PageNum = (int) DataConverter.convZonedStringToLong(
                        source.substring(32, 40), 8);
            } catch (NumberFormatException exception) {
                exception.printStackTrace();
                cdemoCt00PageNum = 0;
            }
            cdemoCt00NextPageFlg = source.substring(40, 41);
            cdemoCt00TrnSelFlg = source.substring(41, 42);
            cdemoCt00TrnSelected = source.substring(42, 58);
        }

        public String get() {
            StringBuilder sb = new StringBuilder();
            sb.append(cdemoCt00TrnidFirst);
            sb.append(cdemoCt00TrnidLast);
            sb.append(DataConverter.convZonedLongToString(cdemoCt00PageNum, 8));
            sb.append(cdemoCt00NextPageFlg);
            sb.append(cdemoCt00TrnSelFlg);
            sb.append(cdemoCt00TrnSelected);
            return sb.toString();
        }
        ...
        public String toString() {
            ...
            sb.append(PictureFormatter.intFormatWithoutSign(
                    (long) cdemoCt00PageNum, "00000000"));
