...
public class Cousr01cVariableContainer {
    ...
    // *----------------------------------------------------------------*
    // [T-Up#INFO][COUSR01C.cbl, LINE #35] WS-VARIABLES (level: 1)
    ...
    private @Getter @Setter Cousr01cCarddemoCommarea carddemoCommarea = new Cousr01cCarddemoCommarea();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:15:57 CDT 
    // *                                                                 
    //       *COPY COUSR01.                                                    
    // *(/home/oflab/repository/ref/COBOL_COPYBOOK/CARDDEMO/COUSR01.CPY) 
    // ******************************************************************
    // * Copyright Amazon.com, Inc. or its affiliates.                   
    // * All Rights Reserved.                                            
    // *                                                                 
    ...
    // * language governing permissions and limitations under the License
    // ******************************************************************
    // [T-Up#INFO][COUSR01.CPY, LINE #18] COUSR1AI (level: 1)
    private @Getter @Setter Cousr01cCousr1ai cousr1ai = new Cousr01cCousr1ai();

    public Cousr01cCousr1ao getCousr1ao() {
        return Cousr01cCousr1ao.builder().OFFILLER1(getOFFILLER1())
                ...
                .OFFILLER8(getOFFILLER8()).fnamec(getFnamec())
                .fnamep(getFnamep()).fnameh(getFnameh()).fnamev(getFnamev())
                .fnameo(getFnameo()).OFFILLER9(getOFFILLER9())
                .lnamec(getLnamec()).lnamep(getLnamep()).lnameh(getLnameh())
                .lnamev(getLnamev()).lnameo(getLnameo())
                .OFFILLER10(getOFFILLER10()).useridc(getUseridc())
                .useridp(getUseridp()).useridh(getUseridh())
                .useridv(getUseridv()).userido(getUserido())
    ...
    public void setCousr1ao(String source) {
        ...
        setOFFILLER9(source.substring(189, 192));
        ...
        setOFFILLER10(source.substring(216, 219));
    ...
    public void setOFFILLER2(String source) {
        ...
        try {
            ...
            tempByteBuffer1.flip();
            getCousr1ai().setTrnnamel(tempByteBuffer1.getShort());
    ...
    public String getTrnnamec() {
        return getCousr1ai().getOFFILLER3().substring(0, 1);
    }

    public void setTrnnamec(String source) {
        getCousr1ai()
                .setOFFILLER3(
                        StringUtils.overlay(getCousr1ai().getOFFILLER3(),
                                source, 0, 1));
    }

    public String getTrnnamep() {
        return getCousr1ai().getOFFILLER3().substring(1, 2);
    }
    ...
    public String getTrnnameh() {
        return getCousr1ai().getOFFILLER3().substring(2, 3);
    }
    ...
    public String getTrnnamev() {
        return getCousr1ai().getOFFILLER3().substring(3);
    }
    ...
    public String getOFFILLER3() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr1ai().getTitle01l());
        tempByteBuffer1.flip();
        String temp2 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp2 + getCousr1ai().getTitle01f();
    }
    ...
    public void setOFFILLER3(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr1ai().setTitle01l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getTitle01c() {
        return getCousr1ai().getOFFILLER5().substring(0, 1);
    }

    public void setTitle01c(String source) {
        getCousr1ai()
                .setOFFILLER5(
                        StringUtils.overlay(getCousr1ai().getOFFILLER5(),
                                source, 0, 1));
    }

    public String getTitle01p() {
        return getCousr1ai().getOFFILLER5().substring(1, 2);
    }
    ...
    public String getTitle01h() {
        return getCousr1ai().getOFFILLER5().substring(2, 3);
    }
    ...
    public String getTitle01v() {
        return getCousr1ai().getOFFILLER5().substring(3);
    }
    ...
    public String getOFFILLER4() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr1ai().getCurdatel());
        tempByteBuffer1.flip();
        String temp3 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp3 + getCousr1ai().getCurdatef();
    }
    ...
    public void setOFFILLER4(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr1ai().setCurdatel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getCurdatec() {
        return getCousr1ai().getOFFILLER7().substring(0, 1);
    }

    public void setCurdatec(String source) {
        getCousr1ai()
                .setOFFILLER7(
                        StringUtils.overlay(getCousr1ai().getOFFILLER7(),
                                source, 0, 1));
    }

    public String getCurdatep() {
        return getCousr1ai().getOFFILLER7().substring(1, 2);
    }
    ...
    public String getCurdateh() {
        return getCousr1ai().getOFFILLER7().substring(2, 3);
    }
    ...
    public String getCurdatev() {
        return getCousr1ai().getOFFILLER7().substring(3);
    }
    ...
    public String getOFFILLER5() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr1ai().getPgmnamel());
        tempByteBuffer1.flip();
        String temp4 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp4 + getCousr1ai().getPgmnamef();
    }
    ...
    public void setOFFILLER5(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr1ai().setPgmnamel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getPgmnamec() {
        return getCousr1ai().getOFFILLER9().substring(0, 1);
    }

    public void setPgmnamec(String source) {
        getCousr1ai()
                .setOFFILLER9(
                        StringUtils.overlay(getCousr1ai().getOFFILLER9(),
                                source, 0, 1));
    }

    public String getPgmnamep() {
        return getCousr1ai().getOFFILLER9().substring(1, 2);
    }
    ...
    public String getPgmnameh() {
        return getCousr1ai().getOFFILLER9().substring(2, 3);
    }
    ...
    public String getPgmnamev() {
        return getCousr1ai().getOFFILLER9().substring(3);
    }
    ...
    public String getOFFILLER6() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr1ai().getTitle02l());
        tempByteBuffer1.flip();
        String temp5 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp5 + getCousr1ai().getTitle02f();
    }
    ...
    public void setOFFILLER6(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr1ai().setTitle02l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getTitle02c() {
        return getCousr1ai().getOFFILLER11().substring(0, 1);
    }

    public void setTitle02c(String source) {
        getCousr1ai().setOFFILLER11(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER11(), source, 0, 1));
    }

    public String getTitle02p() {
        return getCousr1ai().getOFFILLER11().substring(1, 2);
    }

    public void setTitle02p(String source) {
        getCousr1ai().setOFFILLER11(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER11(), source, 1, 2));
    }

    public String getTitle02h() {
        return getCousr1ai().getOFFILLER11().substring(2, 3);
    }

    public void setTitle02h(String source) {
        getCousr1ai().setOFFILLER11(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER11(), source, 2, 3));
    }

    public String getTitle02v() {
        return getCousr1ai().getOFFILLER11().substring(3);
    }

    public void setTitle02v(String source) {
        getCousr1ai().setOFFILLER11(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER11(), source, 3, 4));
    }
    ...
    public String getOFFILLER7() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr1ai().getCurtimel());
        tempByteBuffer1.flip();
        String temp6 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp6 + getCousr1ai().getCurtimef();
    }
    ...
    public void setOFFILLER7(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr1ai().setCurtimel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getCurtimec() {
        return getCousr1ai().getOFFILLER13().substring(0, 1);
    }

    public void setCurtimec(String source) {
        getCousr1ai().setOFFILLER13(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER13(), source, 0, 1));
    }

    public String getCurtimep() {
        return getCousr1ai().getOFFILLER13().substring(1, 2);
    }

    public void setCurtimep(String source) {
        getCousr1ai().setOFFILLER13(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER13(), source, 1, 2));
    }

    public String getCurtimeh() {
        return getCousr1ai().getOFFILLER13().substring(2, 3);
    }

    public void setCurtimeh(String source) {
        getCousr1ai().setOFFILLER13(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER13(), source, 2, 3));
    }

    public String getCurtimev() {
        return getCousr1ai().getOFFILLER13().substring(3);
    }

    public void setCurtimev(String source) {
        getCousr1ai().setOFFILLER13(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER13(), source, 3, 4));
    }
    ...
    public String getOFFILLER8() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr1ai().getFnamel());
        tempByteBuffer1.flip();
        String temp7 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp7 + getCousr1ai().getFnamef();
    }
    ...
    public void setOFFILLER8(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr1ai().setFnamel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getFnamec() {
        return getCousr1ai().getOFFILLER15().substring(0, 1);
    }

    public void setFnamec(String source) {
        getCousr1ai().setOFFILLER15(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER15(), source, 0, 1));
    }

    public String getFnamep() {
        return getCousr1ai().getOFFILLER15().substring(1, 2);
    }

    public void setFnamep(String source) {
        getCousr1ai().setOFFILLER15(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER15(), source, 1, 2));
    }

    public String getFnameh() {
        return getCousr1ai().getOFFILLER15().substring(2, 3);
    }

    public void setFnameh(String source) {
        getCousr1ai().setOFFILLER15(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER15(), source, 2, 3));
    }

    public String getFnamev() {
        return getCousr1ai().getOFFILLER15().substring(3);
    }

    public void setFnamev(String source) {
        getCousr1ai().setOFFILLER15(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER15(), source, 3, 4));
    }
    ...
    public String getOFFILLER9() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr1ai().getLnamel());
        tempByteBuffer1.flip();
        String temp8 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp8 + getCousr1ai().getLnamef();
    }
    ...
    public void setOFFILLER9(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr1ai().setLnamel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getLnamec() {
        return getCousr1ai().getOFFILLER17().substring(0, 1);
    }

    public void setLnamec(String source) {
        getCousr1ai().setOFFILLER17(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER17(), source, 0, 1));
    }

    public String getLnamep() {
        return getCousr1ai().getOFFILLER17().substring(1, 2);
    }

    public void setLnamep(String source) {
        getCousr1ai().setOFFILLER17(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER17(), source, 1, 2));
    }

    public String getLnameh() {
        return getCousr1ai().getOFFILLER17().substring(2, 3);
    }

    public void setLnameh(String source) {
        getCousr1ai().setOFFILLER17(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER17(), source, 2, 3));
    }

    public String getLnamev() {
        return getCousr1ai().getOFFILLER17().substring(3);
    }

    public void setLnamev(String source) {
        getCousr1ai().setOFFILLER17(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER17(), source, 3, 4));
    }
    ...
    public String getOFFILLER10() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr1ai().getUseridl());
        tempByteBuffer1.flip();
        String temp9 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp9 + getCousr1ai().getUseridf();
    }
    ...
    public void setOFFILLER10(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr1ai().setUseridl(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getUseridc() {
        return getCousr1ai().getOFFILLER19().substring(0, 1);
    }

    public void setUseridc(String source) {
        getCousr1ai().setOFFILLER19(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER19(), source, 0, 1));
    }

    public String getUseridp() {
        return getCousr1ai().getOFFILLER19().substring(1, 2);
    }

    public void setUseridp(String source) {
        getCousr1ai().setOFFILLER19(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER19(), source, 1, 2));
    }

    public String getUseridh() {
        return getCousr1ai().getOFFILLER19().substring(2, 3);
    }

    public void setUseridh(String source) {
        getCousr1ai().setOFFILLER19(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER19(), source, 2, 3));
    }

    public String getUseridv() {
        return getCousr1ai().getOFFILLER19().substring(3);
    }

    public void setUseridv(String source) {
        getCousr1ai().setOFFILLER19(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER19(), source, 3, 4));
    }
    ...
    public String getOFFILLER11() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr1ai().getPasswdl());
        tempByteBuffer1.flip();
        String temp10 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp10 + getCousr1ai().getPasswdf();
    }
    ...
    public void setOFFILLER11(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr1ai().setPasswdl(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getPasswdc() {
        return getCousr1ai().getOFFILLER21().substring(0, 1);
    }

    public void setPasswdc(String source) {
        getCousr1ai().setOFFILLER21(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER21(), source, 0, 1));
    }

    public String getPasswdp() {
        return getCousr1ai().getOFFILLER21().substring(1, 2);
    }

    public void setPasswdp(String source) {
        getCousr1ai().setOFFILLER21(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER21(), source, 1, 2));
    }

    public String getPasswdh() {
        return getCousr1ai().getOFFILLER21().substring(2, 3);
    }

    public void setPasswdh(String source) {
        getCousr1ai().setOFFILLER21(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER21(), source, 2, 3));
    }

    public String getPasswdv() {
        return getCousr1ai().getOFFILLER21().substring(3);
    }

    public void setPasswdv(String source) {
        getCousr1ai().setOFFILLER21(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER21(), source, 3, 4));
    }
    ...
    public String getOFFILLER12() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr1ai().getUsrtypel());
        tempByteBuffer1.flip();
        String temp11 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp11 + getCousr1ai().getUsrtypef();
    }
    ...
    public void setOFFILLER12(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr1ai().setUsrtypel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getUsrtypec() {
        return getCousr1ai().getOFFILLER23().substring(0, 1);
    }

    public void setUsrtypec(String source) {
        getCousr1ai().setOFFILLER23(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER23(), source, 0, 1));
    }

    public String getUsrtypep() {
        return getCousr1ai().getOFFILLER23().substring(1, 2);
    }

    public void setUsrtypep(String source) {
        getCousr1ai().setOFFILLER23(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER23(), source, 1, 2));
    }

    public String getUsrtypeh() {
        return getCousr1ai().getOFFILLER23().substring(2, 3);
    }

    public void setUsrtypeh(String source) {
        getCousr1ai().setOFFILLER23(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER23(), source, 2, 3));
    }

    public String getUsrtypev() {
        return getCousr1ai().getOFFILLER23().substring(3);
    }

    public void setUsrtypev(String source) {
        getCousr1ai().setOFFILLER23(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER23(), source, 3, 4));
    }
    ...
    public String getOFFILLER13() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr1ai().getErrmsgl());
        tempByteBuffer1.flip();
        String temp12 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp12 + getCousr1ai().getErrmsgf();
    }
    ...
    public void setOFFILLER13(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr1ai().setErrmsgl(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getErrmsgc() {
        return getCousr1ai().getOFFILLER25().substring(0, 1);
    }

    public void setErrmsgc(String source) {
        getCousr1ai().setOFFILLER25(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER25(), source, 0, 1));
    }

    public String getErrmsgp() {
        return getCousr1ai().getOFFILLER25().substring(1, 2);
    }

    public void setErrmsgp(String source) {
        getCousr1ai().setOFFILLER25(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER25(), source, 1, 2));
    }

    public String getErrmsgh() {
        return getCousr1ai().getOFFILLER25().substring(2, 3);
    }

    public void setErrmsgh(String source) {
        getCousr1ai().setOFFILLER25(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER25(), source, 2, 3));
    }

    public String getErrmsgv() {
        return getCousr1ai().getOFFILLER25().substring(3);
    }

    public void setErrmsgv(String source) {
        getCousr1ai().setOFFILLER25(
                StringUtils
                        .overlay(getCousr1ai().getOFFILLER25(), source, 3, 4));
    }
    ...
    private @Getter @Setter Cousr01cCcdaScreenTitle ccdaScreenTitle = new Cousr01cCcdaScreenTitle();
    // *                                                                 
    ...
    private @Getter @Setter Cousr01cWsDateTime wsDateTime = new Cousr01cWsDateTime();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:15:58 CDT 
    // *                                                                 
    //       *COPY CSMSG01Y.                                                   
    ...
    private @Getter @Setter Cousr01cCcdaCommonMessages ccdaCommonMessages = new Cousr01cCcdaCommonMessages();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:15:58 CDT 
    // *                                                                 
    //       *COPY CSUSR01Y.                                                   
    ...
    private @Getter @Setter Cousr01cSecUserData secUserData = new Cousr01cSecUserData();
    // *                                                                 
    ...
    private @Getter @Setter Cousr01cDfhaid dfhaid = new Cousr01cDfhaid();
    //       *COPY DFHBMSCA.                                                   
    // *(/home/oflab/repository/ref/COBOL_COPYBOOK/.default/DFHBMSCA.cpy)
    // [T-Up#INFO][DFHBMSCA.cpy, LINE #2] DFHBMSCA (level: 1)
    private @Getter @Setter Cousr01cDfhbmsca dfhbmsca = new Cousr01cDfhbmsca();
    // *COPY DFHATTR.                                                    
    // *----------------------------------------------------------------*
    // *                        LINKAGE SECTION                          
    // *----------------------------------------------------------------*
    // [T-Up#INFO][COUSR01C.cbl, LINE #63] DFHCOMMAREA (level: 1)
