 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cousr00cCarddemoCommarea {
    // [T-Up#INFO][COCOM01Y.cpy, LINE #21] CDEMO-GENERAL-INFO (level: 5)
    private @Getter @Setter Cousr00cCdemoGeneralInfo cdemoGeneralInfo = new Cousr00cCdemoGeneralInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #33] CDEMO-CUSTOMER-INFO (level: 5)
    private @Getter @Setter Cousr00cCdemoCustomerInfo cdemoCustomerInfo = new Cousr00cCdemoCustomerInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #38] CDEMO-ACCOUNT-INFO (level: 5)
    private @Getter @Setter Cousr00cCdemoAccountInfo cdemoAccountInfo = new Cousr00cCdemoAccountInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #41] CDEMO-CARD-INFO (level: 5)
    private @Getter @Setter Cousr00cCdemoCardInfo cdemoCardInfo = new Cousr00cCdemoCardInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #43] CDEMO-MORE-INFO (level: 5)
    private @Getter @Setter Cousr00cCdemoMoreInfo cdemoMoreInfo = new Cousr00cCdemoMoreInfo();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:15:57 CDT 
    // *                                                                 
    // [T-Up#INFO][COUSR00C.cbl, LINE #67] CDEMO-CU00-INFO (level: 5)
    private @Getter @Setter Cousr00cCdemoCu00Info cdemoCu00Info = new Cousr00cCdemoCu00Info();
    ...
    public void set(String source) {
        ...
        cdemoCu00Info.set(source.substring(160, 194));
    }
    ...
    public String toString() {
        ...
        sb.append(getCdemoCu00Info().toString());
        return sb.toString();
    }

    public static @AllArgsConstructor @NoArgsConstructor class Cousr00cCdemoGeneralInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr00cCdemoCustomerInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr00cCdemoAccountInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr00cCdemoCardInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr00cCdemoMoreInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr00cCdemoCu00Info {
        // [T-Up#INFO][COUSR00C.cbl, LINE #68] CDEMO-CU00-USRID-FIRST (level: 10)
        private @Getter String cdemoCu00UsridFirst = StringUtils.repeat(' ', 8);
        // [T-Up#INFO][COUSR00C.cbl, LINE #69] CDEMO-CU00-USRID-LAST (level: 10)
        private @Getter String cdemoCu00UsridLast = StringUtils.repeat(' ', 8);
        // [T-Up#INFO][COUSR00C.cbl, LINE #70] CDEMO-CU00-PAGE-NUM (level: 10)
        private @Getter @Setter int cdemoCu00PageNum;
        // [T-Up#INFO][COUSR00C.cbl, LINE #71] CDEMO-CU00-NEXT-PAGE-FLG (level: 10)
        private @Getter String cdemoCu00NextPageFlg = "N";
        // [T-Up#INFO][COUSR00C.cbl, LINE #72] NEXT-PAGE-YES (level: 88)
        public static final String NEXT_PAGE_YES = "Y";
        // [T-Up#INFO][COUSR00C.cbl, LINE #73] NEXT-PAGE-NO (level: 88)
        public static final String NEXT_PAGE_NO = "N";
        // [T-Up#INFO][COUSR00C.cbl, LINE #74] CDEMO-CU00-USR-SEL-FLG (level: 10)
        private @Getter String cdemoCu00UsrSelFlg = StringUtils.repeat(' ', 1);
        // [T-Up#INFO][COUSR00C.cbl, LINE #75] CDEMO-CU00-USR-SELECTED (level: 10)
        private @Getter String cdemoCu00UsrSelected = StringUtils
                .repeat(' ', 8);

        public void setCdemoCu00UsridFirst(String source) {
            cdemoCu00UsridFirst = StringUtils.truncate(
                    StringUtils.rightPad(source, 8), 8);
        }

        public void setCdemoCu00UsridLast(String source) {
            cdemoCu00UsridLast = StringUtils.truncate(
                    StringUtils.rightPad(source, 8), 8);
        }

        public void setCdemoCu00NextPageFlg(String source) {
            cdemoCu00NextPageFlg = StringUtils.truncate(
                    StringUtils.rightPad(source, 1), 1);
        }

        public void setCdemoCu00UsrSelFlg(String source) {
            cdemoCu00UsrSelFlg = StringUtils.truncate(
                    StringUtils.rightPad(source, 1), 1);
        }

        public void setCdemoCu00UsrSelected(String source) {
            cdemoCu00UsrSelected = StringUtils.truncate(
                    StringUtils.rightPad(source, 8), 8);
        }

        public void set(String source) {
            source = StringUtils.truncate(StringUtils.rightPad(source, 34), 34);
            cdemoCu00UsridFirst = source.substring(0, 8);
            cdemoCu00UsridLast = source.substring(8, 16);
            try {
                cdemoCu00PageNum = (int) DataConverter.convZonedStringToLong(
                        source.substring(16, 24), 8);
            } catch (NumberFormatException exception) {
                exception.printStackTrace();
                cdemoCu00PageNum = 0;
            }
            cdemoCu00NextPageFlg = source.substring(24, 25);
            cdemoCu00UsrSelFlg = source.substring(25, 26);
            cdemoCu00UsrSelected = source.substring(26, 34);
        }

        public String get() {
            StringBuilder sb = new StringBuilder();
            sb.append(cdemoCu00UsridFirst);
            sb.append(cdemoCu00UsridLast);
            sb.append(DataConverter.convZonedLongToString(cdemoCu00PageNum, 8));
            sb.append(cdemoCu00NextPageFlg);
            sb.append(cdemoCu00UsrSelFlg);
            sb.append(cdemoCu00UsrSelected);
            return sb.toString();
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(getCdemoCu00UsridFirst());
            sb.append(getCdemoCu00UsridLast());
            sb.append(PictureFormatter.intFormatWithoutSign(
                    (long) cdemoCu00PageNum, "00000000"));
            sb.append(getCdemoCu00NextPageFlg());
            sb.append(getCdemoCu00UsrSelFlg());
            sb.append(getCdemoCu00UsrSelected());
            return sb.toString();
        }
    }
}
