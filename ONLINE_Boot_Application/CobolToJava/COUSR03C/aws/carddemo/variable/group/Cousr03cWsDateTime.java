 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cousr03cWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter Cousr03cWsCurdateData wsCurdateData = new Cousr03cWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter Cousr03cWsCurdateMmDdYy wsCurdateMmDdYy = new Cousr03cWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter Cousr03cWsCurtimeHhMmSs wsCurtimeHhMmSs = new Cousr03cWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter Cousr03cWsTimestamp wsTimestamp = new Cousr03cWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr03cWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter Cousr03cWsCurdate wsCurdate = new Cousr03cWsCurdate();
        ...
        private @Getter @Setter Cousr03cWsCurtime wsCurtime = new Cousr03cWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cousr03cWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cousr03cWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr03cWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr03cWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr03cWsTimestamp {
