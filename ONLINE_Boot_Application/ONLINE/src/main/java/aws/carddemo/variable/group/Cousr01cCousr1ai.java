 ...
 */
public @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class Cousr01cCousr1ai {
    // [T-Up#INFO][COUSR01.CPY, LINE #19] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER1 = StringUtils.repeat(' ',
            12);
    // [T-Up#INFO][COUSR01.CPY, LINE #20] TRNNAMEL (level: 2)
    private @Getter @Setter int trnnamel;
    // [T-Up#INFO][COUSR01.CPY, LINE #21] TRNNAMEF (level: 2)
    ...
    // [T-Up#INFO][COUSR01.CPY, LINE #24] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER3 = StringUtils.repeat(' ',
            4);
    // [T-Up#INFO][COUSR01.CPY, LINE #25] TRNNAMEI (level: 2)
    private @Getter @Builder.Default String trnnamei = StringUtils.repeat(' ',
            4);
    // [T-Up#INFO][COUSR01.CPY, LINE #26] TITLE01L (level: 2)
    private @Getter @Setter int title01l;
    // [T-Up#INFO][COUSR01.CPY, LINE #27] TITLE01F (level: 2)
    ...
    // [T-Up#INFO][COUSR01.CPY, LINE #30] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER5 = StringUtils.repeat(' ',
            4);
    // [T-Up#INFO][COUSR01.CPY, LINE #31] TITLE01I (level: 2)
    private @Getter @Builder.Default String title01i = StringUtils.repeat(' ',
            40);
    // [T-Up#INFO][COUSR01.CPY, LINE #32] CURDATEL (level: 2)
    private @Getter @Setter int curdatel;
    // [T-Up#INFO][COUSR01.CPY, LINE #33] CURDATEF (level: 2)
    ...
    // [T-Up#INFO][COUSR01.CPY, LINE #36] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER7 = StringUtils.repeat(' ',
            4);
    // [T-Up#INFO][COUSR01.CPY, LINE #37] CURDATEI (level: 2)
    private @Getter @Builder.Default String curdatei = StringUtils.repeat(' ',
            8);
    // [T-Up#INFO][COUSR01.CPY, LINE #38] PGMNAMEL (level: 2)
    private @Getter @Setter int pgmnamel;
    // [T-Up#INFO][COUSR01.CPY, LINE #39] PGMNAMEF (level: 2)
    ...
    // [T-Up#INFO][COUSR01.CPY, LINE #42] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER9 = StringUtils.repeat(' ',
            4);
    // [T-Up#INFO][COUSR01.CPY, LINE #43] PGMNAMEI (level: 2)
    private @Getter @Builder.Default String pgmnamei = StringUtils.repeat(' ',
            8);
    // [T-Up#INFO][COUSR01.CPY, LINE #44] TITLE02L (level: 2)
    private @Getter @Setter int title02l;
    // [T-Up#INFO][COUSR01.CPY, LINE #45] TITLE02F (level: 2)
    ...
    // [T-Up#INFO][COUSR01.CPY, LINE #48] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER11 = StringUtils.repeat(
            ' ', 4);
    // [T-Up#INFO][COUSR01.CPY, LINE #49] TITLE02I (level: 2)
    private @Getter @Builder.Default String title02i = StringUtils.repeat(' ',
            40);
    // [T-Up#INFO][COUSR01.CPY, LINE #50] CURTIMEL (level: 2)
    private @Getter @Setter int curtimel;
    // [T-Up#INFO][COUSR01.CPY, LINE #51] CURTIMEF (level: 2)
    ...
    // [T-Up#INFO][COUSR01.CPY, LINE #66] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER17 = StringUtils.repeat(
            ' ', 4);
    // [T-Up#INFO][COUSR01.CPY, LINE #67] LNAMEI (level: 2)
    private @Getter @Builder.Default String lnamei = StringUtils
            .repeat(' ', 20);
    // [T-Up#INFO][COUSR01.CPY, LINE #68] USERIDL (level: 2)
    private @Getter @Setter int useridl;
    // [T-Up#INFO][COUSR01.CPY, LINE #69] USERIDF (level: 2)
    ...
    // [T-Up#INFO][COUSR01.CPY, LINE #72] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER19 = StringUtils.repeat(
            ' ', 4);
    // [T-Up#INFO][COUSR01.CPY, LINE #73] USERIDI (level: 2)
    private @Getter @Builder.Default String useridi = StringUtils
            .repeat(' ', 8);
    // [T-Up#INFO][COUSR01.CPY, LINE #74] PASSWDL (level: 2)
    private @Getter @Setter int passwdl;
    // [T-Up#INFO][COUSR01.CPY, LINE #75] PASSWDF (level: 2)
    ...
    // [T-Up#INFO][COUSR01.CPY, LINE #78] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER21 = StringUtils.repeat(
            ' ', 4);
    // [T-Up#INFO][COUSR01.CPY, LINE #79] PASSWDI (level: 2)
    private @Getter @Builder.Default String passwdi = StringUtils
            .repeat(' ', 8);
    // [T-Up#INFO][COUSR01.CPY, LINE #80] USRTYPEL (level: 2)
    private @Getter @Setter int usrtypel;
    // [T-Up#INFO][COUSR01.CPY, LINE #81] USRTYPEF (level: 2)
    ...
    // [T-Up#INFO][COUSR01.CPY, LINE #84] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER23 = StringUtils.repeat(
            ' ', 4);
    // [T-Up#INFO][COUSR01.CPY, LINE #85] USRTYPEI (level: 2)
    private @Getter @Builder.Default String usrtypei = StringUtils.repeat(' ',
            1);
    // [T-Up#INFO][COUSR01.CPY, LINE #86] ERRMSGL (level: 2)
    private @Getter @Setter int errmsgl;
    // [T-Up#INFO][COUSR01.CPY, LINE #87] ERRMSGF (level: 2)
    ...
    // [T-Up#INFO][COUSR01.CPY, LINE #90] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER25 = StringUtils.repeat(
            ' ', 4);
    // [T-Up#INFO][COUSR01.CPY, LINE #91] ERRMSGI (level: 2)
    ...
    public static Cousr01cCousr1ai createDefaultValueInstance() {
        return new Cousr01cCousr1ai.builder().build();
    }
    ...
    public void set(String source) {
        ...
        fnamef = source.substring(164, 165);
        OFFILLER15 = source.substring(165, 169);
        fnamei = source.substring(169, 189);
        try {
            tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
            tempByteBuffer1.put(source.substring(189, 191).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
        ...
        lnamef = source.substring(191, 192);
        OFFILLER17 = source.substring(192, 196);
        lnamei = source.substring(196, 216);
        try {
            tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
            tempByteBuffer1.put(source.substring(216, 218).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
        ...
        useridf = source.substring(218, 219);
        OFFILLER19 = source.substring(219, 223);
        useridi = source.substring(223, 231);
        try {
            tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER2 {
        // [T-Up#INFO][COUSR01.CPY, LINE #23] TRNNAMEA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER4 {
        // [T-Up#INFO][COUSR01.CPY, LINE #29] TITLE01A (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER6 {
        // [T-Up#INFO][COUSR01.CPY, LINE #35] CURDATEA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER8 {
        // [T-Up#INFO][COUSR01.CPY, LINE #41] PGMNAMEA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER10 {
        // [T-Up#INFO][COUSR01.CPY, LINE #47] TITLE02A (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER12 {
        // [T-Up#INFO][COUSR01.CPY, LINE #53] CURTIMEA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER14 {
        // [T-Up#INFO][COUSR01.CPY, LINE #59] FNAMEA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER16 {
        // [T-Up#INFO][COUSR01.CPY, LINE #65] LNAMEA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER18 {
        // [T-Up#INFO][COUSR01.CPY, LINE #71] USERIDA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER20 {
        // [T-Up#INFO][COUSR01.CPY, LINE #77] PASSWDA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER22 {
        // [T-Up#INFO][COUSR01.CPY, LINE #83] USRTYPEA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER24 {
        // [T-Up#INFO][COUSR01.CPY, LINE #89] ERRMSGA (level: 3)
