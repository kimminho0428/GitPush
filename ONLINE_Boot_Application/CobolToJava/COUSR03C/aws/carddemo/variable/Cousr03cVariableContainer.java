...
public class Cousr03cVariableContainer {
    ...
    // *----------------------------------------------------------------*
    // [T-Up#INFO][COUSR03C.cbl, LINE #35] WS-VARIABLES (level: 1)
    ...
    //       *COPY COUSR03.                                                    
    // *(/home/oflab/repository/ref/COBOL_COPYBOOK/CARDDEMO/COUSR03.CPY) 
    // ******************************************************************
    // * Copyright Amazon.com, Inc. or its affiliates.                   
    // * All Rights Reserved.                                            
    // *                                                                 
    ...
    // * language governing permissions and limitations under the License
    // ******************************************************************
    // [T-Up#INFO][COUSR03.CPY, LINE #18] COUSR3AI (level: 1)
    private @Getter @Setter Cousr03cCousr3ai cousr3ai = new Cousr03cCousr3ai();

    public Cousr03cCousr3ao getCousr3ao() {
        return Cousr03cCousr3ao.builder().OFFILLER1(getOFFILLER1())
                ...
                .OFFILLER11(getOFFILLER11()).usrtypec(getUsrtypec())
                .usrtypep(getUsrtypep()).usrtypeh(getUsrtypeh())
                .usrtypev(getUsrtypev()).usrtypeo(getUsrtypeo())
                .OFFILLER12(getOFFILLER12()).errmsgc(getErrmsgc())
    ...
    public void setCousr3ao(String source) {
        ...
        setOFFILLER12(source.substring(239, 242));
    ...
    public void setOFFILLER2(String source) {
        ...
        try {
            ...
            tempByteBuffer1.flip();
            getCousr3ai().setTrnnamel(tempByteBuffer1.getShort());
    ...
    public String getTrnnamec() {
        return getCousr3ai().getOFFILLER3().substring(0, 1);
    }

    public void setTrnnamec(String source) {
        getCousr3ai()
                .setOFFILLER3(
                        StringUtils.overlay(getCousr3ai().getOFFILLER3(),
                                source, 0, 1));
    }

    public String getTrnnamep() {
        return getCousr3ai().getOFFILLER3().substring(1, 2);
    }
    ...
    public String getTrnnameh() {
        return getCousr3ai().getOFFILLER3().substring(2, 3);
    }
    ...
    public String getTrnnamev() {
        return getCousr3ai().getOFFILLER3().substring(3);
    }
    ...
    public String getOFFILLER3() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr3ai().getTitle01l());
        tempByteBuffer1.flip();
        String temp2 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp2 + getCousr3ai().getTitle01f();
    }
    ...
    public void setOFFILLER3(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr3ai().setTitle01l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getTitle01c() {
        return getCousr3ai().getOFFILLER5().substring(0, 1);
    }

    public void setTitle01c(String source) {
        getCousr3ai()
                .setOFFILLER5(
                        StringUtils.overlay(getCousr3ai().getOFFILLER5(),
                                source, 0, 1));
    }

    public String getTitle01p() {
        return getCousr3ai().getOFFILLER5().substring(1, 2);
    }
    ...
    public String getTitle01h() {
        return getCousr3ai().getOFFILLER5().substring(2, 3);
    }
    ...
    public String getTitle01v() {
        return getCousr3ai().getOFFILLER5().substring(3);
    }
    ...
    public String getOFFILLER4() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr3ai().getCurdatel());
        tempByteBuffer1.flip();
        String temp3 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp3 + getCousr3ai().getCurdatef();
    }
    ...
    public void setOFFILLER4(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr3ai().setCurdatel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getCurdatec() {
        return getCousr3ai().getOFFILLER7().substring(0, 1);
    }

    public void setCurdatec(String source) {
        getCousr3ai()
                .setOFFILLER7(
                        StringUtils.overlay(getCousr3ai().getOFFILLER7(),
                                source, 0, 1));
    }

    public String getCurdatep() {
        return getCousr3ai().getOFFILLER7().substring(1, 2);
    }
    ...
    public String getCurdateh() {
        return getCousr3ai().getOFFILLER7().substring(2, 3);
    }
    ...
    public String getCurdatev() {
        return getCousr3ai().getOFFILLER7().substring(3);
    }
    ...
    public String getOFFILLER5() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr3ai().getPgmnamel());
        tempByteBuffer1.flip();
        String temp4 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp4 + getCousr3ai().getPgmnamef();
    }
    ...
    public void setOFFILLER5(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr3ai().setPgmnamel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getPgmnamec() {
        return getCousr3ai().getOFFILLER9().substring(0, 1);
    }

    public void setPgmnamec(String source) {
        getCousr3ai()
                .setOFFILLER9(
                        StringUtils.overlay(getCousr3ai().getOFFILLER9(),
                                source, 0, 1));
    }

    public String getPgmnamep() {
        return getCousr3ai().getOFFILLER9().substring(1, 2);
    }
    ...
    public String getPgmnameh() {
        return getCousr3ai().getOFFILLER9().substring(2, 3);
    }
    ...
    public String getPgmnamev() {
        return getCousr3ai().getOFFILLER9().substring(3);
    }
    ...
    public String getOFFILLER6() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr3ai().getTitle02l());
        tempByteBuffer1.flip();
        String temp5 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp5 + getCousr3ai().getTitle02f();
    }
    ...
    public void setOFFILLER6(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr3ai().setTitle02l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getTitle02c() {
        return getCousr3ai().getOFFILLER11().substring(0, 1);
    }

    public void setTitle02c(String source) {
        getCousr3ai().setOFFILLER11(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER11(), source, 0, 1));
    }

    public String getTitle02p() {
        return getCousr3ai().getOFFILLER11().substring(1, 2);
    }

    public void setTitle02p(String source) {
        getCousr3ai().setOFFILLER11(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER11(), source, 1, 2));
    }

    public String getTitle02h() {
        return getCousr3ai().getOFFILLER11().substring(2, 3);
    }

    public void setTitle02h(String source) {
        getCousr3ai().setOFFILLER11(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER11(), source, 2, 3));
    }

    public String getTitle02v() {
        return getCousr3ai().getOFFILLER11().substring(3);
    }

    public void setTitle02v(String source) {
        getCousr3ai().setOFFILLER11(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER11(), source, 3, 4));
    }
    ...
    public String getOFFILLER7() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr3ai().getCurtimel());
        tempByteBuffer1.flip();
        String temp6 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp6 + getCousr3ai().getCurtimef();
    }
    ...
    public void setOFFILLER7(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr3ai().setCurtimel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getCurtimec() {
        return getCousr3ai().getOFFILLER13().substring(0, 1);
    }

    public void setCurtimec(String source) {
        getCousr3ai().setOFFILLER13(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER13(), source, 0, 1));
    }

    public String getCurtimep() {
        return getCousr3ai().getOFFILLER13().substring(1, 2);
    }

    public void setCurtimep(String source) {
        getCousr3ai().setOFFILLER13(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER13(), source, 1, 2));
    }

    public String getCurtimeh() {
        return getCousr3ai().getOFFILLER13().substring(2, 3);
    }

    public void setCurtimeh(String source) {
        getCousr3ai().setOFFILLER13(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER13(), source, 2, 3));
    }

    public String getCurtimev() {
        return getCousr3ai().getOFFILLER13().substring(3);
    }

    public void setCurtimev(String source) {
        getCousr3ai().setOFFILLER13(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER13(), source, 3, 4));
    }
    ...
    public String getOFFILLER8() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr3ai().getUsridinl());
        tempByteBuffer1.flip();
        String temp7 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp7 + getCousr3ai().getUsridinf();
    }
    ...
    public void setOFFILLER8(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr3ai().setUsridinl(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getUsridinc() {
        return getCousr3ai().getOFFILLER15().substring(0, 1);
    }

    public void setUsridinc(String source) {
        getCousr3ai().setOFFILLER15(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER15(), source, 0, 1));
    }

    public String getUsridinp() {
        return getCousr3ai().getOFFILLER15().substring(1, 2);
    }

    public void setUsridinp(String source) {
        getCousr3ai().setOFFILLER15(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER15(), source, 1, 2));
    }

    public String getUsridinh() {
        return getCousr3ai().getOFFILLER15().substring(2, 3);
    }

    public void setUsridinh(String source) {
        getCousr3ai().setOFFILLER15(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER15(), source, 2, 3));
    }

    public String getUsridinv() {
        return getCousr3ai().getOFFILLER15().substring(3);
    }

    public void setUsridinv(String source) {
        getCousr3ai().setOFFILLER15(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER15(), source, 3, 4));
    }
    ...
    public String getOFFILLER9() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr3ai().getFnamel());
        tempByteBuffer1.flip();
        String temp8 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp8 + getCousr3ai().getFnamef();
    }
    ...
    public void setOFFILLER9(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr3ai().setFnamel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getFnamec() {
        return getCousr3ai().getOFFILLER17().substring(0, 1);
    }

    public void setFnamec(String source) {
        getCousr3ai().setOFFILLER17(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER17(), source, 0, 1));
    }

    public String getFnamep() {
        return getCousr3ai().getOFFILLER17().substring(1, 2);
    }

    public void setFnamep(String source) {
        getCousr3ai().setOFFILLER17(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER17(), source, 1, 2));
    }

    public String getFnameh() {
        return getCousr3ai().getOFFILLER17().substring(2, 3);
    }

    public void setFnameh(String source) {
        getCousr3ai().setOFFILLER17(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER17(), source, 2, 3));
    }

    public String getFnamev() {
        return getCousr3ai().getOFFILLER17().substring(3);
    }

    public void setFnamev(String source) {
        getCousr3ai().setOFFILLER17(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER17(), source, 3, 4));
    }
    ...
    public String getOFFILLER10() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr3ai().getLnamel());
        tempByteBuffer1.flip();
        String temp9 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp9 + getCousr3ai().getLnamef();
    }
    ...
    public void setOFFILLER10(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr3ai().setLnamel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getLnamec() {
        return getCousr3ai().getOFFILLER19().substring(0, 1);
    }

    public void setLnamec(String source) {
        getCousr3ai().setOFFILLER19(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER19(), source, 0, 1));
    }

    public String getLnamep() {
        return getCousr3ai().getOFFILLER19().substring(1, 2);
    }

    public void setLnamep(String source) {
        getCousr3ai().setOFFILLER19(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER19(), source, 1, 2));
    }

    public String getLnameh() {
        return getCousr3ai().getOFFILLER19().substring(2, 3);
    }

    public void setLnameh(String source) {
        getCousr3ai().setOFFILLER19(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER19(), source, 2, 3));
    }

    public String getLnamev() {
        return getCousr3ai().getOFFILLER19().substring(3);
    }

    public void setLnamev(String source) {
        getCousr3ai().setOFFILLER19(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER19(), source, 3, 4));
    }
    ...
    public String getOFFILLER11() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr3ai().getUsrtypel());
        tempByteBuffer1.flip();
        String temp10 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp10 + getCousr3ai().getUsrtypef();
    }
    ...
    public void setOFFILLER11(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr3ai().setUsrtypel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getUsrtypec() {
        return getCousr3ai().getOFFILLER21().substring(0, 1);
    }

    public void setUsrtypec(String source) {
        getCousr3ai().setOFFILLER21(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER21(), source, 0, 1));
    }

    public String getUsrtypep() {
        return getCousr3ai().getOFFILLER21().substring(1, 2);
    }

    public void setUsrtypep(String source) {
        getCousr3ai().setOFFILLER21(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER21(), source, 1, 2));
    }

    public String getUsrtypeh() {
        return getCousr3ai().getOFFILLER21().substring(2, 3);
    }

    public void setUsrtypeh(String source) {
        getCousr3ai().setOFFILLER21(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER21(), source, 2, 3));
    }

    public String getUsrtypev() {
        return getCousr3ai().getOFFILLER21().substring(3);
    }

    public void setUsrtypev(String source) {
        getCousr3ai().setOFFILLER21(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER21(), source, 3, 4));
    }
    ...
    public String getOFFILLER12() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getCousr3ai().getErrmsgl());
        tempByteBuffer1.flip();
        String temp11 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp11 + getCousr3ai().getErrmsgf();
    }
    ...
    public void setOFFILLER12(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getCousr3ai().setErrmsgl(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getErrmsgc() {
        return getCousr3ai().getOFFILLER23().substring(0, 1);
    }

    public void setErrmsgc(String source) {
        getCousr3ai().setOFFILLER23(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER23(), source, 0, 1));
    }

    public String getErrmsgp() {
        return getCousr3ai().getOFFILLER23().substring(1, 2);
    }

    public void setErrmsgp(String source) {
        getCousr3ai().setOFFILLER23(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER23(), source, 1, 2));
    }

    public String getErrmsgh() {
        return getCousr3ai().getOFFILLER23().substring(2, 3);
    }

    public void setErrmsgh(String source) {
        getCousr3ai().setOFFILLER23(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER23(), source, 2, 3));
    }

    public String getErrmsgv() {
        return getCousr3ai().getOFFILLER23().substring(3);
    }

    public void setErrmsgv(String source) {
        getCousr3ai().setOFFILLER23(
                StringUtils
                        .overlay(getCousr3ai().getOFFILLER23(), source, 3, 4));
    }
    ...
    private @Getter @Setter Cousr03cCcdaScreenTitle ccdaScreenTitle = new Cousr03cCcdaScreenTitle();
    // *                                                                 
    ...
    private @Getter @Setter Cousr03cWsDateTime wsDateTime = new Cousr03cWsDateTime();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:15:58 CDT 
    // *                                                                 
    //       *COPY CSMSG01Y.                                                   
    ...
    private @Getter @Setter Cousr03cCcdaCommonMessages ccdaCommonMessages = new Cousr03cCcdaCommonMessages();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:15:58 CDT 
    // *                                                                 
    //       *COPY CSUSR01Y.                                                   
    ...
    private @Getter @Setter Cousr03cSecUserData secUserData = new Cousr03cSecUserData();
    // *                                                                 
    ...
    private @Getter @Setter Cousr03cDfhaid dfhaid = new Cousr03cDfhaid();
    //       *COPY DFHBMSCA.                                                   
    // *(/home/oflab/repository/ref/COBOL_COPYBOOK/.default/DFHBMSCA.cpy)
    // [T-Up#INFO][DFHBMSCA.cpy, LINE #2] DFHBMSCA (level: 1)
    private @Getter @Setter Cousr03cDfhbmsca dfhbmsca = new Cousr03cDfhbmsca();
    // *----------------------------------------------------------------*
    // *                        LINKAGE SECTION                          
    // *----------------------------------------------------------------*
    // [T-Up#INFO][COUSR03C.cbl, LINE #74] DFHCOMMAREA (level: 1)
