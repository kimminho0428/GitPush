 ...
 * <ul>
 * <li>converted COBOL program: {@link aws.carddemo.Cbact01c}</li>
 * </ul>
 */
@Getter
@Setter
...
public class Cbact01cTasklet implements Tasklet {
    private Map<String, Dd> dd;
    private String parm;
    private final Cbact01c program;
