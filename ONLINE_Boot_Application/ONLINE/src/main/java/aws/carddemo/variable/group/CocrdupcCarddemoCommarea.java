 ...
 */
public @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdupcCarddemoCommarea {
    // [T-Up#INFO][COCOM01Y.cpy, LINE #21] CDEMO-GENERAL-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdupcCdemoGeneralInfo cdemoGeneralInfo = new CocrdupcCdemoGeneralInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #33] CDEMO-CUSTOMER-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdupcCdemoCustomerInfo cdemoCustomerInfo = new CocrdupcCdemoCustomerInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #38] CDEMO-ACCOUNT-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdupcCdemoAccountInfo cdemoAccountInfo = new CocrdupcCdemoAccountInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #41] CDEMO-CARD-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdupcCdemoCardInfo cdemoCardInfo = new CocrdupcCdemoCardInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #43] CDEMO-MORE-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdupcCdemoMoreInfo cdemoMoreInfo = new CocrdupcCdemoMoreInfo();

    public static CocrdupcCarddemoCommarea createDefaultValueInstance() {
        return new CocrdupcCarddemoCommarea.builder()
                .cdemoGeneralInfo(
                        CocrdupcCdemoGeneralInfo.createDefaultValueInstance())
                .cdemoCustomerInfo(
                        CocrdupcCdemoCustomerInfo.createDefaultValueInstance())
                .cdemoAccountInfo(
                        CocrdupcCdemoAccountInfo.createDefaultValueInstance())
                .cdemoCardInfo(
                        CocrdupcCdemoCardInfo.createDefaultValueInstance())
                .cdemoMoreInfo(
                        CocrdupcCdemoMoreInfo.createDefaultValueInstance())
                .build();
    }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdupcCdemoGeneralInfo {
        ...
        public static CocrdupcCdemoGeneralInfo createDefaultValueInstance() {
            return new CocrdupcCdemoGeneralInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdupcCdemoCustomerInfo {
        ...
        public static CocrdupcCdemoCustomerInfo createDefaultValueInstance() {
            return new CocrdupcCdemoCustomerInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdupcCdemoAccountInfo {
        ...
        public static CocrdupcCdemoAccountInfo createDefaultValueInstance() {
            return new CocrdupcCdemoAccountInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdupcCdemoCardInfo {
        // [T-Up#INFO][COCOM01Y.cpy, LINE #42] CDEMO-CARD-NUM (level: 10)
        private @Getter @Setter long cdemoCardNum;

        public static CocrdupcCdemoCardInfo createDefaultValueInstance() {
            return new CocrdupcCdemoCardInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdupcCdemoMoreInfo {
        ...
        public static CocrdupcCdemoMoreInfo createDefaultValueInstance() {
            return new CocrdupcCdemoMoreInfo.builder().build();
        }
