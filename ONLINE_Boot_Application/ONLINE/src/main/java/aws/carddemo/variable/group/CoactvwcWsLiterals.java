...
public @AllArgsConstructor @NoArgsConstructor class CoactvwcWsLiterals {
    // [T-Up#INFO][COACTVWC.cbl, LINE #142] LIT-THISPGM (level: 5)
    private @Getter String litThispgm = "COACTVWC";
    // [T-Up#INFO][COACTVWC.cbl, LINE #144] LIT-THISTRANID (level: 5)
    private @Getter String litThistranid = "CAVW";
    // [T-Up#INFO][COACTVWC.cbl, LINE #146] LIT-THISMAPSET (level: 5)
    private @Getter String litThismapset = "COACTVW ";
    // [T-Up#INFO][COACTVWC.cbl, LINE #148] LIT-THISMAP (level: 5)
    private @Getter String litThismap = "CACTVWA";
    // [T-Up#INFO][COACTVWC.cbl, LINE #150] LIT-CCLISTPGM (level: 5)
    private @Getter String litCclistpgm = "COCRDLIC";
    // [T-Up#INFO][COACTVWC.cbl, LINE #152] LIT-CCLISTTRANID (level: 5)
    private @Getter String litCclisttranid = "CCLI";
    // [T-Up#INFO][COACTVWC.cbl, LINE #154] LIT-CCLISTMAPSET (level: 5)
    private @Getter String litCclistmapset = "COCRDLI";
    // [T-Up#INFO][COACTVWC.cbl, LINE #156] LIT-CCLISTMAP (level: 5)
    private @Getter String litCclistmap = "CCRDSLA";
    // [T-Up#INFO][COACTVWC.cbl, LINE #158] LIT-CARDUPDATEPGM (level: 5)
    private @Getter String litCardupdatepgm = "COCRDUPC";
    // [T-Up#INFO][COACTVWC.cbl, LINE #160] LIT-CARDUDPATETRANID (level: 5)
    private @Getter String litCardudpatetranid = "CCUP";
    // [T-Up#INFO][COACTVWC.cbl, LINE #162] LIT-CARDUPDATEMAPSET (level: 5)
    private @Getter String litCardupdatemapset = "COCRDUP ";
    // [T-Up#INFO][COACTVWC.cbl, LINE #164] LIT-CARDUPDATEMAP (level: 5)
    private @Getter String litCardupdatemap = "CCRDUPA";
    // [T-Up#INFO][COACTVWC.cbl, LINE #167] LIT-MENUPGM (level: 5)
    private @Getter String litMenupgm = "COMEN01C";
    // [T-Up#INFO][COACTVWC.cbl, LINE #169] LIT-MENUTRANID (level: 5)
    private @Getter String litMenutranid = "CM00";
    // [T-Up#INFO][COACTVWC.cbl, LINE #171] LIT-MENUMAPSET (level: 5)
    private @Getter String litMenumapset = "COMEN01";
    // [T-Up#INFO][COACTVWC.cbl, LINE #173] LIT-MENUMAP (level: 5)
    private @Getter String litMenumap = "COMEN1A";
    // [T-Up#INFO][COACTVWC.cbl, LINE #175] LIT-CARDDTLPGM (level: 5)
    private @Getter String litCarddtlpgm = "COCRDSLC";
    // [T-Up#INFO][COACTVWC.cbl, LINE #177] LIT-CARDDTLTRANID (level: 5)
    private @Getter String litCarddtltranid = "CCDL";
    // [T-Up#INFO][COACTVWC.cbl, LINE #179] LIT-CARDDTLMAPSET (level: 5)
    private @Getter String litCarddtlmapset = "COCRDSL";
    // [T-Up#INFO][COACTVWC.cbl, LINE #181] LIT-CARDDTLMAP (level: 5)
    private @Getter String litCarddtlmap = "CCRDSLA";
    // [T-Up#INFO][COACTVWC.cbl, LINE #183] LIT-ACCTFILENAME (level: 5)
    private @Getter String litAcctfilename = "ACCTDAT ";
    // [T-Up#INFO][COACTVWC.cbl, LINE #185] LIT-CARDFILENAME (level: 5)
    private @Getter String litCardfilename = "CARDDAT ";
    // [T-Up#INFO][COACTVWC.cbl, LINE #187] LIT-CUSTFILENAME (level: 5)
    private @Getter String litCustfilename = "CUSTDAT ";
    // [T-Up#INFO][COACTVWC.cbl, LINE #189] LIT-CARDFILENAME-ACCT-PATH (level: 5)
    private @Getter String litCardfilenameAcctPath = "CARDAIX ";
    // [T-Up#INFO][COACTVWC.cbl, LINE #191] LIT-CARDXREFNAME-ACCT-PATH (level: 5)
    private @Getter String litCardxrefnameAcctPath = "CXACAIX ";
    // [T-Up#INFO][COACTVWC.cbl, LINE #193] LIT-ALL-ALPHA-FROM (level: 5)
    private @Getter String litAllAlphaFrom = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
    // [T-Up#INFO][COACTVWC.cbl, LINE #196] LIT-ALL-SPACES-TO (level: 5)
    private @Getter String litAllSpacesTo = StringUtils.repeat(' ', 52);
    // [T-Up#INFO][COACTVWC.cbl, LINE #198] LIT-UPPER (level: 5)
    private @Getter String litUpper = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    // [T-Up#INFO][COACTVWC.cbl, LINE #200] LIT-LOWER (level: 5)
