 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cosgn00cCarddemoCommarea {
    // [T-Up#INFO][COCOM01Y.cpy, LINE #21] CDEMO-GENERAL-INFO (level: 5)
    private @Getter @Setter Cosgn00cCdemoGeneralInfo cdemoGeneralInfo = new Cosgn00cCdemoGeneralInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #33] CDEMO-CUSTOMER-INFO (level: 5)
    private @Getter @Setter Cosgn00cCdemoCustomerInfo cdemoCustomerInfo = new Cosgn00cCdemoCustomerInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #38] CDEMO-ACCOUNT-INFO (level: 5)
    private @Getter @Setter Cosgn00cCdemoAccountInfo cdemoAccountInfo = new Cosgn00cCdemoAccountInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #41] CDEMO-CARD-INFO (level: 5)
    private @Getter @Setter Cosgn00cCdemoCardInfo cdemoCardInfo = new Cosgn00cCdemoCardInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #43] CDEMO-MORE-INFO (level: 5)
    private @Getter @Setter Cosgn00cCdemoMoreInfo cdemoMoreInfo = new Cosgn00cCdemoMoreInfo();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cosgn00cCdemoGeneralInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cosgn00cCdemoCustomerInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cosgn00cCdemoAccountInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cosgn00cCdemoCardInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cosgn00cCdemoMoreInfo {
