 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cbact04cAcctfileStatus {
    // [T-Up#INFO][CBACT04C.cbl, LINE #125] ACCTFILE-STAT1 (level: 5)
    private @Getter String acctfileStat1 = StringUtils.repeat(' ', 1);
    // [T-Up#INFO][CBACT04C.cbl, LINE #126] ACCTFILE-STAT2 (level: 5)
