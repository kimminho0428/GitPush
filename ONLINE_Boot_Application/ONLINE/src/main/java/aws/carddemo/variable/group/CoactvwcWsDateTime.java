 ...
 */
public @AllArgsConstructor @NoArgsConstructor class CoactvwcWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter CoactvwcWsCurdateData wsCurdateData = new CoactvwcWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter CoactvwcWsCurdateMmDdYy wsCurdateMmDdYy = new CoactvwcWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter CoactvwcWsCurtimeHhMmSs wsCurtimeHhMmSs = new CoactvwcWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter CoactvwcWsTimestamp wsTimestamp = new CoactvwcWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CoactvwcWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter CoactvwcWsCurdate wsCurdate = new CoactvwcWsCurdate();
        ...
        private @Getter @Setter CoactvwcWsCurtime wsCurtime = new CoactvwcWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class CoactvwcWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class CoactvwcWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CoactvwcWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CoactvwcWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CoactvwcWsTimestamp {
