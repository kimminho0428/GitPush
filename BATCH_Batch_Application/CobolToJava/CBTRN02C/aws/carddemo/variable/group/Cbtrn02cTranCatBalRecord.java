 ...
 */
public @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class Cbtrn02cTranCatBalRecord {
    // [T-Up#INFO][CVTRA01Y.cpy, LINE #6] TRAN-CAT-KEY (level: 5)
    private @Getter @Setter @Builder.Default Cbtrn02cTranCatKey tranCatKey = new Cbtrn02cTranCatKey();
    ...
    public static Cbtrn02cTranCatBalRecord createDefaultValueInstance() {
        return new Cbtrn02cTranCatBalRecord.builder().tranCatKey(
                Cbtrn02cTranCatKey.createDefaultValueInstance()).build();
    }
    ...
    public void set(Cbtrn02cFdTranCatBalRecord source) {
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class Cbtrn02cTranCatKey {
        ...
        public static Cbtrn02cTranCatKey createDefaultValueInstance() {
            return new Cbtrn02cTranCatKey.builder().build();
        }
