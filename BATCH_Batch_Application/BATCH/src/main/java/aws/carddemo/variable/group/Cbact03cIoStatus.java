 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cbact03cIoStatus {
    // [T-Up#INFO][CBACT03C.cbl, LINE #51] IO-STAT1 (level: 5)
    private @Getter String ioStat1 = StringUtils.repeat(' ', 1);
    // [T-Up#INFO][CBACT03C.cbl, LINE #52] IO-STAT2 (level: 5)
    ...
    public void set(Cbact03cXreffileStatus source) {
