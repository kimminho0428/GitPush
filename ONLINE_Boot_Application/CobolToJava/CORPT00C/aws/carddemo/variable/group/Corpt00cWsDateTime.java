 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Corpt00cWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter Corpt00cWsCurdateData wsCurdateData = new Corpt00cWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter Corpt00cWsCurdateMmDdYy wsCurdateMmDdYy = new Corpt00cWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter Corpt00cWsCurtimeHhMmSs wsCurtimeHhMmSs = new Corpt00cWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter Corpt00cWsTimestamp wsTimestamp = new Corpt00cWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter Corpt00cWsCurdate wsCurdate = new Corpt00cWsCurdate();
        ...
        private @Getter @Setter Corpt00cWsCurtime wsCurtime = new Corpt00cWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Corpt00cWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Corpt00cWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cWsTimestamp {
