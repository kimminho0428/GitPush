...
import aws.carddemo.mapper.Comen01cMapperInterface.*;
...
import static aws.carddemo.variable.group.Comen01cCarddemoCommarea.Comen01cCdemoGeneralInfo.*;
import static aws.carddemo.variable.group.Comen01cWsVariables.*;
...
public class Comen01c {
    ...
    void mainPara(OpenFrameContext context) {
        ...
        if (task.hasCommarea() == 0) {
            ...
            // [T-Up#INFO][COMEN01C.cbl, LINE #87] PERFORM statement
            controlManager.run(context, returnToSignonScreen);
            if (controlManager.isTerminate(context)) {
                return;
            }
        } else {
            // [T-Up#INFO][COMEN01C.cbl, LINE #89] MOVE statement
            container.getCarddemoCommarea().set(
                    StringUtils.overlay(container.getCarddemoCommarea().get(),
                            ...
                            0, 160));
            // [T-Up#INFO][COMEN01C.cbl, LINE #90] IF statement
            if (!(container.getCarddemoCommarea().getCdemoGeneralInfo()
                    .getCdemoPgmContext() == CDEMO_PGM_REENTER)) {
                // [T-Up#INFO][COMEN01C.cbl, LINE #91] SET statement
                container.getCarddemoCommarea().getCdemoGeneralInfo()
                        .setCdemoPgmContext(CDEMO_PGM_REENTER);
                // [T-Up#INFO][COMEN01C.cbl, LINE #92] MOVE statement
                container.setComen1ao(Comen01cComen1ai
                        .createDefaultValueInstance().get());
                // [T-Up#INFO][COMEN01C.cbl, LINE #93] PERFORM statement
                controlManager.run(context, sendMenuScreen);
                if (controlManager.isTerminate(context)) {
                    return;
                }
            } else {
                // [T-Up#INFO][COMEN01C.cbl, LINE #95] PERFORM statement
                controlManager.run(context, receiveMenuScreen);
                if (controlManager.isTerminate(context)) {
                    return;
                }
                // [T-Up#INFO][COMEN01C.cbl, LINE #96] EVALUATE statement
                if (CobStringUtils.compare(task.getPressedKey(), container
                        .getDfhaid().getDfhenter()) == 0) {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #98] PERFORM statement
                    ...
                    // [T-Up#INFO][COMEN01C.cbl, LINE #100] MOVE statement
                    container.getCarddemoCommarea().getCdemoGeneralInfo()
                            .setCdemoToProgram("COSGN00C");
                    // [T-Up#INFO][COMEN01C.cbl, LINE #101] EXEC_CICS statement
                    /*
                                                   EXEC CICS                                    
                                                   XCTL PROGRAM('COSGN00C')                     
                                                   END-EXEC
                    ...
                    programControl.forward("CC00", cosgn00cInputDto);
                    context.setReturnFlag(true);
                    // [T-Up#INFO][COMEN01C.cbl, LINE #104] PERFORM statement
                    controlManager.run(context, returnToSignonScreen);
                    if (controlManager.isTerminate(context)) {
                        return;
                    }
                } else {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #106] MOVE statement
                    container.getWsVariables().setWsErrFlg("Y");
                    // [T-Up#INFO][COMEN01C.cbl, LINE #107] MOVE statement
                    container.getWsVariables().setWsMessage(
                            container.getCcdaCommonMessages()
                                    .getCcdaMsgInvalidKey());
                    // [T-Up#INFO][COMEN01C.cbl, LINE #108] PERFORM statement
                    controlManager.run(context, sendMenuScreen);
                    if (controlManager.isTerminate(context)) {
                        return;
                    }
        ...
        // [T-Up#INFO][COMEN01C.cbl, LINE #113] EXEC_CICS statement
        /*
                       EXEC CICS RETURN                                             
                                 TRANSID (WS-TRANID)                                
        ...
        TaskDto taskDto = TaskDto
                ...
                .destination("CM00")
                .data(Data
                        .session(Comen01cCarddemoCommareaToComen01cDfhcommarea.INSTANCE
    ...
    void processEnterKey(OpenFrameContext context) {
        ...
        Comen01cVariableContainer container = (Comen01cVariableContainer) context
                .getProgramVariableContainer("Comen01c");
        // [T-Up#INFO][COMEN01C.cbl, LINE #123] PERFORM statement
        ...
        // [T-Up#INFO][COMEN01C.cbl, LINE #128] MOVE statement
                        ...
                        container
                                ...
                                .substring(
                                        ...
                                        0 + container.getWsVariables()
                                                .getWsIdx()));
        // [T-Up#INFO][COMEN01C.cbl, LINE #129] INSPECT statement
        ...
        if ((!true || container.getWsVariables().getWsOption() > container
            ...
            // [T-Up#INFO][COMEN01C.cbl, LINE #136] MOVE statement
            container.getWsVariables().setWsErrFlg("Y");
            // [T-Up#INFO][COMEN01C.cbl, LINE #137] MOVE statement
            container.getWsVariables().setWsMessage(
                    "Please enter a valid option number...");
            // [T-Up#INFO][COMEN01C.cbl, LINE #139] PERFORM statement
            controlManager.run(context, sendMenuScreen);
            if (controlManager.isTerminate(context)) {
                return;
            }
        }
        // [T-Up#INFO][COMEN01C.cbl, LINE #142] IF statement
        if (CobStringUtils.compare(container.getCarddemoCommarea()
                ...
                && CobStringUtils.compare(
                        container.getCarddemoMainMenuOptions()
                                .getCdemoMenuOptUsrtype(
                                        container.getWsVariables()
                                                .getWsOption() - 1), "A") == 0) {
            // [T-Up#INFO][COMEN01C.cbl, LINE #144] SET statement
            container.getWsVariables().setWsErrFlg(ERR_FLG_ON);
            // [T-Up#INFO][COMEN01C.cbl, LINE #145] MOVE statement
            container.getWsVariables()
                    .setWsMessage(StringUtils.repeat(' ', 80));
            // [T-Up#INFO][COMEN01C.cbl, LINE #146] MOVE statement
            container.getWsVariables().setWsMessage(
                    "No access - Admin Only option... ");
            // [T-Up#INFO][COMEN01C.cbl, LINE #148] PERFORM statement
            controlManager.run(context, sendMenuScreen);
            if (controlManager.isTerminate(context)) {
                return;
            }
        }
        // [T-Up#INFO][COMEN01C.cbl, LINE #151] IF statement
        if (!(CobStringUtils.compare(container.getWsVariables().getWsErrFlg(),
                ERR_FLG_ON) == 0)) {
            // [T-Up#INFO][COMEN01C.cbl, LINE #152] IF statement
            if (CobStringUtils
                    .compare(
                            container
                ...
                // [T-Up#INFO][COMEN01C.cbl, LINE #153] MOVE statement
                container
                        .getCarddemoCommarea()
                        .getCdemoGeneralInfo()
                        .setCdemoFromTranid(
                                container.getWsVariables().getWsTranid());
                // [T-Up#INFO][COMEN01C.cbl, LINE #154] MOVE statement
                container
                        .getCarddemoCommarea()
                        .getCdemoGeneralInfo()
                        .setCdemoFromProgram(
                ...
                // [T-Up#INFO][COMEN01C.cbl, LINE #157] MOVE statement
                container.getCarddemoCommarea().getCdemoGeneralInfo()
                        .setCdemoPgmContext(0);
                // [T-Up#INFO][COMEN01C.cbl, LINE #158] EVALUATE statement
                switch (container.getCarddemoMainMenuOptions()
                        .getCdemoMenuOptPgmname(
                                container.getWsVariables().getWsOption() - 1)) {
                case "COACTVWC": {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #160] EXEC_CICS statement
                    /*
                                               EXEC CICS                                        
                    ...
                    coactvwcInputDto
                            .setDfhcommarea(Comen01cCarddemoCommareaToCoactvwcDfhcommarea.INSTANCE
                                    .toTarget(container.getCarddemoCommarea()));
                ...
                case "COACTUPC": {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #165] EXEC_CICS statement
                    /*
                                               EXEC CICS                                        
                    ...
                    coactupcInputDto
                            .setDfhcommarea(Comen01cCarddemoCommareaToCoactupcDfhcommarea.INSTANCE
                                    .toTarget(container.getCarddemoCommarea()));
                ...
                case "COCRDLIC": {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #170] EXEC_CICS statement
                    /*
                                               EXEC CICS                                        
                    ...
                    cocrdlicInputDto
                            .setDfhcommarea(Comen01cCarddemoCommareaToCocrdlicDfhcommarea.INSTANCE
                                    .toTarget(container.getCarddemoCommarea()));
                ...
                case "COCRDSLC": {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #175] EXEC_CICS statement
                    /*
                                               EXEC CICS                                        
                    ...
                    cocrdslcInputDto
                            .setDfhcommarea(Comen01cCarddemoCommareaToCocrdslcDfhcommarea.INSTANCE
                                    .toTarget(container.getCarddemoCommarea()));
                ...
                case "COCRDUPC": {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #180] EXEC_CICS statement
                    /*
                                               EXEC CICS                                        
                    ...
                    cocrdupcInputDto
                            .setDfhcommarea(Comen01cCarddemoCommareaToCocrdupcDfhcommarea.INSTANCE
                                    .toTarget(container.getCarddemoCommarea()));
                ...
                case "COTRN00C": {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #185] EXEC_CICS statement
                    /*
                                               EXEC CICS                                        
                    ...
                    cotrn00cInputDto
                            .setDfhcommarea(Comen01cCarddemoCommareaToCotrn00cDfhcommarea.INSTANCE
                                    .toTarget(container.getCarddemoCommarea()));
                ...
                case "COTRN01C": {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #190] EXEC_CICS statement
                    /*
                                               EXEC CICS                                        
                    ...
                    cotrn01cInputDto
                            .setDfhcommarea(Comen01cCarddemoCommareaToCotrn01cDfhcommarea.INSTANCE
                                    .toTarget(container.getCarddemoCommarea()));
                ...
                case "COTRN02C": {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #195] EXEC_CICS statement
                    /*
                                               EXEC CICS                                        
                    ...
                    cotrn02cInputDto
                            .setDfhcommarea(Comen01cCarddemoCommareaToCotrn02cDfhcommarea.INSTANCE
                                    .toTarget(container.getCarddemoCommarea()));
                ...
                case "CORPT00C": {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #200] EXEC_CICS statement
                    /*
                                               EXEC CICS                                        
                    ...
                    corpt00cInputDto
                            .setDfhcommarea(Comen01cCarddemoCommareaToCorpt00cDfhcommarea.INSTANCE
                                    .toTarget(container.getCarddemoCommarea()));
                ...
                case "COBIL00C": {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #205] EXEC_CICS statement
                    /*
                                               EXEC CICS                                        
                    ...
                    cobil00cInputDto
                            .setDfhcommarea(Comen01cCarddemoCommareaToCobil00cDfhcommarea.INSTANCE
                                    .toTarget(container.getCarddemoCommarea()));
                ...
                default: {
                    // [T-Up#INFO][COMEN01C.cbl, LINE #210] CONTINUE statement
                    break;
                }
                }
            }
            // [T-Up#INFO][COMEN01C.cbl, LINE #213] MOVE statement
            container.getWsVariables()
                    .setWsMessage(StringUtils.repeat(' ', 80));
            // [T-Up#INFO][COMEN01C.cbl, LINE #214] MOVE statement
            container.setErrmsgc(container.getDfhbmsca().getDfhgreen());
            // [T-Up#INFO][COMEN01C.cbl, LINE #215] STRING statement
            tempStringBuilder1 = new StringBuilder();
            ...
            // [T-Up#INFO][COMEN01C.cbl, LINE #220] PERFORM statement
            controlManager.run(context, sendMenuScreen);
            if (controlManager.isTerminate(context)) {
                return;
            }
    ...
    void sendMenuScreen(OpenFrameContext context) {
        Comen01cVariableContainer container = (Comen01cVariableContainer) context
                .getProgramVariableContainer("Comen01c");
        // [T-Up#INFO][COMEN01C.cbl, LINE #240] PERFORM statement
        controlManager.run(context, populateHeaderInfo);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COMEN01C.cbl, LINE #241] PERFORM statement
        controlManager.run(context, buildMenuOptions);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COMEN01C.cbl, LINE #243] MOVE statement
        container.setErrmsgo(container.getWsVariables().getWsMessage());
        // [T-Up#INFO][COMEN01C.cbl, LINE #245] EXEC_CICS statement
        /*
                       EXEC CICS SEND                                               
                                 MAP('COMEN1A')                                     
                                 MAPSET('COMEN01')                                  
    ...
    void receiveMenuScreen(OpenFrameContext context) {
        Comen01cVariableContainer container = (Comen01cVariableContainer) context
                .getProgramVariableContainer("Comen01c");
        // [T-Up#INFO][COMEN01C.cbl, LINE #257] EXEC_CICS statement
        /*
                       EXEC CICS RECEIVE                                            
                                 MAP('COMEN1A')                                     
                                 MAPSET('COMEN01')                                  
    ...
    void populateHeaderInfo(OpenFrameContext context) {
        ...
        // [T-Up#INFO][COMEN01C.cbl, LINE #278] MOVE statement
        container
                .getWsDateTime()
                .getWsCurdateMmDdYy()
                .setWsCurdateDd(
        ...
        // [T-Up#INFO][COMEN01C.cbl, LINE #279] MOVE statement
        container
                .getWsDateTime()
                .getWsCurdateMmDdYy()
                .setWsCurdateYy(
                        Integer.parseInt(DataConverter
                                .convZonedLongToString(
                                        container.getWsDateTime()
                                                ...
                                                .getWsCurdateYear(), 4)
                                .substring(2, 4).trim()));
        // [T-Up#INFO][COMEN01C.cbl, LINE #281] MOVE statement
        container.setCurdateo(container.getWsDateTime().getWsCurdateMmDdYy()
                .get());
        // [T-Up#INFO][COMEN01C.cbl, LINE #283] MOVE statement
        container
                .getWsDateTime()
                .getWsCurtimeHhMmSs()
                .setWsCurtimeHh(
        ...
        // [T-Up#INFO][COMEN01C.cbl, LINE #284] MOVE statement
        container
                .getWsDateTime()
                .getWsCurtimeHhMmSs()
                .setWsCurtimeMm(
        ...
        // [T-Up#INFO][COMEN01C.cbl, LINE #285] MOVE statement
        container
                .getWsDateTime()
                .getWsCurtimeHhMmSs()
                .setWsCurtimeSs(
        ...
        // [T-Up#INFO][COMEN01C.cbl, LINE #287] MOVE statement
    ...
    void buildMenuOptions(OpenFrameContext context) {
        ...
        Comen01cVariableContainer container = (Comen01cVariableContainer) context
                .getProgramVariableContainer("Comen01c");
        // [T-Up#INFO][COMEN01C.cbl, LINE #294] PERFORM statement
        container.getWsVariables().setWsIdx(1);
        while (!(container.getWsVariables().getWsIdx() > container
                .getCarddemoMainMenuOptions().getCdemoMenuOptCount())) {
            // [T-Up#INFO][COMEN01C.cbl, LINE #297] MOVE statement
            container.getWsVariables().setWsMenuOptTxt(
                    StringUtils.repeat(' ', 40));
            // [T-Up#INFO][COMEN01C.cbl, LINE #299] STRING statement
            tempStringBuilder1 = new StringBuilder();
            tempStringBuilder2 = new StringBuilder(container.getWsVariables()
                    .getWsMenuOptTxt());
            tempStringBuilder1
                    .append(container.getCarddemoMainMenuOptions()
                            .getCdemoMenuOptNum(
                                    container.getWsVariables().getWsIdx() - 1))
                    .append(". ")
                    .append(container.getCarddemoMainMenuOptions()
            ...
            // [T-Up#INFO][COMEN01C.cbl, LINE #304] EVALUATE statement
            switch (container.getWsVariables().getWsIdx()) {
            case 1: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #306] MOVE statement
                container.setOptn001o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            case 2: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #308] MOVE statement
                container.setOptn002o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            case 3: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #310] MOVE statement
                container.setOptn003o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            case 4: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #312] MOVE statement
                container.setOptn004o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            case 5: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #314] MOVE statement
                container.setOptn005o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            case 6: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #316] MOVE statement
                container.setOptn006o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            case 7: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #318] MOVE statement
                container.setOptn007o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            case 8: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #320] MOVE statement
                container.setOptn008o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            case 9: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #322] MOVE statement
                container.setOptn009o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            case 10: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #324] MOVE statement
                container.setOptn010o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            case 11: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #326] MOVE statement
                container.setOptn011o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            case 12: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #328] MOVE statement
                container.setOptn012o(container.getWsVariables()
                        .getWsMenuOptTxt());
                break;
            }
            default: {
                // [T-Up#INFO][COMEN01C.cbl, LINE #330] CONTINUE statement
                break;
            }
            }
            container.getWsVariables().setWsIdx(
