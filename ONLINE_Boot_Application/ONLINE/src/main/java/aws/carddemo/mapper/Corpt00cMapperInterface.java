...
import aws.carddemo.variable.group.Corpt00cCarddemoCommarea;
...
public interface Corpt00cMapperInterface {
     ...
     * <ul>
     * <li>source class: {@link Corpt00cCarddemoCommarea}</li>
     * <li>target class: {@link Cosgn00cDfhcommarea}</li>
     * </ul>
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE)
    public interface Corpt00cCarddemoCommareaToCosgn00cDfhcommarea {
        Corpt00cCarddemoCommareaToCosgn00cDfhcommarea INSTANCE = Mappers
                .getMapper(Corpt00cCarddemoCommareaToCosgn00cDfhcommarea.class);

        Cosgn00cDfhcommarea toTarget(Corpt00cCarddemoCommarea source);

        Corpt00cCarddemoCommarea toSource(Cosgn00cDfhcommarea source);

        @AfterMapping
        default void makeTarget(Corpt00cCarddemoCommarea source,
        ...
        default void makeSource(Cosgn00cDfhcommarea source,
                @MappingTarget Corpt00cCarddemoCommarea target) {
     ...
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE)
    public interface Corpt00cCarddemoCommareaToCorpt00cDfhcommarea {
        Corpt00cCarddemoCommareaToCorpt00cDfhcommarea INSTANCE = Mappers
                .getMapper(Corpt00cCarddemoCommareaToCorpt00cDfhcommarea.class);

        Corpt00cDfhcommarea toTarget(Corpt00cCarddemoCommarea source);

        Corpt00cCarddemoCommarea toSource(Corpt00cDfhcommarea source);
     ...
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE)
    public interface Corpt00cCarddemoCommareaToComen01cDfhcommarea {
        Corpt00cCarddemoCommareaToComen01cDfhcommarea INSTANCE = Mappers
                .getMapper(Corpt00cCarddemoCommareaToComen01cDfhcommarea.class);

        Comen01cDfhcommarea toTarget(Corpt00cCarddemoCommarea source);

        Corpt00cCarddemoCommarea toSource(Comen01cDfhcommarea source);
