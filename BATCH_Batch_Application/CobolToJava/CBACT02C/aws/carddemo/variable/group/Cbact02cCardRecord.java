 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cbact02cCardRecord {
    ...
    public void set(Cbact02cFdCardfileRec source) {
        cardNum = source.getFdCardNum();
        cardAcctId = DataConverter.convZonedStringToLong(source.getFdCardData()
                .substring(0, 11), 11);
        cardCvvCd = (int) DataConverter.convZonedStringToLong(source
                .getFdCardData().substring(11, 14), 3);
        cardEmbossedName = source.getFdCardData().substring(14, 64);
        cardExpiraionDate = source.getFdCardData().substring(64, 74);
        cardActiveStatus = source.getFdCardData().substring(74, 75);
        OFFILLER1 = source.getFdCardData().substring(75);
    }
