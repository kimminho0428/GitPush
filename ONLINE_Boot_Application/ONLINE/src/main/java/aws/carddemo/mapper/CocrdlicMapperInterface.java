...
import aws.carddemo.variable.group.CocrdlicCarddemoCommarea;
import aws.carddemo.variable.group.CocrdslcDfhcommarea;
import aws.carddemo.variable.group.CocrdlicCardRecord;
 ...
 */
public interface CocrdlicMapperInterface {
    /** 
     * <p>Mapper class to convert data for CICS processing</p>
     * <ul>
     * <li>source class: {@link CocrdlicCarddemoCommarea}</li>
     * <li>target class: {@link CocrdslcDfhcommarea}</li>
     * </ul>
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE)
    public interface CocrdlicCarddemoCommareaToCocrdslcDfhcommarea {
        CocrdlicCarddemoCommareaToCocrdslcDfhcommarea INSTANCE = Mappers
                .getMapper(CocrdlicCarddemoCommareaToCocrdslcDfhcommarea.class);

        CocrdslcDfhcommarea toTarget(CocrdlicCarddemoCommarea source);

        CocrdlicCarddemoCommarea toSource(CocrdslcDfhcommarea source);

        @AfterMapping
        default void makeTarget(CocrdlicCarddemoCommarea source,
        ...
        default void makeSource(CocrdslcDfhcommarea source,
                @MappingTarget CocrdlicCarddemoCommarea target) {
     ...
     * <p>Mapper class to convert data for CICS processing</p>
     * <ul>
     * <li>source class: {@link CocrdlicCardRecord}</li>
     * <li>target class: {@link AwsM2CarddemoCarddataVsamKsdsDto}</li>
     * </ul>
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE)
    public interface CocrdlicCardRecordToAwsM2CarddemoCarddataVsamKsdsDto {
        CocrdlicCardRecordToAwsM2CarddemoCarddataVsamKsdsDto INSTANCE = Mappers
                .getMapper(CocrdlicCardRecordToAwsM2CarddemoCarddataVsamKsdsDto.class);
        ...
        AwsM2CarddemoCarddataVsamKsdsDto toTarget(CocrdlicCardRecord source);
        ...
        CocrdlicCardRecord toSource(AwsM2CarddemoCarddataVsamKsdsDto source);
    }
     ...
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE)
    public interface CocrdlicCarddemoCommareaToComen01cDfhcommarea {
        CocrdlicCarddemoCommareaToComen01cDfhcommarea INSTANCE = Mappers
                .getMapper(CocrdlicCarddemoCommareaToComen01cDfhcommarea.class);

        Comen01cDfhcommarea toTarget(CocrdlicCarddemoCommarea source);

        CocrdlicCarddemoCommarea toSource(Comen01cDfhcommarea source);
     ...
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE)
    public interface CocrdlicCarddemoCommareaToCocrdupcDfhcommarea {
        CocrdlicCarddemoCommareaToCocrdupcDfhcommarea INSTANCE = Mappers
                .getMapper(CocrdlicCarddemoCommareaToCocrdupcDfhcommarea.class);

        CocrdupcDfhcommarea toTarget(CocrdlicCarddemoCommarea source);

        CocrdlicCarddemoCommarea toSource(CocrdupcDfhcommarea source);
