 ...
 */
public @AllArgsConstructor @NoArgsConstructor class CocrdupcWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter CocrdupcWsCurdateData wsCurdateData = new CocrdupcWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter CocrdupcWsCurdateMmDdYy wsCurdateMmDdYy = new CocrdupcWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter CocrdupcWsCurtimeHhMmSs wsCurtimeHhMmSs = new CocrdupcWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter CocrdupcWsTimestamp wsTimestamp = new CocrdupcWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdupcWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter CocrdupcWsCurdate wsCurdate = new CocrdupcWsCurdate();
        ...
        private @Getter @Setter CocrdupcWsCurtime wsCurtime = new CocrdupcWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class CocrdupcWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class CocrdupcWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdupcWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdupcWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdupcWsTimestamp {
