 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cosgn00cWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter Cosgn00cWsCurdateData wsCurdateData = new Cosgn00cWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter Cosgn00cWsCurdateMmDdYy wsCurdateMmDdYy = new Cosgn00cWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter Cosgn00cWsCurtimeHhMmSs wsCurtimeHhMmSs = new Cosgn00cWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter Cosgn00cWsTimestamp wsTimestamp = new Cosgn00cWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cosgn00cWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter Cosgn00cWsCurdate wsCurdate = new Cosgn00cWsCurdate();
        ...
        private @Getter @Setter Cosgn00cWsCurtime wsCurtime = new Cosgn00cWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cosgn00cWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cosgn00cWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cosgn00cWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cosgn00cWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cosgn00cWsTimestamp {
