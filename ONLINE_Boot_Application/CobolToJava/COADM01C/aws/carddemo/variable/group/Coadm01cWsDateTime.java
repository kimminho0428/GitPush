 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Coadm01cWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter Coadm01cWsCurdateData wsCurdateData = new Coadm01cWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter Coadm01cWsCurdateMmDdYy wsCurdateMmDdYy = new Coadm01cWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter Coadm01cWsCurtimeHhMmSs wsCurtimeHhMmSs = new Coadm01cWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter Coadm01cWsTimestamp wsTimestamp = new Coadm01cWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Coadm01cWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter Coadm01cWsCurdate wsCurdate = new Coadm01cWsCurdate();
        ...
        private @Getter @Setter Coadm01cWsCurtime wsCurtime = new Coadm01cWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Coadm01cWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Coadm01cWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Coadm01cWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Coadm01cWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Coadm01cWsTimestamp {
