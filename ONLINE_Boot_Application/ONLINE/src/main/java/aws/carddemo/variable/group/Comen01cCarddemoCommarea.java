 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Comen01cCarddemoCommarea {
    // [T-Up#INFO][COCOM01Y.cpy, LINE #21] CDEMO-GENERAL-INFO (level: 5)
    private @Getter @Setter Comen01cCdemoGeneralInfo cdemoGeneralInfo = new Comen01cCdemoGeneralInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #33] CDEMO-CUSTOMER-INFO (level: 5)
    private @Getter @Setter Comen01cCdemoCustomerInfo cdemoCustomerInfo = new Comen01cCdemoCustomerInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #38] CDEMO-ACCOUNT-INFO (level: 5)
    private @Getter @Setter Comen01cCdemoAccountInfo cdemoAccountInfo = new Comen01cCdemoAccountInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #41] CDEMO-CARD-INFO (level: 5)
    private @Getter @Setter Comen01cCdemoCardInfo cdemoCardInfo = new Comen01cCdemoCardInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #43] CDEMO-MORE-INFO (level: 5)
    private @Getter @Setter Comen01cCdemoMoreInfo cdemoMoreInfo = new Comen01cCdemoMoreInfo();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Comen01cCdemoGeneralInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Comen01cCdemoCustomerInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Comen01cCdemoAccountInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Comen01cCdemoCardInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Comen01cCdemoMoreInfo {
