...
public @AllArgsConstructor @NoArgsConstructor class Cobil00cCarddemoCommarea {
    ...
    // *                                                                 
    // [T-Up#INFO][COBIL00C.cbl, LINE #64] CDEMO-CB00-INFO (level: 5)
    ...
    public void set(String source) {
        ...
        cdemoCb00Info.set(source.substring(160, 218));
    }
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cobil00cCdemoCb00Info {
        // [T-Up#INFO][COBIL00C.cbl, LINE #65] CDEMO-CB00-TRNID-FIRST (level: 10)
        private @Getter String cdemoCb00TrnidFirst = StringUtils
                .repeat(' ', 16);
        // [T-Up#INFO][COBIL00C.cbl, LINE #66] CDEMO-CB00-TRNID-LAST (level: 10)
        private @Getter String cdemoCb00TrnidLast = StringUtils.repeat(' ', 16);
        // [T-Up#INFO][COBIL00C.cbl, LINE #67] CDEMO-CB00-PAGE-NUM (level: 10)
        private @Getter @Setter int cdemoCb00PageNum;
        // [T-Up#INFO][COBIL00C.cbl, LINE #68] CDEMO-CB00-NEXT-PAGE-FLG (level: 10)
        private @Getter String cdemoCb00NextPageFlg = "N";
        // [T-Up#INFO][COBIL00C.cbl, LINE #69] NEXT-PAGE-YES (level: 88)
        public static final String NEXT_PAGE_YES = "Y";
        // [T-Up#INFO][COBIL00C.cbl, LINE #70] NEXT-PAGE-NO (level: 88)
        public static final String NEXT_PAGE_NO = "N";
        // [T-Up#INFO][COBIL00C.cbl, LINE #71] CDEMO-CB00-TRN-SEL-FLG (level: 10)
        private @Getter String cdemoCb00TrnSelFlg = StringUtils.repeat(' ', 1);
        // [T-Up#INFO][COBIL00C.cbl, LINE #72] CDEMO-CB00-TRN-SELECTED (level: 10)
        ...
        public void set(String source) {
            ...
            cdemoCb00TrnidFirst = source.substring(0, 16);
            cdemoCb00TrnidLast = source.substring(16, 32);
            try {
                cdemoCb00PageNum = (int) DataConverter.convZonedStringToLong(
                        source.substring(32, 40), 8);
            } catch (NumberFormatException exception) {
                exception.printStackTrace();
                cdemoCb00PageNum = 0;
            }
            cdemoCb00NextPageFlg = source.substring(40, 41);
            cdemoCb00TrnSelFlg = source.substring(41, 42);
            cdemoCb00TrnSelected = source.substring(42, 58);
        }

        public String get() {
            StringBuilder sb = new StringBuilder();
            sb.append(cdemoCb00TrnidFirst);
            sb.append(cdemoCb00TrnidLast);
            sb.append(DataConverter.convZonedLongToString(cdemoCb00PageNum, 8));
            sb.append(cdemoCb00NextPageFlg);
            sb.append(cdemoCb00TrnSelFlg);
            sb.append(cdemoCb00TrnSelected);
            return sb.toString();
        }
        ...
        public String toString() {
            ...
            sb.append(PictureFormatter.intFormatWithoutSign(
                    (long) cdemoCb00PageNum, "00000000"));
