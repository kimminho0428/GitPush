 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Corpt00cCarddemoCommarea {
    // [T-Up#INFO][COCOM01Y.cpy, LINE #21] CDEMO-GENERAL-INFO (level: 5)
    private @Getter @Setter Corpt00cCdemoGeneralInfo cdemoGeneralInfo = new Corpt00cCdemoGeneralInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #33] CDEMO-CUSTOMER-INFO (level: 5)
    private @Getter @Setter Corpt00cCdemoCustomerInfo cdemoCustomerInfo = new Corpt00cCdemoCustomerInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #38] CDEMO-ACCOUNT-INFO (level: 5)
    private @Getter @Setter Corpt00cCdemoAccountInfo cdemoAccountInfo = new Corpt00cCdemoAccountInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #41] CDEMO-CARD-INFO (level: 5)
    private @Getter @Setter Corpt00cCdemoCardInfo cdemoCardInfo = new Corpt00cCdemoCardInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #43] CDEMO-MORE-INFO (level: 5)
    private @Getter @Setter Corpt00cCdemoMoreInfo cdemoMoreInfo = new Corpt00cCdemoMoreInfo();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cCdemoGeneralInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cCdemoCustomerInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cCdemoAccountInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cCdemoCardInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cCdemoMoreInfo {
