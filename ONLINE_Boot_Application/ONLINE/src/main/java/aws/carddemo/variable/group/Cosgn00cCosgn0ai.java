 ...
 */
public @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class Cosgn00cCosgn0ai {
    // [T-Up#INFO][COSGN00.CPY, LINE #19] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER1 = StringUtils.repeat(' ',
            12);
    // [T-Up#INFO][COSGN00.CPY, LINE #20] TRNNAMEL (level: 2)
    private @Getter @Setter int trnnamel;
    // [T-Up#INFO][COSGN00.CPY, LINE #21] TRNNAMEF (level: 2)
    ...
    // [T-Up#INFO][COSGN00.CPY, LINE #24] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER3 = StringUtils.repeat(' ',
            4);
    // [T-Up#INFO][COSGN00.CPY, LINE #25] TRNNAMEI (level: 2)
    private @Getter @Builder.Default String trnnamei = StringUtils.repeat(' ',
            4);
    // [T-Up#INFO][COSGN00.CPY, LINE #26] TITLE01L (level: 2)
    private @Getter @Setter int title01l;
    // [T-Up#INFO][COSGN00.CPY, LINE #27] TITLE01F (level: 2)
    ...
    // [T-Up#INFO][COSGN00.CPY, LINE #30] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER5 = StringUtils.repeat(' ',
            4);
    // [T-Up#INFO][COSGN00.CPY, LINE #31] TITLE01I (level: 2)
    private @Getter @Builder.Default String title01i = StringUtils.repeat(' ',
            40);
    // [T-Up#INFO][COSGN00.CPY, LINE #32] CURDATEL (level: 2)
    private @Getter @Setter int curdatel;
    // [T-Up#INFO][COSGN00.CPY, LINE #33] CURDATEF (level: 2)
    ...
    // [T-Up#INFO][COSGN00.CPY, LINE #36] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER7 = StringUtils.repeat(' ',
            4);
    // [T-Up#INFO][COSGN00.CPY, LINE #37] CURDATEI (level: 2)
    private @Getter @Builder.Default String curdatei = StringUtils.repeat(' ',
            8);
    // [T-Up#INFO][COSGN00.CPY, LINE #38] PGMNAMEL (level: 2)
    private @Getter @Setter int pgmnamel;
    // [T-Up#INFO][COSGN00.CPY, LINE #39] PGMNAMEF (level: 2)
    ...
    // [T-Up#INFO][COSGN00.CPY, LINE #42] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER9 = StringUtils.repeat(' ',
            4);
    // [T-Up#INFO][COSGN00.CPY, LINE #43] PGMNAMEI (level: 2)
    private @Getter @Builder.Default String pgmnamei = StringUtils.repeat(' ',
            8);
    // [T-Up#INFO][COSGN00.CPY, LINE #44] TITLE02L (level: 2)
    private @Getter @Setter int title02l;
    // [T-Up#INFO][COSGN00.CPY, LINE #45] TITLE02F (level: 2)
    ...
    // [T-Up#INFO][COSGN00.CPY, LINE #48] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER11 = StringUtils.repeat(
            ' ', 4);
    // [T-Up#INFO][COSGN00.CPY, LINE #49] TITLE02I (level: 2)
    private @Getter @Builder.Default String title02i = StringUtils.repeat(' ',
            40);
    // [T-Up#INFO][COSGN00.CPY, LINE #50] CURTIMEL (level: 2)
    private @Getter @Setter int curtimel;
    // [T-Up#INFO][COSGN00.CPY, LINE #51] CURTIMEF (level: 2)
    ...
    // [T-Up#INFO][COSGN00.CPY, LINE #72] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER19 = StringUtils.repeat(
            ' ', 4);
    // [T-Up#INFO][COSGN00.CPY, LINE #73] USERIDI (level: 2)
    private @Getter @Builder.Default String useridi = StringUtils
            .repeat(' ', 8);
    // [T-Up#INFO][COSGN00.CPY, LINE #74] PASSWDL (level: 2)
    private @Getter @Setter int passwdl;
    // [T-Up#INFO][COSGN00.CPY, LINE #75] PASSWDF (level: 2)
    ...
    // [T-Up#INFO][COSGN00.CPY, LINE #84] FILLER (level: 2)
    private @Getter @Builder.Default String OFFILLER23 = StringUtils.repeat(
            ' ', 4);
    // [T-Up#INFO][COSGN00.CPY, LINE #85] ERRMSGI (level: 2)
    ...
    public static Cosgn00cCosgn0ai createDefaultValueInstance() {
        return new Cosgn00cCosgn0ai.builder().build();
    }
    ...
    public void set(String source) {
        ...
        curtimei = source.substring(154, 163);
        try {
            tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
            tempByteBuffer1.put(source.substring(163, 165).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            applidl = tempByteBuffer1.getShort();
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            applidl = 0;
        }
        applidf = source.substring(165, 166);
        OFFILLER15 = source.substring(166, 170);
        applidi = source.substring(170, 178);
        try {
            tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
            tempByteBuffer1.put(source.substring(178, 180).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            sysidl = tempByteBuffer1.getShort();
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            sysidl = 0;
        }
        sysidf = source.substring(180, 181);
        OFFILLER17 = source.substring(181, 185);
        sysidi = source.substring(185, 193);
        try {
            tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
            tempByteBuffer1.put(source.substring(193, 195).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            useridl = tempByteBuffer1.getShort();
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            useridl = 0;
        }
        useridf = source.substring(195, 196);
        OFFILLER19 = source.substring(196, 200);
        useridi = source.substring(200, 208);
        try {
            tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        ...
        passwdf = source.substring(210, 211);
        OFFILLER21 = source.substring(211, 215);
        passwdi = source.substring(215, 223);
        try {
            tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        ...
        errmsgf = source.substring(225, 226);
        OFFILLER23 = source.substring(226, 230);
        errmsgi = source.substring(230, 308);
    }
    ...
    public String get() {
        ...
        sb.append(curtimei);
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) applidl);
        tempByteBuffer1.flip();
        sb.append(StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString());
        sb.append(applidf);
        ...
        sb.append(applidi);
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) sysidl);
        tempByteBuffer1.flip();
        sb.append(StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString());
        sb.append(sysidf);
        ...
        sb.append(sysidi);
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) useridl);
        tempByteBuffer1.flip();
        sb.append(StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString());
        sb.append(useridf);
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER2 {
        // [T-Up#INFO][COSGN00.CPY, LINE #23] TRNNAMEA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER4 {
        // [T-Up#INFO][COSGN00.CPY, LINE #29] TITLE01A (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER6 {
        // [T-Up#INFO][COSGN00.CPY, LINE #35] CURDATEA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER8 {
        // [T-Up#INFO][COSGN00.CPY, LINE #41] PGMNAMEA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER10 {
        // [T-Up#INFO][COSGN00.CPY, LINE #47] TITLE02A (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER12 {
        // [T-Up#INFO][COSGN00.CPY, LINE #53] CURTIMEA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER14 {
        // [T-Up#INFO][COSGN00.CPY, LINE #59] APPLIDA (level: 3)
        private @Getter String applida = StringUtils.repeat(' ', 1);
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER16 {
        // [T-Up#INFO][COSGN00.CPY, LINE #65] SYSIDA (level: 3)
        private @Getter String sysida = StringUtils.repeat(' ', 1);
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER18 {
        // [T-Up#INFO][COSGN00.CPY, LINE #71] USERIDA (level: 3)
        private @Getter String userida = StringUtils.repeat(' ', 1);
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER20 {
        // [T-Up#INFO][COSGN00.CPY, LINE #77] PASSWDA (level: 3)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class _OFFILLER22 {
        // [T-Up#INFO][COSGN00.CPY, LINE #83] ERRMSGA (level: 3)
