 ...
 */
public @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class Cotrn02cTranRecord {
    ...
    public static Cotrn02cTranRecord createDefaultValueInstance() {
        return new Cotrn02cTranRecord.builder().build();
    }
