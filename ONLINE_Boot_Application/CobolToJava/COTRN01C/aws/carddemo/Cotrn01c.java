...
import aws.carddemo.mapper.Cotrn01cMapperInterface.*;
...
import static aws.carddemo.variable.group.Cotrn01cCarddemoCommarea.Cotrn01cCdemoGeneralInfo.*;
import static aws.carddemo.variable.group.Cotrn01cWsVariables.*;
...
public class Cotrn01c {
    ...
    void mainPara(OpenFrameContext context) {
        ...
        // [T-Up#INFO][COTRN01C.cbl, LINE #88] SET statement
        container.getWsVariables().setWsErrFlg(ERR_FLG_OFF);
        // [T-Up#INFO][COTRN01C.cbl, LINE #89] SET statement
        container.getWsVariables().setWsUsrModified(USR_MODIFIED_NO);
        // [T-Up#INFO][COTRN01C.cbl, LINE #91] MOVE statement
        container.getWsVariables().setWsMessage(StringUtils.repeat(' ', 80));
        container.setErrmsgo(StringUtils.repeat(' ', 78));
        // [T-Up#INFO][COTRN01C.cbl, LINE #94] IF statement
        if (task.hasCommarea() == 0) {
            // [T-Up#INFO][COTRN01C.cbl, LINE #95] MOVE statement
            container.getCarddemoCommarea().getCdemoGeneralInfo()
                    .setCdemoToProgram("COSGN00C");
            // [T-Up#INFO][COTRN01C.cbl, LINE #96] MOVE statement
            container
                    .getCarddemoCommarea()
                    .getCdemoGeneralInfo()
                    .setCdemoFromTranid(
                            container.getWsVariables().getWsTranid());
            // [T-Up#INFO][COTRN01C.cbl, LINE #97] MOVE statement
            container
                    .getCarddemoCommarea()
                    .getCdemoGeneralInfo()
                    .setCdemoFromProgram(
                            container.getWsVariables().getWsPgmname());
            // [T-Up#INFO][COTRN01C.cbl, LINE #98] MOVE statement
            container.getCarddemoCommarea().getCdemoGeneralInfo()
                    .setCdemoPgmContext(0);
            // [T-Up#INFO][COTRN01C.cbl, LINE #99] EXEC_CICS statement
            /*
                               EXEC CICS                                                
            ...
            // [T-Up#INFO][COTRN01C.cbl, LINE #103] PERFORM statement
            controlManager.run(context, returnToPrevScreen);
            if (controlManager.isTerminate(context)) {
                return;
            }
        } else {
            // [T-Up#INFO][COTRN01C.cbl, LINE #105] MOVE statement
            container.getCarddemoCommarea().set(
                    StringUtils.overlay(container.getCarddemoCommarea().get(),
                            ...
                            0, 218));
            // [T-Up#INFO][COTRN01C.cbl, LINE #106] IF statement
            if (!(container.getCarddemoCommarea().getCdemoGeneralInfo()
                    .getCdemoPgmContext() == CDEMO_PGM_REENTER)) {
                // [T-Up#INFO][COTRN01C.cbl, LINE #107] SET statement
                container.getCarddemoCommarea().getCdemoGeneralInfo()
                        .setCdemoPgmContext(CDEMO_PGM_REENTER);
                // [T-Up#INFO][COTRN01C.cbl, LINE #108] MOVE statement
                container.setCotrn1ao(Cotrn01cCotrn1ai
                        .createDefaultValueInstance().get());
                // [T-Up#INFO][COTRN01C.cbl, LINE #109] MOVE statement
                container.getCotrn1ai().setTrnidinl(-1);
                // [T-Up#INFO][COTRN01C.cbl, LINE #110] IF statement
                if (CobStringUtils.compare(container.getCarddemoCommarea()
                    ...
                    // [T-Up#INFO][COTRN01C.cbl, LINE #112] MOVE statement
                    container.getCotrn1ai().setTrnidini(
                            container.getCarddemoCommarea().getCdemoCt01Info()
                                    .getCdemoCt01TrnSelected());
                    // [T-Up#INFO][COTRN01C.cbl, LINE #114] PERFORM statement
                    controlManager.run(context, processEnterKey);
                    if (controlManager.isTerminate(context)) {
                        return;
                    }
                }
                // [T-Up#INFO][COTRN01C.cbl, LINE #116] PERFORM statement
                controlManager.run(context, sendTrnviewScreen);
                if (controlManager.isTerminate(context)) {
                    return;
                }
            } else {
                // [T-Up#INFO][COTRN01C.cbl, LINE #118] PERFORM statement
                controlManager.run(context, receiveTrnviewScreen);
                if (controlManager.isTerminate(context)) {
                    return;
                }
                // [T-Up#INFO][COTRN01C.cbl, LINE #119] EVALUATE statement
                if (CobStringUtils.compare(task.getPressedKey(), container
                        .getDfhaid().getDfhenter()) == 0) {
                    // [T-Up#INFO][COTRN01C.cbl, LINE #121] PERFORM statement
                    controlManager.run(context, processEnterKey);
                    if (controlManager.isTerminate(context)) {
                        return;
                    }
                    ...
                    // [T-Up#INFO][COTRN01C.cbl, LINE #123] IF statement
                    if (CobStringUtils.compare(container.getCarddemoCommarea()
                        ...
                        // [T-Up#INFO][COTRN01C.cbl, LINE #124] MOVE statement
                        container.getCarddemoCommarea().getCdemoGeneralInfo()
                                .setCdemoToProgram("COMEN01C");
                        // [T-Up#INFO][COTRN01C.cbl, LINE #125] MOVE statement
                        container
                                .getCarddemoCommarea()
                                .getCdemoGeneralInfo()
                                .setCdemoFromTranid(
                                        container.getWsVariables()
                                                .getWsTranid());
                        // [T-Up#INFO][COTRN01C.cbl, LINE #126] MOVE statement
                        container
                                .getCarddemoCommarea()
                                .getCdemoGeneralInfo()
                                .setCdemoFromProgram(
                                        container.getWsVariables()
                                                .getWsPgmname());
                        // [T-Up#INFO][COTRN01C.cbl, LINE #127] MOVE statement
                        container.getCarddemoCommarea().getCdemoGeneralInfo()
                                .setCdemoPgmContext(0);
                        // [T-Up#INFO][COTRN01C.cbl, LINE #128] EXEC_CICS statement
                        /*
                                                           EXEC CICS                                
                        ...
                        // [T-Up#INFO][COTRN01C.cbl, LINE #133] MOVE statement
                        container
                                .getCarddemoCommarea()
                                .getCdemoGeneralInfo()
                                .setCdemoToProgram(
                                        container.getCarddemoCommarea()
                                                .getCdemoGeneralInfo()
                                                .getCdemoFromProgram());
                        // [T-Up#INFO][COTRN01C.cbl, LINE #135] MOVE statement
                        container
                                .getCarddemoCommarea()
                                .getCdemoGeneralInfo()
                                .setCdemoFromTranid(
                                        container.getWsVariables()
                                                .getWsTranid());
                        // [T-Up#INFO][COTRN01C.cbl, LINE #136] MOVE statement
                        container
                                .getCarddemoCommarea()
                                .getCdemoGeneralInfo()
                                .setCdemoFromProgram(
                                        container.getWsVariables()
                                                .getWsPgmname());
                        // [T-Up#INFO][COTRN01C.cbl, LINE #137] MOVE statement
                        container.getCarddemoCommarea().getCdemoGeneralInfo()
                                .setCdemoPgmContext(0);
                        // [T-Up#INFO][COTRN01C.cbl, LINE #138] IF statement
                        if (CobStringUtils.compare(container
                                .getCarddemoCommarea().getCdemoGeneralInfo()
                                .getCdemoToProgram(), "COTRN00C") == 0) {
                            // [T-Up#INFO][COTRN01C.cbl, LINE #139] EXEC_CICS statement
                            /*
                                                                   EXEC CICS                            
                            ...
                            // [T-Up#INFO][COTRN01C.cbl, LINE #143] IF statement
                            if (CobStringUtils.compare(container
                                    .getCarddemoCommarea()
                                    .getCdemoGeneralInfo().getCdemoToProgram(),
                                    "COMEN01C") == 0) {
                                // [T-Up#INFO][COTRN01C.cbl, LINE #144] EXEC_CICS statement
                                /*
                                                                       EXEC CICS                            
                                                                       XCTL PROGRAM('COMEN01C')             
                                                                       COMMAREA(CARDDEMO-COMMAREA)          
                        ...
                        // [T-Up#INFO][COTRN01C.cbl, LINE #150] PERFORM statement
                        controlManager.run(context, returnToPrevScreen);
                        if (controlManager.isTerminate(context)) {
                            return;
                        }
                    ...
                    // [T-Up#INFO][COTRN01C.cbl, LINE #152] PERFORM statement
                    ...
                    // [T-Up#INFO][COTRN01C.cbl, LINE #154] MOVE statement
                    container.getCarddemoCommarea().getCdemoGeneralInfo()
                            .setCdemoToProgram("COTRN00C");
                    // [T-Up#INFO][COTRN01C.cbl, LINE #155] MOVE statement
                    container
                            .getCarddemoCommarea()
                            .getCdemoGeneralInfo()
                            .setCdemoFromTranid(
                                    container.getWsVariables().getWsTranid());
                    // [T-Up#INFO][COTRN01C.cbl, LINE #156] MOVE statement
                    container
                            .getCarddemoCommarea()
                            .getCdemoGeneralInfo()
                            .setCdemoFromProgram(
                                    container.getWsVariables().getWsPgmname());
                    // [T-Up#INFO][COTRN01C.cbl, LINE #157] MOVE statement
                    container.getCarddemoCommarea().getCdemoGeneralInfo()
                            .setCdemoPgmContext(0);
                    // [T-Up#INFO][COTRN01C.cbl, LINE #158] EXEC_CICS statement
                    /*
                                                   EXEC CICS                                    
                                                   XCTL PROGRAM('COTRN00C')                     
                                                   COMMAREA(CARDDEMO-COMMAREA)                  
                    ...
                    programControl.forward("CT00", cotrn00cInputDto);
                    context.setReturnFlag(true);
                    // [T-Up#INFO][COTRN01C.cbl, LINE #162] PERFORM statement
                    controlManager.run(context, returnToPrevScreen);
                    if (controlManager.isTerminate(context)) {
                        return;
                    }
                } else {
                    // [T-Up#INFO][COTRN01C.cbl, LINE #164] MOVE statement
                    container.getWsVariables().setWsErrFlg("Y");
                    // [T-Up#INFO][COTRN01C.cbl, LINE #165] MOVE statement
                    container.getWsVariables().setWsMessage(
                            container.getCcdaCommonMessages()
                                    .getCcdaMsgInvalidKey());
                    // [T-Up#INFO][COTRN01C.cbl, LINE #166] PERFORM statement
                    controlManager.run(context, sendTrnviewScreen);
                    if (controlManager.isTerminate(context)) {
                        return;
                    }
        ...
        // [T-Up#INFO][COTRN01C.cbl, LINE #171] EXEC_CICS statement
        /*
                       EXEC CICS RETURN                                             
                                 TRANSID (WS-TRANID)                                
                                 COMMAREA (CARDDEMO-COMMAREA)                       
    ...
    void processEnterKey(OpenFrameContext context) {
        Cotrn01cVariableContainer container = (Cotrn01cVariableContainer) context
                .getProgramVariableContainer("Cotrn01c");
        // [T-Up#INFO][COTRN01C.cbl, LINE #181] EVALUATE statement
        if (CobStringUtils.compare(container.getCotrn1ai().getTrnidini(),
                StringUtils.repeat(' ', 16)) == 0
                || CobStringUtils.compare(
                        container.getCotrn1ai().getTrnidini(),
                        StringUtils.repeat((char) 0x00, 16)) == 0) {
            // [T-Up#INFO][COTRN01C.cbl, LINE #183] MOVE statement
            container.getWsVariables().setWsErrFlg("Y");
            // [T-Up#INFO][COTRN01C.cbl, LINE #184] MOVE statement
            container.getWsVariables().setWsMessage(
                    "Tran ID can NOT be empty...");
            // [T-Up#INFO][COTRN01C.cbl, LINE #186] MOVE statement
            container.getCotrn1ai().setTrnidinl(-1);
            // [T-Up#INFO][COTRN01C.cbl, LINE #187] PERFORM statement
            controlManager.run(context, sendTrnviewScreen);
            if (controlManager.isTerminate(context)) {
                return;
            }
        } else {
            // [T-Up#INFO][COTRN01C.cbl, LINE #189] MOVE statement
            container.getCotrn1ai().setTrnidinl(-1);
            // [T-Up#INFO][COTRN01C.cbl, LINE #190] CONTINUE statement
        }
        // [T-Up#INFO][COTRN01C.cbl, LINE #193] IF statement
        if (!(CobStringUtils.compare(container.getWsVariables().getWsErrFlg(),
                ERR_FLG_ON) == 0)) {
            // [T-Up#INFO][COTRN01C.cbl, LINE #194] MOVE statement
    ...
    void sendTrnviewScreen(OpenFrameContext context) {
        Cotrn01cVariableContainer container = (Cotrn01cVariableContainer) context
                .getProgramVariableContainer("Cotrn01c");
        // [T-Up#INFO][COTRN01C.cbl, LINE #250] PERFORM statement
        controlManager.run(context, populateHeaderInfo);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COTRN01C.cbl, LINE #252] MOVE statement
        container.setErrmsgo(container.getWsVariables().getWsMessage());
        // [T-Up#INFO][COTRN01C.cbl, LINE #254] EXEC_CICS statement
        /*
                       EXEC CICS SEND                                               
                                 MAP('COTRN1A')                                     
                                 MAPSET('COTRN01')                                  
    ...
    void receiveTrnviewScreen(OpenFrameContext context) {
        Cotrn01cVariableContainer container = (Cotrn01cVariableContainer) context
                .getProgramVariableContainer("Cotrn01c");
        // [T-Up#INFO][COTRN01C.cbl, LINE #267] EXEC_CICS statement
        /*
                       EXEC CICS RECEIVE                                            
                                 MAP('COTRN1A')                                     
                                 MAPSET('COTRN01')                                  
    ...
    void populateHeaderInfo(OpenFrameContext context) {
        ...
        // [T-Up#INFO][COTRN01C.cbl, LINE #288] MOVE statement
        container
                .getWsDateTime()
                .getWsCurdateMmDdYy()
                .setWsCurdateDd(
        ...
        // [T-Up#INFO][COTRN01C.cbl, LINE #289] MOVE statement
        container
                .getWsDateTime()
                .getWsCurdateMmDdYy()
                .setWsCurdateYy(
                        Integer.parseInt(DataConverter
                                .convZonedLongToString(
                                        container.getWsDateTime()
                                                ...
                                                .getWsCurdateYear(), 4)
                                .substring(2, 4).trim()));
        // [T-Up#INFO][COTRN01C.cbl, LINE #291] MOVE statement
        container.setCurdateo(container.getWsDateTime().getWsCurdateMmDdYy()
                .get());
        // [T-Up#INFO][COTRN01C.cbl, LINE #293] MOVE statement
        container
                .getWsDateTime()
                .getWsCurtimeHhMmSs()
                .setWsCurtimeHh(
        ...
        // [T-Up#INFO][COTRN01C.cbl, LINE #294] MOVE statement
        container
                .getWsDateTime()
                .getWsCurtimeHhMmSs()
                .setWsCurtimeMm(
        ...
        // [T-Up#INFO][COTRN01C.cbl, LINE #295] MOVE statement
        container
                .getWsDateTime()
                .getWsCurtimeHhMmSs()
                .setWsCurtimeSs(
        ...
        // [T-Up#INFO][COTRN01C.cbl, LINE #297] MOVE statement
    ...
    void readTransactFile(OpenFrameContext context) {
        Cotrn01cVariableContainer container = (Cotrn01cVariableContainer) context
                .getProgramVariableContainer("Cotrn01c");
        // [T-Up#INFO][COTRN01C.cbl, LINE #304] EXEC_CICS statement
        /*
                       EXEC CICS READ                                               
        ...
        try {
            AwsM2CarddemoTransactVsamKsdsDto awsM2CarddemoTransactVsamKsdsDto = recordKeyAccessor
                    .readForUpdate("awsM2CarddemoTransactVsamKsdsDao",
                            container.getTranRecord().getTranId());
            container
                    .setTranRecord(Cotrn01cTranRecordToAwsM2CarddemoTransactVsamKsdsDto.INSTANCE
        ...
        // [T-Up#INFO][COTRN01C.cbl, LINE #315] EVALUATE statement
        if (container.getWsVariables().getWsRespCd() == 0) {
            // [T-Up#INFO][COTRN01C.cbl, LINE #317] CONTINUE statement
        } else if (container.getWsVariables().getWsRespCd() == 13) {
            // [T-Up#INFO][COTRN01C.cbl, LINE #319] MOVE statement
            container.getWsVariables().setWsErrFlg("Y");
            // [T-Up#INFO][COTRN01C.cbl, LINE #320] MOVE statement
            container.getWsVariables().setWsMessage(
                    "Transaction ID NOT found...");
            // [T-Up#INFO][COTRN01C.cbl, LINE #322] MOVE statement
            container.getCotrn1ai().setTrnidinl(-1);
            // [T-Up#INFO][COTRN01C.cbl, LINE #323] PERFORM statement
            controlManager.run(context, sendTrnviewScreen);
            if (controlManager.isTerminate(context)) {
                return;
            }
        } else {
            // [T-Up#INFO][COTRN01C.cbl, LINE #325] DISPLAY statement
            ...
            // [T-Up#INFO][COTRN01C.cbl, LINE #326] MOVE statement
            container.getWsVariables().setWsErrFlg("Y");
            // [T-Up#INFO][COTRN01C.cbl, LINE #327] MOVE statement
            container.getWsVariables().setWsMessage(
                    "Unable to lookup Transaction...");
            // [T-Up#INFO][COTRN01C.cbl, LINE #329] MOVE statement
            container.getCotrn1ai().setTrnidinl(-1);
            // [T-Up#INFO][COTRN01C.cbl, LINE #330] PERFORM statement
            controlManager.run(context, sendTrnviewScreen);
            if (controlManager.isTerminate(context)) {
                return;
            }
    ...
    void clearCurrentScreen(OpenFrameContext context) {
        // [T-Up#INFO][COTRN01C.cbl, LINE #338] PERFORM statement
        controlManager.run(context, initializeAllFields);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COTRN01C.cbl, LINE #339] PERFORM statement
        controlManager.run(context, sendTrnviewScreen);
        if (controlManager.isTerminate(context)) {
            return;
        }
    ...
    void initializeAllFields(OpenFrameContext context) {
        Cotrn01cVariableContainer container = (Cotrn01cVariableContainer) context
                .getProgramVariableContainer("Cotrn01c");
        // [T-Up#INFO][COTRN01C.cbl, LINE #346] MOVE statement
        container.getCotrn1ai().setTrnidinl(-1);
        // [T-Up#INFO][COTRN01C.cbl, LINE #347] MOVE statement
