 ...
 * <ul>
 * <li>converted COBOL program: {@link aws.carddemo.Cbcus01c}</li>
 * </ul>
 */
@Getter
@Setter
...
public class Cbcus01cTasklet implements Tasklet {
    private Map<String, Dd> dd;
    private String parm;
    private final Cbcus01c program;
