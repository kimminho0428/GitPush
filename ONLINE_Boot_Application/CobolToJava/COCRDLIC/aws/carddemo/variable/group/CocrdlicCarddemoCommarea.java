 ...
 */
public @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdlicCarddemoCommarea {
    // [T-Up#INFO][COCOM01Y.cpy, LINE #21] CDEMO-GENERAL-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdlicCdemoGeneralInfo cdemoGeneralInfo = new CocrdlicCdemoGeneralInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #33] CDEMO-CUSTOMER-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdlicCdemoCustomerInfo cdemoCustomerInfo = new CocrdlicCdemoCustomerInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #38] CDEMO-ACCOUNT-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdlicCdemoAccountInfo cdemoAccountInfo = new CocrdlicCdemoAccountInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #41] CDEMO-CARD-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdlicCdemoCardInfo cdemoCardInfo = new CocrdlicCdemoCardInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #43] CDEMO-MORE-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdlicCdemoMoreInfo cdemoMoreInfo = new CocrdlicCdemoMoreInfo();

    public static CocrdlicCarddemoCommarea createDefaultValueInstance() {
        return new CocrdlicCarddemoCommarea.builder()
                .cdemoGeneralInfo(
                        CocrdlicCdemoGeneralInfo.createDefaultValueInstance())
                .cdemoCustomerInfo(
                        CocrdlicCdemoCustomerInfo.createDefaultValueInstance())
                .cdemoAccountInfo(
                        CocrdlicCdemoAccountInfo.createDefaultValueInstance())
                .cdemoCardInfo(
                        CocrdlicCdemoCardInfo.createDefaultValueInstance())
                .cdemoMoreInfo(
                        CocrdlicCdemoMoreInfo.createDefaultValueInstance())
                .build();
    }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdlicCdemoGeneralInfo {
        ...
        public static CocrdlicCdemoGeneralInfo createDefaultValueInstance() {
            return new CocrdlicCdemoGeneralInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdlicCdemoCustomerInfo {
        ...
        public static CocrdlicCdemoCustomerInfo createDefaultValueInstance() {
            return new CocrdlicCdemoCustomerInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdlicCdemoAccountInfo {
        ...
        public static CocrdlicCdemoAccountInfo createDefaultValueInstance() {
            return new CocrdlicCdemoAccountInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdlicCdemoCardInfo {
        // [T-Up#INFO][COCOM01Y.cpy, LINE #42] CDEMO-CARD-NUM (level: 10)
        private @Getter @Setter long cdemoCardNum;

        public static CocrdlicCdemoCardInfo createDefaultValueInstance() {
            return new CocrdlicCdemoCardInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdlicCdemoMoreInfo {
        ...
        public static CocrdlicCdemoMoreInfo createDefaultValueInstance() {
            return new CocrdlicCdemoMoreInfo.builder().build();
        }
