...
import aws.carddemo.mapper.CoactupcMapperInterface.*;
...
import static aws.carddemo.variable.CoactupcVariableContainer.*;
import static aws.carddemo.variable.group.CoactupcCarddemoCommarea.CoactupcCdemoGeneralInfo.*;
import static aws.carddemo.variable.group.CoactupcCcWorkAreas.CoactupcCcWorkArea.*;
import static aws.carddemo.variable.group.CoactupcUsStateZipcodeToEdit.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsCalculationVars.CoactupcWsEditDateCcyymmdd.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsCalculationVars.CoactupcWsEditDateCcyymmdd.CoactupcWsEditDateCcyy.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsCalculationVars.CoactupcWsEditDateFlgs.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsFileReadFlags.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsGenericEdits.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsGenericEdits.CoactupcWsEditUsPhoneNumFlgs.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsGenericEdits.CoactupcWsEditUsSsn.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsGenericEdits.CoactupcWsEditUsSsnFlgs.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsNonKeyFlags.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsNonKeyFlags.CoactupcWsEditAddressFlags.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsNonKeyFlags.CoactupcWsEditAddressFlags.CoactupcWsEditPhoneNum1Flgs.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsNonKeyFlags.CoactupcWsEditAddressFlags.CoactupcWsEditPhoneNum2Flgs.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsNonKeyFlags.CoactupcWsEditDtOfBirthFlgs.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsNonKeyFlags.CoactupcWsEditNameFlags.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsNonKeyFlags.CoactupcWsEditOpenDateFlgs.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsNonKeyFlags.CoactupcWsEditReissueDateFlgs.*;
import static aws.carddemo.variable.group.CoactupcWsMiscStorage.CoactupcWsNonKeyFlags.CoactupcWsExpiryDateFlgs.*;
import static aws.carddemo.variable.group.CoactupcWsThisProgcommarea.CoactupcAcctUpdateScreenData.*;
import static aws.carddemo.variable.group.CoactupcWsThisProgcommarea.CoactupcAcupNewDetails.CoactupcAcupNewCustData.*;
...
public class Coactupc {
    ...
    void _0000Main(OpenFrameContext context) {
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #863] EXEC_CICS statement
        /*
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #867] INITIALIZE statement
        container.getCcWorkAreas().setCcWorkArea(
                CoactupcCcWorkAreas.CoactupcCcWorkArea
        ...
        if (task.hasCommarea() == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #887] INITIALIZE statement
            container.setCarddemoCommarea(CoactupcCarddemoCommarea
                    .createDefaultValueInstance());
            container.setWsThisProgcommarea(CoactupcWsThisProgcommarea
                    .createDefaultValueInstance());
            // [T-Up#INFO][COACTUPC.cbl, LINE #889] SET statement
            container.getCarddemoCommarea().getCdemoGeneralInfo()
                    .setCdemoPgmContext(CDEMO_PGM_ENTER);
            // [T-Up#INFO][COACTUPC.cbl, LINE #890] SET statement
            container.getWsThisProgcommarea().getAcctUpdateScreenData()
                    .setAcupChangeAction(ACUP_DETAILS_NOT_FETCHED_1);
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #892] MOVE statement
            container.getCarddemoCommarea().set(
                    container.getDfhcommarea().get().substring(0, 160));
            // [T-Up#INFO][COACTUPC.cbl, LINE #894] MOVE statement
        ...
        // ***************************************************************** 
        // [T-Up#INFO][COACTUPC.cbl, LINE #902] PERFORM statement
        ...
        // ***************************************************************** 
        // [T-Up#INFO][COACTUPC.cbl, LINE #909] SET statement
        container.getWsMiscStorage().setWsPfkFlag(PFK_INVALID);
        // [T-Up#INFO][COACTUPC.cbl, LINE #910] IF statement
        if (((CobStringUtils.compare(container.getCcWorkAreas().getCcWorkArea()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #915] SET statement
            container.getWsMiscStorage().setWsPfkFlag(PFK_VALID);
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #918] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage().getWsPfkFlag(),
                PFK_INVALID) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #919] SET statement
        ...
        // ***************************************************************** 
        // [T-Up#INFO][COACTUPC.cbl, LINE #925] EVALUATE statement
        if (CobStringUtils.compare(container.getCcWorkAreas().getCcWorkArea()
            ...
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #932] SET statement
            container.getCcWorkAreas().getCcWorkArea()
                    .setCcardAid(CCARD_AID_PFK03);
            // [T-Up#INFO][COACTUPC.cbl, LINE #934] IF statement
            if (CobStringUtils.compare(container.getCarddemoCommarea()
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #936] MOVE statement
                container
                        .getCarddemoCommarea()
                        .getCdemoGeneralInfo()
                        .setCdemoToTranid(
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #938] MOVE statement
                container
                        .getCarddemoCommarea()
                        .getCdemoGeneralInfo()
                        .setCdemoToTranid(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #941] IF statement
            if (CobStringUtils.compare(container.getCarddemoCommarea()
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #943] MOVE statement
                container
                        .getCarddemoCommarea()
                        .getCdemoGeneralInfo()
                        .setCdemoToProgram(
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #945] MOVE statement
                container
                        .getCarddemoCommarea()
                        .getCdemoGeneralInfo()
                        .setCdemoToProgram(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #948] MOVE statement
            container
                    .getCarddemoCommarea()
                    .getCdemoGeneralInfo()
                    .setCdemoFromTranid(
                            container.getWsLiterals().getLitThistranid());
            // [T-Up#INFO][COACTUPC.cbl, LINE #949] MOVE statement
            container
                    .getCarddemoCommarea()
                    .getCdemoGeneralInfo()
                    .setCdemoFromProgram(
                            container.getWsLiterals().getLitThispgm());
            // [T-Up#INFO][COACTUPC.cbl, LINE #951] SET statement
            container.getCarddemoCommarea().getCdemoGeneralInfo()
                    .setCdemoUserType(CDEMO_USRTYP_USER);
            // [T-Up#INFO][COACTUPC.cbl, LINE #952] SET statement
            container.getCarddemoCommarea().getCdemoGeneralInfo()
                    .setCdemoPgmContext(CDEMO_PGM_ENTER);
            // [T-Up#INFO][COACTUPC.cbl, LINE #953] MOVE statement
            container
                    .getCarddemoCommarea()
                    .getCdemoMoreInfo()
                    .setCdemoLastMapset(
                            container.getWsLiterals().getLitThismapset());
            // [T-Up#INFO][COACTUPC.cbl, LINE #954] MOVE statement
            container.getCarddemoCommarea().getCdemoMoreInfo()
                    .setCdemoLastMap(container.getWsLiterals().getLitThismap());
            // [T-Up#INFO][COACTUPC.cbl, LINE #956] EXEC_CICS statement
            /*
                                   EXEC CICS                                            
                                        SYNCPOINT                                       
                                   END-EXEC
             */
            // [T-Up#ERROR][COACTUPC.cbl, LINE #956] Migration failed for EXEC_CICS statement : UN_SUPPORTED_COMMAND
            // [T-Up#INFO][COACTUPC.cbl, LINE #960] EXEC_CICS statement
            /*
                                   EXEC CICS XCTL                                       
                                        PROGRAM ('COMEN01C')                            
            ...
            comen01cInputDto
                    .setDfhcommarea(CoactupcCarddemoCommareaToComen01cDfhcommarea.INSTANCE
            ...
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #972] INITIALIZE statement
            container.setWsThisProgcommarea(CoactupcWsThisProgcommarea
                    .createDefaultValueInstance());
            // [T-Up#INFO][COACTUPC.cbl, LINE #973] PERFORM statement
            controlManager.run(context, _3000SendMap, _3000SendMapExit);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #975] SET statement
            container.getCarddemoCommarea().getCdemoGeneralInfo()
                    .setCdemoPgmContext(CDEMO_PGM_REENTER);
            // [T-Up#INFO][COACTUPC.cbl, LINE #976] SET statement
            container.getWsThisProgcommarea().getAcctUpdateScreenData()
                    .setAcupChangeAction(ACUP_DETAILS_NOT_FETCHED_1);
            // [T-Up#INFO][COACTUPC.cbl, LINE #977] GOTO statement
            ...
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #985] INITIALIZE statement
            container.setWsThisProgcommarea(CoactupcWsThisProgcommarea
                    .createDefaultValueInstance());
            container.setWsMiscStorage(CoactupcWsMiscStorage
                    .createDefaultValueInstance());
            container.getCarddemoCommarea().getCdemoAccountInfo()
                    .setCdemoAcctId(0);
            // [T-Up#INFO][COACTUPC.cbl, LINE #988] SET statement
            container.getCarddemoCommarea().getCdemoGeneralInfo()
                    .setCdemoPgmContext(CDEMO_PGM_ENTER);
            // [T-Up#INFO][COACTUPC.cbl, LINE #989] PERFORM statement
            controlManager.run(context, _3000SendMap, _3000SendMapExit);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #991] SET statement
            container.getCarddemoCommarea().getCdemoGeneralInfo()
                    .setCdemoPgmContext(CDEMO_PGM_REENTER);
            // [T-Up#INFO][COACTUPC.cbl, LINE #992] SET statement
            container.getWsThisProgcommarea().getAcctUpdateScreenData()
                    .setAcupChangeAction(ACUP_DETAILS_NOT_FETCHED_1);
            // [T-Up#INFO][COACTUPC.cbl, LINE #993] GOTO statement
            context.setGotoTarget(commonReturn);
            return;
        } else {
            // ******************************************************************
            ...
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #1001] PERFORM statement
            controlManager.run(context, _1000ProcessInputs,
                    _1000ProcessInputsExit);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #1003] PERFORM statement
            controlManager.run(context, _2000DecideAction,
                    _2000DecideActionExit);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #1005] PERFORM statement
            controlManager.run(context, _3000SendMap, _3000SendMapExit);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #1007] GOTO statement
            context.setGotoTarget(commonReturn);
            return;
        }
    }
    ...
    void _0000MainExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #1026] EXIT statement
    }

    void _1000ProcessInputs(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1030] PERFORM statement
        controlManager.run(context, _1100ReceiveMap, _1100ReceiveMapExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1032] PERFORM statement
        controlManager.run(context, _1200EditMapInputs, _1200EditMapInputsExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1034] MOVE statement
        container
                .getCcWorkAreas()
                .getCcWorkArea()
                .setCcardErrorMsg(container.getWsMiscStorage().getWsReturnMsg());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1035] MOVE statement
        container.getCcWorkAreas().getCcWorkArea()
                .setCcardNextProg(container.getWsLiterals().getLitThispgm());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1036] MOVE statement
        container
                .getCcWorkAreas()
                .getCcWorkArea()
                .setCcardNextMapset(
                        container.getWsLiterals().getLitThismapset());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1037] MOVE statement
        container.getCcWorkAreas().getCcWorkArea()
    ...
    void _1000ProcessInputsExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #1041] EXIT statement
    }

    void _1100ReceiveMap(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1044] EXEC_CICS statement
        /*
        ...
        // *                                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #1051] INITIALIZE statement
        ...
        // *    Account Master data                                          
        // ******************************************************************
        // [T-Up#INFO][COACTUPC.cbl, LINE #1055] IF statement
        if (CobStringUtils.compare(container.getCactupai().getAcctsidi(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1057] MOVE statement
            container.getCcWorkAreas().getCcWorkArea()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1060] MOVE statement
            container.getCcWorkAreas().getCcWorkArea()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1064] IF statement
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcrdlimi(), "*") == 0
            ...
            if (IntrinsicFunction.functionTestNumvalC(container
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #1083] COMPUTE statement
                container
                        .getWsThisProgcommarea()
                        .getAcupNewDetails()
                        .getAcupNewAcctData()
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #1086] CONTINUE statement
            }
        }
        // * Cash Limit                                                      
        // [T-Up#INFO][COACTUPC.cbl, LINE #1091] IF statement
        if (CobStringUtils.compare(container.getCactupai().getAcshlimi(), "*") == 0
                || CobStringUtils.compare(
                        container.getCactupai().getAcshlimi(),
                        StringUtils.repeat(' ', 15)) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1093] MOVE statement
            container
                    .getWsMiscStorage()
                    .getAlphaVarsForDataEditing()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1095] MOVE statement
            container
                    .getWsMiscStorage()
                    .getAlphaVarsForDataEditing()
                    .setAcupNewCashCreditLimitX(
                            container.getCactupai().getAcshlimi());
            // [T-Up#INFO][COACTUPC.cbl, LINE #1096] IF statement
            if (IntrinsicFunction.functionTestNumvalC(container
                    .getWsMiscStorage().getAlphaVarsForDataEditing()
                    .getAcupNewCashCreditLimitX(), null) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1097] COMPUTE statement
                container
                        .getWsThisProgcommarea()
                        .getAcupNewDetails()
                        .getAcupNewAcctData()
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #1100] CONTINUE statement
            }
        }
        // * Current Balance                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #1105] IF statement
        if (CobStringUtils.compare(container.getCactupai().getAcurbali(), "*") == 0
                || CobStringUtils.compare(
                        container.getCactupai().getAcurbali(),
                        StringUtils.repeat(' ', 15)) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1107] MOVE statement
            container.getWsMiscStorage().getAlphaVarsForDataEditing()
                    .setAcupNewCurrBalX(StringUtils.repeat((char) 0x00, 15));
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1109] MOVE statement
            container.getWsMiscStorage().getAlphaVarsForDataEditing()
                    .setAcupNewCurrBalX(container.getCactupai().getAcurbali());
            // [T-Up#INFO][COACTUPC.cbl, LINE #1110] IF statement
            if (IntrinsicFunction.functionTestNumvalC(container
                    .getWsMiscStorage().getAlphaVarsForDataEditing()
                    .getAcupNewCurrBalX(), null) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1111] COMPUTE statement
                container
                        .getWsThisProgcommarea()
                        .getAcupNewDetails()
                        .getAcupNewAcctData()
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #1114] CONTINUE statement
            }
        }
        // *Current Cycle Credit                                             
        // [T-Up#INFO][COACTUPC.cbl, LINE #1119] IF statement
        if (CobStringUtils.compare(container.getCactupai().getAcrcycri(), "*") == 0
                || CobStringUtils.compare(
                        container.getCactupai().getAcrcycri(),
                        StringUtils.repeat(' ', 15)) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1121] MOVE statement
            container
                    .getWsMiscStorage()
                    .getAlphaVarsForDataEditing()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1123] MOVE statement
            container
                    .getWsMiscStorage()
                    .getAlphaVarsForDataEditing()
                    .setAcupNewCurrCycCreditX(
                            container.getCactupai().getAcrcycri());
            // [T-Up#INFO][COACTUPC.cbl, LINE #1124] IF statement
            if (IntrinsicFunction.functionTestNumvalC(container
                    .getWsMiscStorage().getAlphaVarsForDataEditing()
                    .getAcupNewCurrCycCreditX(), null) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1125] COMPUTE statement
                container
                        .getWsThisProgcommarea()
                        .getAcupNewDetails()
                        .getAcupNewAcctData()
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #1128] CONTINUE statement
            }
        }
        // *Current Cycle Debit                                              
        // [T-Up#INFO][COACTUPC.cbl, LINE #1133] IF statement
        if (CobStringUtils.compare(container.getCactupai().getAcrcydbi(), "*") == 0
                || CobStringUtils.compare(
                        container.getCactupai().getAcrcydbi(),
                        StringUtils.repeat(' ', 15)) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1135] MOVE statement
            container
                    .getWsMiscStorage()
                    .getAlphaVarsForDataEditing()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1137] MOVE statement
            container
                    .getWsMiscStorage()
                    .getAlphaVarsForDataEditing()
                    .setAcupNewCurrCycDebitX(
                            container.getCactupai().getAcrcydbi());
            // [T-Up#INFO][COACTUPC.cbl, LINE #1138] IF statement
            if (IntrinsicFunction.functionTestNumvalC(container
                    .getWsMiscStorage().getAlphaVarsForDataEditing()
                    .getAcupNewCurrCycDebitX(), null) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1139] COMPUTE statement
                container
                        .getWsThisProgcommarea()
                        .getAcupNewDetails()
                        .getAcupNewAcctData()
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #1142] CONTINUE statement
            }
        }
        // *Open date                                                        
        // *                                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #1148] IF statement
        if (CobStringUtils.compare(container.getCactupai().getOpnyeari(), "*") == 0
                || CobStringUtils.compare(
                        container.getCactupai().getOpnyeari(),
                        StringUtils.repeat(' ', 4)) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1150] MOVE statement
            container.getWsThisProgcommarea().getAcupNewDetails()
                    .getAcupNewAcctData()
                    .setAcupNewOpenYear(StringUtils.repeat((char) 0x00, 4));
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1152] MOVE statement
            container.getWsThisProgcommarea().getAcupNewDetails()
                    .getAcupNewAcctData()
                    .setAcupNewOpenYear(container.getCactupai().getOpnyeari());
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1155] IF statement
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcstfcoi(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1287] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsfnami(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1296] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsmnami(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1305] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcslnami(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1314] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsadl1i(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1323] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsadl2i(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1330] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcscityi(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1337] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcssttei(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1344] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsctryi(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1351] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsph1ai(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1365] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsph1bi(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1372] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsph1ci(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1379] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsph2ai(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1386] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsph2bi(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1393] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsph2ci(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1400] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcsgovti(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1409] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcseftci(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1418] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
        ...
        if (CobStringUtils.compare(container.getCactupai().getAcspflgi(), "*") == 0
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1427] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupNewDetails()
                    .getAcupNewCustData()
    ...
    void _1100ReceiveMapExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #1431] EXIT statement
    }

    void _1200EditMapInputs(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1435] SET statement
        container.getWsMiscStorage().setWsInputFlag(INPUT_OK);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1437] IF statement
        if (CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_DETAILS_NOT_FETCHED_1) == 0
                || CobStringUtils.compare(container.getWsThisProgcommarea()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1439] PERFORM statement
            controlManager.run(context, _1210EditAccount, _1210EditAccountExit);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #1442] MOVE statement
            container
                    .getWsThisProgcommarea()
                    .getAcupOldDetails()
                    .setAcupOldAcctData(
                            CoactupcWsThisProgcommarea.CoactupcAcupOldDetails.CoactupcAcupOldAcctData
                                    .createDefaultValueInstance());
            // *       IF THE SEARCH CONDITIONS HAVE PROBLEMS FLAG THEM          
            // [T-Up#INFO][COACTUPC.cbl, LINE #1445] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsEditAcctFlag(), FLG_ACCTFILTER_BLANK) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1446] SET statement
        ...
        if ((CobStringUtils.compare(container.getWsMiscStorage()
                ...
                || CobStringUtils.compare(container.getWsThisProgcommarea()
                        .getAcctUpdateScreenData().getAcupChangeAction(),
                        ACUP_CHANGES_OKAYED_AND_DONE) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1470] MOVE statement
            container.getWsMiscStorage().setWsNonKeyFlags(
                    CoactupcWsMiscStorage.CoactupcWsNonKeyFlags
                            .createDefaultValueInstance());
            // [T-Up#INFO][COACTUPC.cbl, LINE #1471] GOTO statement
            context.setGotoTarget(_1200EditMapInputsExit);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1474] SET statement
        container.getWsThisProgcommarea().getAcctUpdateScreenData()
                .setAcupChangeAction(ACUP_CHANGES_NOT_OK);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1476] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Account Status");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1477] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditYesNo(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1478] PERFORM statement
        controlManager.run(context, _1220EditYesno, _1220EditYesnoExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1480] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .setWsEditAcctStatus(
                        container.getWsMiscStorage().getWsGenericEdits()
                                .getWsEditYesNo());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1482] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Open Date");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1483] MOVE statement
        container
                .getWsMiscStorage()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1484] PERFORM statement
        controlManager.run(context, editDateCcyymmdd, editDateCcyymmddExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1486] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditOpenDateFlgs()
                .set(container.getWsMiscStorage().getWsCalculationVars()
                        .getWsEditDateFlgs());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1488] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Credit Limit");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1489] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1490] PERFORM statement
        controlManager.run(context, _1250EditSigned9v2, _1250EditSigned9v2Exit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1492] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1494] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Expiry Date");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1495] MOVE statement
        container
                .getWsMiscStorage()
                .getWsCalculationVars()
                .getWsEditDateCcyymmdd()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1496] PERFORM statement
        controlManager.run(context, editDateCcyymmdd, editDateCcyymmddExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1498] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsExpiryDateFlgs()
                .set(container.getWsMiscStorage().getWsCalculationVars()
                        .getWsEditDateFlgs());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1500] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Cash Credit Limit");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1501] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditSignedNumber9v2X(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1503] PERFORM statement
        controlManager.run(context, _1250EditSigned9v2, _1250EditSigned9v2Exit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1505] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .setWsEditCashCreditLimit(
                        container.getWsMiscStorage().getWsGenericEdits()
                                .getWsFlgSignedNumberEdit());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1507] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Reissue Date");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1508] MOVE statement
        container
                .getWsMiscStorage()
                .getWsCalculationVars()
                .getWsEditDateCcyymmdd()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1509] PERFORM statement
        controlManager.run(context, editDateCcyymmdd, editDateCcyymmddExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1511] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditReissueDateFlgs()
                .set(container.getWsMiscStorage().getWsCalculationVars()
                        .getWsEditDateFlgs());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1513] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Current Balance");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1514] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditSignedNumber9v2X(
                        container.getWsMiscStorage()
                                .getAlphaVarsForDataEditing()
                                .getAcupNewCurrBalX());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1515] PERFORM statement
        controlManager.run(context, _1250EditSigned9v2, _1250EditSigned9v2Exit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1517] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .setWsEditCurrBal(
                        container.getWsMiscStorage().getWsGenericEdits()
                                .getWsFlgSignedNumberEdit());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1519] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Current Cycle Credit Limit");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1520] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditSignedNumber9v2X(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1522] PERFORM statement
        controlManager.run(context, _1250EditSigned9v2, _1250EditSigned9v2Exit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1524] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .setWsEditCurrCycCredit(
                        container.getWsMiscStorage().getWsGenericEdits()
                                .getWsFlgSignedNumberEdit());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1526] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Current Cycle Debit Limit");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1527] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditSignedNumber9v2X(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1529] PERFORM statement
        controlManager.run(context, _1250EditSigned9v2, _1250EditSigned9v2Exit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1531] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .setWsEditCurrCycDebit(
                        container.getWsMiscStorage().getWsGenericEdits()
                                .getWsFlgSignedNumberEdit());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1533] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("SSN");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1534] PERFORM statement
        controlManager.run(context, _1265EditUsSsn, _1265EditUsSsnExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1537] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Date of Birth");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1538] MOVE statement
        container
                .getWsMiscStorage()
                .getWsCalculationVars()
                .getWsEditDateCcyymmdd()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1540] PERFORM statement
        controlManager.run(context, editDateCcyymmdd, editDateCcyymmddExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1542] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditDtOfBirthFlgs()
                .set(container.getWsMiscStorage().getWsCalculationVars()
                        .getWsEditDateFlgs());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1543] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsNonKeyFlags().getWsEditDtOfBirthFlgs().get(),
                WS_EDIT_DT_OF_BIRTH_ISVALID) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1544] PERFORM statement
            controlManager.run(context, editDateOfBirth, editDateOfBirthExit);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #1546] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsNonKeyFlags()
                    .getWsEditDtOfBirthFlgs()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1549] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("FICO Score");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1550] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1552] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumLength(3);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1553] PERFORM statement
        controlManager.run(context, _1245EditNumReqd, _1245EditNumReqdExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1555] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1557] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsNonKeyFlags().getWsEditFicoScoreFlgs(),
                FLG_FICO_SCORE_ISVALID) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1558] PERFORM statement
        ...
        // *    Edit names                                                   
        // ******************************************************************
        // [T-Up#INFO][COACTUPC.cbl, LINE #1564] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("First Name");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1565] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1566] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumLength(25);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1567] PERFORM statement
        controlManager.run(context, _1225EditAlphaReqd, _1225EditAlphaReqdExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1569] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditNameFlags()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1572] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Middle Name");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1573] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1574] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumLength(25);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1575] PERFORM statement
        controlManager.run(context, _1235EditAlphaOpt, _1235EditAlphaOptExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1577] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditNameFlags()
                .setWsEditMiddleNameFlgs(
                        container.getWsMiscStorage().getWsGenericEdits()
                                .getWsEditAlphaOnlyFlags());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1580] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Last Name");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1581] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1582] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumLength(25);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1583] PERFORM statement
        controlManager.run(context, _1225EditAlphaReqd, _1225EditAlphaReqdExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1585] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditNameFlags()
                .setWsEditLastNameFlgs(
                        container.getWsMiscStorage().getWsGenericEdits()
                                .getWsEditAlphaOnlyFlags());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1588] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Address Line 1");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1589] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1590] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumLength(50);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1591] PERFORM statement
        controlManager.run(context, _1215EditMandatory, _1215EditMandatoryExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1593] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1596] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("State");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1597] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1598] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumLength(2);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1599] PERFORM statement
        controlManager.run(context, _1225EditAlphaReqd, _1225EditAlphaReqdExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1601] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditAddressFlags()
                .setWsEditStateFlgs(
                        container.getWsMiscStorage().getWsGenericEdits()
                                .getWsEditAlphaOnlyFlags());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1603] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsGenericEdits().getWsEditAlphaOnlyFlags(),
                FLG_ALPHA_ISVALID) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1604] PERFORM statement
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1609] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Zip");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1610] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1611] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumLength(5);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1612] PERFORM statement
        controlManager.run(context, _1245EditNumReqd, _1245EditNumReqdExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1614] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditAddressFlags()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1619] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("City");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1620] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1621] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumLength(50);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1622] PERFORM statement
        controlManager.run(context, _1225EditAlphaReqd, _1225EditAlphaReqdExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1624] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditAddressFlags()
                .setWsEditCityFlgs(
                        container.getWsMiscStorage().getWsGenericEdits()
                                .getWsEditAlphaOnlyFlags());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1627] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Country");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1628] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1630] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumLength(3);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1631] PERFORM statement
        controlManager.run(context, _1225EditAlphaReqd, _1225EditAlphaReqdExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1633] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditAddressFlags()
                .setWsEditCountryFlgs(
                        container.getWsMiscStorage().getWsGenericEdits()
                                .getWsEditAlphaOnlyFlags());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1636] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Phone Number 1");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1637] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditUsPhoneNum(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1639] PERFORM statement
        controlManager.run(context, _1260EditUsPhoneNum,
                _1260EditUsPhoneNumExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1641] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditAddressFlags()
                .getWsEditPhoneNum1Flgs()
                .set(container.getWsMiscStorage().getWsGenericEdits()
                        .getWsEditUsPhoneNumFlgs());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1644] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Phone Number 2");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1645] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditUsPhoneNum(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1647] PERFORM statement
        controlManager.run(context, _1260EditUsPhoneNum,
                _1260EditUsPhoneNumExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1649] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .getWsEditAddressFlags()
                .getWsEditPhoneNum2Flgs()
                .set(container.getWsMiscStorage().getWsGenericEdits()
                        .getWsEditUsPhoneNumFlgs());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1652] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("EFT Account Id");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1653] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1655] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumLength(10);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1656] PERFORM statement
        controlManager.run(context, _1245EditNumReqd, _1245EditNumReqdExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1658] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
                .setWsEftAccountIdFlgs(
                        container.getWsMiscStorage().getWsGenericEdits()
                                .getWsEditAlphanumOnlyFlags());
        // [T-Up#INFO][COACTUPC.cbl, LINE #1661] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("Primary Card Holder");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1662] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditYesNo(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1664] PERFORM statement
        controlManager.run(context, _1220EditYesno, _1220EditYesnoExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1666] MOVE statement
        container
                .getWsMiscStorage()
                .getWsNonKeyFlags()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1669] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1671] PERFORM statement
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #1675] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsInputFlag(), INPUT_ERROR) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1676] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1678] SET statement
            container.getWsThisProgcommarea().getAcctUpdateScreenData()
    ...
    void _1200EditMapInputsExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #1683] EXIT statement
    }

    void _1205CompareOldNew(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #1686] SET statement
        container.getWsMiscStorage().setWsDatachangedFlag(NO_CHANGES_FOUND);
        // [T-Up#INFO][COACTUPC.cbl, LINE #1688] IF statement
        if (CobStringUtils.compare(container.getWsThisProgcommarea()
                ...
                && CobStringUtils.compare(container.getWsThisProgcommarea()
                        ...
                        .toUpperCase()) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1705] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1707] SET statement
            container.getWsMiscStorage().setWsDatachangedFlag(
                    CHANGE_HAS_OCCURRED);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1708] GOTO statement
            context.setGotoTarget(_1205CompareOldNewExit);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1712] IF statement
        if (CobStringUtils.compare(container.getWsThisProgcommarea()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1773] SET statement
            container.getWsMiscStorage().setWsReturnMsg(NO_CHANGES_DETECTED);
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1775] SET statement
            container.getWsMiscStorage().setWsDatachangedFlag(
                    CHANGE_HAS_OCCURRED);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1776] GOTO statement
            context.setGotoTarget(_1205CompareOldNewExit);
            return;
        }
    }
    ...
    void _1205CompareOldNewExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #1782] EXIT statement
    }
        ...
        container
                ...
                .setAcupNewAcctId(
                        Long.parseLong(container.getCcWorkAreas()
                                .getCcWorkArea().getCcAcctId()));
        // [T-Up#INFO][COACTUPC.cbl, LINE #1806] IF statement
        if (!StringUtils.isNumeric(container.getCcWorkAreas().getCcWorkArea()
                .getCcAcctId())
                || container.getCcWorkAreas().getCcWorkArea().getCcAcctIdN() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1808] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1809] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1810] STRING statement
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1816] MOVE statement
            container.getCarddemoCommarea().getCdemoAccountInfo()
                    .setCdemoAcctId((long) 0);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1817] GOTO statement
            context.setGotoTarget(_1210EditAccountExit);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1819] MOVE statement
            container
                    .getCarddemoCommarea()
                    .getCdemoAccountInfo()
                    .setCdemoAcctId(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1820] SET statement
    ...
    void _1210EditAccountExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #1825] EXIT statement
    }
    ...
    void _1215EditMandatory(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // *    Initialize                                                   
        // [T-Up#INFO][COACTUPC.cbl, LINE #1830] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditMandatoryFlags(FLG_MANDATORY_NOT_OK);
        // *    Not supplied                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #1833] IF statement
        if ((CobStringUtils.compare(
                ...
                StringUtils.repeat((char) 0x00, 256)) == 0 || CobStringUtils
                .compare(
                        container
                                .getWsMiscStorage()
                                .getWsGenericEdits()
                ...
                || container
                        ...
                        .length() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1840] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1841] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditMandatoryFlags(FLG_MANDATORY_BLANK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1842] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1843] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
    ...
    void _1220EditYesno(OpenFrameContext context) {
        ...
        // *                                                                 
        // *    Not supplied                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #1865] IF statement
        if ((CobStringUtils.compare(container.getWsMiscStorage()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1868] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1869] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditYesNo(FLG_YES_NO_BLANK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1870] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1871] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1878] GOTO statement
            context.setGotoTarget(_1220EditYesnoExit);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1882] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsGenericEdits().getWsEditYesNo(), FLG_YES_NO_ISVALID_1) == 0
                || CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsGenericEdits().getWsEditYesNo(),
                        FLG_YES_NO_ISVALID_2) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1883] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1885] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1886] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditYesNo(FLG_YES_NO_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1887] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1888] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1895] GOTO statement
            context.setGotoTarget(_1220EditYesnoExit);
            return;
        }
    }
    ...
    void _1220EditYesnoExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #1899] EXIT statement
    }
    ...
    void _1225EditAlphaReqd(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // *    Initialize                                                   
        // [T-Up#INFO][COACTUPC.cbl, LINE #1904] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphaOnlyFlags(FLG_ALPHA_NOT_OK);
        // *    Not supplied                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #1907] IF statement
        if ((CobStringUtils.compare(
                container
                        .getWsMiscStorage()
                        .getWsGenericEdits()
                ...
                || container
                        ...
                        .substring(
                                ...
                                0 + container.getWsMiscStorage()
                                        ...
                                        .getWsEditAlphanumLength()).trim()
                        .length() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1914] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1915] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphaOnlyFlags(FLG_ALPHA_BLANK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1916] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1917] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
                ...
                .setWsEditAlphanumOnly(
                        StringUtils.overlay(
                                ...
                                0, 0 + container.getWsMiscStorage()
                                        .getWsGenericEdits()
                                        .getWsEditAlphanumLength()));
        // [T-Up#INFO][COACTUPC.cbl, LINE #1934] IF statement
        if (container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .getWsEditAlphanumOnly()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1938] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1940] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1941] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphaOnlyFlags(FLG_ALPHA_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1942] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1943] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #1950] GOTO statement
            context.setGotoTarget(_1225EditAlphaReqdExit);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #1953] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphaOnlyFlags(FLG_ALPHA_ISVALID);
    }

    void _1225EditAlphaReqdExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #1956] EXIT statement
    }
    ...
    void _1230EditAlphanumReqd(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // *    Initialize                                                   
        // [T-Up#INFO][COACTUPC.cbl, LINE #1961] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_NOT_OK);
        // *    Not supplied                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #1964] IF statement
        if ((CobStringUtils.compare(
                container
                        .getWsMiscStorage()
                        .getWsGenericEdits()
                ...
                || container
                        ...
                        .substring(
                                ...
                                0 + container.getWsMiscStorage()
                                        ...
                                        .getWsEditAlphanumLength()).trim()
                        .length() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1971] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1972] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_BLANK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1973] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #1974] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
                ...
                .setWsEditAlphanumOnly(
                        StringUtils.overlay(
                                ...
                                0, 0 + container.getWsMiscStorage()
                                        .getWsGenericEdits()
                                        .getWsEditAlphanumLength()));
        // [T-Up#INFO][COACTUPC.cbl, LINE #1992] IF statement
        if (container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .getWsEditAlphanumOnly()
                .substring(
                        ...
                        0 + container.getWsMiscStorage().getWsGenericEdits()
                                .getWsEditAlphanumLength()).trim().length() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1996] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #1998] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #1999] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2000] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2001] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2008] GOTO statement
            context.setGotoTarget(_1230EditAlphanumReqdExit);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2011] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_ISVALID);
    }

    void _1230EditAlphanumReqdExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2014] EXIT statement
    }
    ...
    void _1235EditAlphaOpt(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // *    Initialize                                                   
        // [T-Up#INFO][COACTUPC.cbl, LINE #2018] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphaOnlyFlags(FLG_ALPHA_NOT_OK);
        // *    Not supplied                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #2021] IF statement
        if ((CobStringUtils.compare(
                container
                        .getWsMiscStorage()
                        .getWsGenericEdits()
                ...
                || container
                        ...
                        .substring(
                                ...
                                0 + container.getWsMiscStorage()
                                        ...
                                        .getWsEditAlphanumLength()).trim()
                        .length() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2028] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphaOnlyFlags(FLG_ALPHA_ISVALID);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2029] GOTO statement
            context.setGotoTarget(_1235EditAlphaOptExit);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2031] CONTINUE statement
        }
        // *    Only Alphabets and space allowed                             
        // [T-Up#INFO][COACTUPC.cbl, LINE #2035] MOVE statement
        container.setLitAllAlphaFrom(container.getWsLiterals()
                .getLitAllAlphanumFromX().getLitAllAlphaFromX().get());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2036] INSPECT statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
                        StringUtils.overlay(
                                ...
                                0, 0 + container.getWsMiscStorage()
                                        .getWsGenericEdits()
                                        .getWsEditAlphanumLength()));
        // [T-Up#INFO][COACTUPC.cbl, LINE #2040] IF statement
        if (container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .getWsEditAlphanumOnly()
                .substring(
                        ...
                        0 + container.getWsMiscStorage().getWsGenericEdits()
                                .getWsEditAlphanumLength()).trim().length() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2044] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2046] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2047] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphaOnlyFlags(FLG_ALPHA_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2048] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2049] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2056] GOTO statement
            context.setGotoTarget(_1235EditAlphaOptExit);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2059] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphaOnlyFlags(FLG_ALPHA_ISVALID);
    }

    void _1235EditAlphaOptExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2062] EXIT statement
    }
    ...
    void _1240EditAlphanumOpt(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // *    Initialize                                                   
        // [T-Up#INFO][COACTUPC.cbl, LINE #2067] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_NOT_OK);
        // *    Not supplied, but ok as optional                             
        // [T-Up#INFO][COACTUPC.cbl, LINE #2070] IF statement
        if ((CobStringUtils.compare(
                container
                        .getWsMiscStorage()
                        .getWsGenericEdits()
                ...
                || container
                        ...
                        .substring(
                                ...
                                0 + container.getWsMiscStorage()
                                        ...
                                        .getWsEditAlphanumLength()).trim()
                        .length() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2076] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_ISVALID);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2077] GOTO statement
            context.setGotoTarget(_1240EditAlphanumOptExit);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2079] CONTINUE statement
        }
        // *    Only Alphabets and space allowed                             
        // [T-Up#INFO][COACTUPC.cbl, LINE #2083] MOVE statement
        container.setLitAllAlphanumFrom(container.getWsLiterals()
                .getLitAllAlphanumFromX().get());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2084] INSPECT statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
                        StringUtils.overlay(
                                ...
                                0, 0 + container.getWsMiscStorage()
                                        .getWsGenericEdits()
                                        .getWsEditAlphanumLength()));
        // [T-Up#INFO][COACTUPC.cbl, LINE #2088] IF statement
        if (container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .getWsEditAlphanumOnly()
                .substring(
                        ...
                        0 + container.getWsMiscStorage().getWsGenericEdits()
                                .getWsEditAlphanumLength()).trim().length() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2092] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2094] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2095] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2096] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2097] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2104] GOTO statement
            context.setGotoTarget(_1240EditAlphanumOptExit);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2107] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_ISVALID);
    }

    void _1240EditAlphanumOptExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2110] EXIT statement
    }
    ...
    void _1245EditNumReqd(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // *    Initialize                                                   
        // [T-Up#INFO][COACTUPC.cbl, LINE #2115] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_NOT_OK);
        // *    Not supplied                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #2118] IF statement
        if ((CobStringUtils.compare(
                container
                        .getWsMiscStorage()
                        .getWsGenericEdits()
                ...
                || container
                        ...
                        .substring(
                                ...
                                0 + container.getWsMiscStorage()
                                        ...
                                        .getWsEditAlphanumLength()).trim()
                        .length() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2125] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2126] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_BLANK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2127] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2128] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2136] GOTO statement
            context.setGotoTarget(_1245EditNumReqdExit);
            return;
        }
        // *    Only all numeric allowed                                     
        // [T-Up#INFO][COACTUPC.cbl, LINE #2141] IF statement
        if (StringUtils.isNumeric(container
                ...
                .substring(
                        ...
                        0 + container.getWsMiscStorage().getWsGenericEdits()
                                .getWsEditAlphanumLength()))) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2143] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2145] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2146] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2147] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2148] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2155] GOTO statement
            context.setGotoTarget(_1245EditNumReqdExit);
            return;
        }
        // *    Must not be zero                                             
        // [T-Up#INFO][COACTUPC.cbl, LINE #2160] IF statement
        if (IntrinsicFunction.functionNumval(container
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2162] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2163] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2164] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2165] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2172] GOTO statement
            context.setGotoTarget(_1245EditNumReqdExit);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2174] CONTINUE statement
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2178] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumOnlyFlags(FLG_ALPHNANUM_ISVALID);
    }

    void _1245EditNumReqdExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2181] EXIT statement
    }
    ...
    void _1250EditSigned9v2(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2185] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsFlgSignedNumberEdit(FLG_SIGNED_NUMBER_NOT_OK);
        // *    Not supplied                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #2188] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                ...
                || CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsGenericEdits().getWsEditSignedNumber9v2X(),
                        StringUtils.repeat(' ', 15)) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2190] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2191] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsFlgSignedNumberEdit(FLG_SIGNED_NUMBER_BLANK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2192] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2193] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2200] GOTO statement
            context.setGotoTarget(_1250EditSigned9v2Exit);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2202] CONTINUE statement
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2205] IF statement
        if (IntrinsicFunction.functionTestNumvalC(container.getWsMiscStorage()
                .getWsGenericEdits().getWsEditSignedNumber9v2X(), null) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2206] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2208] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2209] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsFlgSignedNumberEdit(FLG_SIGNED_NUMBER_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2210] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2211] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2217] GOTO statement
            context.setGotoTarget(_1250EditSigned9v2Exit);
            return;
        }
        // *    If we got here all edits were cleared                        
        // [T-Up#INFO][COACTUPC.cbl, LINE #2222] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsFlgSignedNumberEdit(FLG_SIGNED_NUMBER_ISVALID);
    }

    void _1250EditSigned9v2Exit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2226] EXIT statement
    }
        ...
        if ((CobStringUtils.compare(container.getWsMiscStorage()
                ...
                && (CobStringUtils.compare(container.getWsMiscStorage()
                        ...
                        .compare(container.getWsMiscStorage()
                                ...
                                StringUtils.repeat((char) 0x00, 4)) == 0)) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2244] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .getWsEditUsPhoneNumFlgs().set(WS_EDIT_US_PHONE_IS_VALID);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2245] GOTO statement
            context.setGotoTarget(editUsPhoneExit);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2247] CONTINUE statement
        }
    }
    ...
    void editAreaCode(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2251] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsGenericEdits().getWsEditUsPhoneNuma(),
                StringUtils.repeat(' ', 3)) == 0
                || CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsGenericEdits().getWsEditUsPhoneNuma(),
                        StringUtils.repeat((char) 0x00, 3)) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2253] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2254] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .getWsEditUsPhoneNumFlgs()
                    .setWsEditUsPhoneaFlg(FLG_EDIT_US_PHONEA_BLANK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2255] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2256] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2263] GOTO statement
            context.setGotoTarget(editUsPhonePrefix);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2265] CONTINUE statement
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2268] IF statement
        if (StringUtils.isNumeric(container.getWsMiscStorage()
                .getWsGenericEdits().getWsEditUsPhoneNuma())) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2269] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2271] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2272] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .getWsEditUsPhoneNumFlgs()
                    .setWsEditUsPhoneaFlg(FLG_EDIT_US_PHONEA_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2273] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2274] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2281] GOTO statement
            context.setGotoTarget(editUsPhonePrefix);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2284] IF statement
        if (container.getWsMiscStorage().getWsGenericEdits()
                .getWsEditUsPhoneNumaN() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2285] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2286] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .getWsEditUsPhoneNumFlgs()
                    .setWsEditUsPhoneaFlg(FLG_EDIT_US_PHONEA_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2287] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2288] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2295] GOTO statement
            context.setGotoTarget(editUsPhonePrefix);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2297] CONTINUE statement
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2300] MOVE statement
        container.setWsUsPhoneAreaCodeToEdit(container.getWsMiscStorage()
                .getWsGenericEdits().getWsEditUsPhoneNuma().trim());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2302] IF statement
        if (CobStringUtils.compare(container.getWsUsPhoneAreaCodeToEdit(),
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2303] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2305] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2306] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .getWsEditUsPhoneNumFlgs()
                    .setWsEditUsPhoneaFlg(FLG_EDIT_US_PHONEA_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2307] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2308] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2315] GOTO statement
            context.setGotoTarget(editUsPhonePrefix);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2318] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .getWsEditUsPhoneNumFlgs()
    ...
    void editUsPhonePrefix(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2322] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsGenericEdits().getWsEditUsPhoneNumb(),
                StringUtils.repeat(' ', 3)) == 0
                || CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsGenericEdits().getWsEditUsPhoneNumb(),
                        StringUtils.repeat((char) 0x00, 3)) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2324] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2325] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .getWsEditUsPhoneNumFlgs()
                    .setWsEditEditUsPhoneb(FLG_EDIT_US_PHONEB_BLANK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2326] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2327] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2334] GOTO statement
            context.setGotoTarget(editUsPhoneLinenum);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2336] CONTINUE statement
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2339] IF statement
        if (StringUtils.isNumeric(container.getWsMiscStorage()
                .getWsGenericEdits().getWsEditUsPhoneNumb())) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2340] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2342] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2343] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .getWsEditUsPhoneNumFlgs()
                    .setWsEditEditUsPhoneb(FLG_EDIT_US_PHONEB_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2344] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2345] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2352] GOTO statement
            context.setGotoTarget(editUsPhoneLinenum);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2355] IF statement
        if (container.getWsMiscStorage().getWsGenericEdits()
                .getWsEditUsPhoneNumbN() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2356] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2357] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .getWsEditUsPhoneNumFlgs()
                    .setWsEditEditUsPhoneb(FLG_EDIT_US_PHONEB_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2358] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2359] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2366] GOTO statement
            context.setGotoTarget(editUsPhoneLinenum);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2368] CONTINUE statement
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2371] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .getWsEditUsPhoneNumFlgs()
    ...
    void editUsPhoneLinenum(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2375] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsGenericEdits().getWsEditUsPhoneNumc(),
                StringUtils.repeat(' ', 4)) == 0
                || CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsGenericEdits().getWsEditUsPhoneNumc(),
                        StringUtils.repeat((char) 0x00, 4)) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2377] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2378] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .getWsEditUsPhoneNumFlgs()
                    .setWsEditEditPhonec(FLG_EDIT_US_PHONEC_BLANK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2379] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2380] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2387] GOTO statement
            context.setGotoTarget(editUsPhoneExit);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2389] CONTINUE statement
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2392] IF statement
        if (StringUtils.isNumeric(container.getWsMiscStorage()
                .getWsGenericEdits().getWsEditUsPhoneNumc())) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2393] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2395] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2396] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .getWsEditUsPhoneNumFlgs()
                    .setWsEditEditPhonec(FLG_EDIT_US_PHONEC_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2397] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2398] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2405] GOTO statement
            context.setGotoTarget(editUsPhoneExit);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2408] IF statement
        if (container.getWsMiscStorage().getWsGenericEdits()
                .getWsEditUsPhoneNumcN() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2409] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2410] SET statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .getWsEditUsPhoneNumFlgs()
                    .setWsEditEditPhonec(FLG_EDIT_US_PHONEC_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2411] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2412] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2419] GOTO statement
            context.setGotoTarget(editUsPhoneExit);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2421] CONTINUE statement
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2425] SET statement
        container.getWsMiscStorage().getWsGenericEdits()
                .getWsEditUsPhoneNumFlgs()
    ...
    void editUsPhoneExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2429] EXIT statement
    }

    void _1260EditUsPhoneNumExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2432] EXIT statement
    }
    ...
    void _1265EditUsSsn(OpenFrameContext context) {
        ...
        // *    Edit SSN Part 1                                              
        // ******************************************************************
        // [T-Up#INFO][COACTUPC.cbl, LINE #2443] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditVariableName("SSN: First 3 chars");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2444] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .setWsEditAlphanumOnly(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData().getAcupNewCustSsnX()
                                .getAcupNewCustSsn1());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2445] MOVE statement
        container.getWsMiscStorage().getWsGenericEdits()
                .setWsEditAlphanumLength(3);
        // [T-Up#INFO][COACTUPC.cbl, LINE #2446] PERFORM statement
        controlManager.run(context, _1245EditNumReqd, _1245EditNumReqdExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2448] MOVE statement
        container
                .getWsMiscStorage()
                .getWsGenericEdits()
                .getWsEditUsSsnFlgs()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #2452] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsGenericEdits().getWsEditUsSsnFlgs()
                .getWsEditUsSsnPart1Flgs(), FLG_EDIT_US_SSN_PART1_ISVALID) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2453] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsGenericEdits()
                    .getWsEditUsSsn()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2454] IF statement
            if (container.getWsMiscStorage().getWsGenericEdits()
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #2455] SET statement
                container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
                // [T-Up#INFO][COACTUPC.cbl, LINE #2456] SET statement
                container.getWsMiscStorage().getWsGenericEdits()
                        .getWsEditUsSsnFlgs()
                        .setWsEditUsSsnPart1Flgs(FLG_EDIT_US_SSN_PART1_NOT_OK);
                // [T-Up#INFO][COACTUPC.cbl, LINE #2458] IF statement
                if (CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                    // [T-Up#INFO][COACTUPC.cbl, LINE #2459] STRING statement
                    tempStringBuilder1 = new StringBuilder();
                    tempStringBuilder2 = new StringBuilder(container
                            .getWsMiscStorage().getWsReturnMsg());
                    tempStringBuilder1.append(
                    ...
                    // [T-Up#INFO][COACTUPC.cbl, LINE #2466] CONTINUE statement
                }
            }
            // ******************************************************************
            // *    Edit SSN Part 2                                              
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #2473] MOVE statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditVariableName("SSN 4th & 5th chars");
            // [T-Up#INFO][COACTUPC.cbl, LINE #2474] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsGenericEdits()
                    .setWsEditAlphanumOnly(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2475] MOVE statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphanumLength(2);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2476] PERFORM statement
            controlManager.run(context, _1245EditNumReqd, _1245EditNumReqdExit);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #2478] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsGenericEdits()
                    .getWsEditUsSsnFlgs()
            ...
            // *    Edit SSN Part 3                                              
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #2485] MOVE statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditVariableName("SSN Last 4 chars");
            // [T-Up#INFO][COACTUPC.cbl, LINE #2486] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsGenericEdits()
                    .setWsEditAlphanumOnly(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2487] MOVE statement
            container.getWsMiscStorage().getWsGenericEdits()
                    .setWsEditAlphanumLength(4);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2488] PERFORM statement
            controlManager.run(context, _1245EditNumReqd, _1245EditNumReqdExit);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #2490] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsGenericEdits()
                    .getWsEditUsSsnFlgs()
    ...
    void _1265EditUsSsnExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2494] EXIT statement
    }
    ...
    void _1270EditUsStateCd(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2498] MOVE statement
        container.setUsStateCodeToEdit(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustAddrStateCd());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2499] IF statement
        if (CobStringUtils.compare(container.getUsStateCodeToEdit(),
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2500] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2502] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2503] SET statement
            container.getWsMiscStorage().getWsNonKeyFlags()
                    .getWsEditAddressFlags()
                    .setWsEditStateFlgs(FLG_STATE_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2504] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2505] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2512] GOTO statement
    ...
    void _1270EditUsStateCdExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2516] EXIT statement
    }
    ...
    void _1275EditFicoScore(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2519] IF statement
        if (container.getWsThisProgcommarea().getAcupNewDetails()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2520] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2522] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2523] SET statement
            container.getWsMiscStorage().getWsNonKeyFlags()
                    .setWsEditFicoScoreFlgs(FLG_FICO_SCORE_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2524] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2525] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2532] GOTO statement
    ...
    void _1275EditFicoScoreExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2536] EXIT statement
    }
    ...
    void _1280EditUsStateZipCd(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2541] STRING statement
        tempStringBuilder1 = new StringBuilder();
        tempStringBuilder2 = new StringBuilder(container
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #2546] IF statement
        if (CobStringUtils.compare(container.getUsStateZipcodeToEdit()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2547] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2549] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2550] SET statement
            container.getWsMiscStorage().getWsNonKeyFlags()
                    .getWsEditAddressFlags()
                    .setWsEditStateFlgs(FLG_STATE_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2551] SET statement
            container.getWsMiscStorage().getWsNonKeyFlags()
                    .getWsEditAddressFlags()
                    .setWsEditZipcodeFlgs(FLG_ZIPCODE_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2552] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2553] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2559] GOTO statement
    ...
    void _1280EditUsStateZipCdExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2563] EXIT statement
    }

    void _2000DecideAction(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2567] EVALUATE statement
        if ((CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_DETAILS_NOT_FETCHED_1) == 0 || CobStringUtils.compare(
                container.getWsThisProgcommarea().getAcctUpdateScreenData()
            ...
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #2577] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsEditAcctFlag(), FLG_ACCTFILTER_ISVALID) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2578] SET statement
                container.getWsMiscStorage().setWsReturnMsg(WS_RETURN_MSG_OFF);
                // [T-Up#INFO][COACTUPC.cbl, LINE #2579] PERFORM statement
                controlManager.run(context, _9000ReadAcct, _9000ReadAcctExit);
                if (controlManager.isTerminate(context)) {
                    return;
                }
                // [T-Up#INFO][COACTUPC.cbl, LINE #2581] IF statement
                if (CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsFileReadFlags().getWsCustMasterReadFlag(),
                        FOUND_CUST_IN_MASTER) == 0) {
                    // [T-Up#INFO][COACTUPC.cbl, LINE #2582] SET statement
                    container.getWsThisProgcommarea().getAcctUpdateScreenData()
            ...
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #2590] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsInputFlag(), INPUT_ERROR) == 0
                    || CobStringUtils.compare(container.getWsMiscStorage()
                            .getWsReturnMsg(), NO_CHANGES_DETECTED) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2592] CONTINUE statement
            } else {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2594] SET statement
                container.getWsThisProgcommarea().getAcctUpdateScreenData()
                        .setAcupChangeAction(ACUP_CHANGES_OK_NOT_CONFIRMED);
            }
        } else if (CobStringUtils.compare(container.getWsThisProgcommarea()
            ...
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #2601] CONTINUE statement
        } else if (CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_CHANGES_OK_NOT_CONFIRMED) == 0
                && CobStringUtils.compare(container.getCcWorkAreas()
            ...
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #2608] PERFORM statement
            controlManager.run(context, _9600WriteProcessing,
                    _9600WriteProcessingExit);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #2610] EVALUATE statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), COULD_NOT_LOCK_ACCT_FOR_UPDATE) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2612] SET statement
                container.getWsThisProgcommarea().getAcctUpdateScreenData()
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #2614] SET statement
                container.getWsThisProgcommarea().getAcctUpdateScreenData()
                        .setAcupChangeAction(ACUP_CHANGES_OKAYED_BUT_FAILED);
            } else if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), DATA_WAS_CHANGED_BEFORE_UPDATE) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2616] SET statement
                container.getWsThisProgcommarea().getAcctUpdateScreenData()
                        .setAcupChangeAction(ACUP_SHOW_DETAILS);
            } else {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2618] SET statement
                container.getWsThisProgcommarea().getAcctUpdateScreenData()
            ...
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #2625] CONTINUE statement
        } else if (CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_CHANGES_OKAYED_AND_DONE) == 0) {
            // ******************************************************************
            ...
            // ******************************************************************
            // [T-Up#INFO][COACTUPC.cbl, LINE #2630] SET statement
            container.getWsThisProgcommarea().getAcctUpdateScreenData()
                    .setAcupChangeAction(ACUP_SHOW_DETAILS);
            // [T-Up#INFO][COACTUPC.cbl, LINE #2631] IF statement
            if (CobStringUtils.compare(container.getCarddemoCommarea()
                    .getCdemoGeneralInfo().getCdemoFromTranid(),
                    StringUtils.repeat((char) 0x00, 4)) == 0
                    || CobStringUtils.compare(container.getCarddemoCommarea()
                            .getCdemoGeneralInfo().getCdemoFromTranid(),
                            StringUtils.repeat(' ', 4)) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2633] MOVE statement
                container.getCarddemoCommarea().getCdemoAccountInfo()
                        .setCdemoAcctId((long) 0);
                container.getCarddemoCommarea().getCdemoCardInfo()
                        .setCdemoCardNum((long) 0);
                // [T-Up#INFO][COACTUPC.cbl, LINE #2635] MOVE statement
                container.getCarddemoCommarea().getCdemoAccountInfo()
                        .setCdemoAcctStatus(StringUtils.repeat((char) 0x00, 1));
            }
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2638] MOVE statement
            container.getAbendData().setAbendCulprit(
                    container.getWsLiterals().getLitThispgm());
            // [T-Up#INFO][COACTUPC.cbl, LINE #2639] MOVE statement
            container.getAbendData().setAbendCode("0001");
            // [T-Up#INFO][COACTUPC.cbl, LINE #2640] MOVE statement
            container.getAbendData()
                    .setAbendReason(StringUtils.repeat(' ', 50));
            // [T-Up#INFO][COACTUPC.cbl, LINE #2641] MOVE statement
            container.getAbendData().setAbendMsg("UNEXPECTED DATA SCENARIO");
            // [T-Up#INFO][COACTUPC.cbl, LINE #2643] PERFORM statement
    ...
    void _3000SendMapExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2669] EXIT statement
    }

    void _3100ScreenInit(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2673] MOVE statement
        container.setCactupao(CoactupcCactupai.createDefaultValueInstance()
                .get());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2675] MOVE statement
        container.getWsDateTime().getWsCurdateData()
                .set(IntrinsicFunction.functionCurrentDate());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2677] MOVE statement
        container.setTitle01o(container.getCcdaScreenTitle().getCcdaTitle01());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2678] MOVE statement
        container.setTitle02o(container.getCcdaScreenTitle().getCcdaTitle02());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2679] MOVE statement
        container.setTrnnameo(container.getWsLiterals().getLitThistranid());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2680] MOVE statement
        container.setPgmnameo(container.getWsLiterals().getLitThispgm());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2682] MOVE statement
        container.getWsDateTime().getWsCurdateData()
                .set(IntrinsicFunction.functionCurrentDate());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2684] MOVE statement
        container
                .getWsDateTime()
                .getWsCurdateMmDdYy()
                .setWsCurdateMm(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #2685] MOVE statement
        container
                .getWsDateTime()
                .getWsCurdateMmDdYy()
                .setWsCurdateDd(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #2686] MOVE statement
        container
                .getWsDateTime()
                .getWsCurdateMmDdYy()
                .setWsCurdateYy(
                        Integer.parseInt(DataConverter
                                .convZonedLongToString(
                                        container.getWsDateTime()
                                                ...
                                                .getWsCurdateYear(), 4)
                                .substring(2, 4).trim()));
        // [T-Up#INFO][COACTUPC.cbl, LINE #2688] MOVE statement
        container.setCurdateo(container.getWsDateTime().getWsCurdateMmDdYy()
                .get());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2690] MOVE statement
        container
                .getWsDateTime()
                .getWsCurtimeHhMmSs()
                .setWsCurtimeHh(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #2691] MOVE statement
        container
                .getWsDateTime()
                .getWsCurtimeHhMmSs()
                .setWsCurtimeMm(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #2692] MOVE statement
        container
                .getWsDateTime()
                .getWsCurtimeHhMmSs()
                .setWsCurtimeSs(
    ...
    void _3200SetupScreenVars(OpenFrameContext context) {
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #2704] IF statement
        if (container.getCarddemoCommarea().getCdemoGeneralInfo()
                .getCdemoPgmContext() == CDEMO_PGM_ENTER) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2705] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2707] IF statement
            if (container.getCcWorkAreas().getCcWorkArea().getCcAcctIdN() == 0
                    && CobStringUtils.compare(container.getWsMiscStorage()
                            .getWsEditAcctFlag(), FLG_ACCTFILTER_ISVALID) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2709] MOVE statement
                container.setAcctsido(StringUtils.repeat((char) 0x00, 11));
            } else {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2711] MOVE statement
                container.setAcctsido(container.getCcWorkAreas()
                        .getCcWorkArea().getCcAcctId());
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #2714] EVALUATE statement
            if ((CobStringUtils.compare(container.getWsThisProgcommarea()
                    .getAcctUpdateScreenData().getAcupChangeAction(),
                    ACUP_DETAILS_NOT_FETCHED_1) == 0 || CobStringUtils.compare(
                    container.getWsThisProgcommarea().getAcctUpdateScreenData()
                    ...
                    || (container.getCcWorkAreas().getCcWorkArea()
                            .getCcAcctIdN() == 0)) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2717] PERFORM statement
                ...
                if (controlManager.isTerminate(context)) {
                    ...
                    .getAcctUpdateScreenData().getAcupChangeAction(),
                    ACUP_SHOW_DETAILS) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #2720] PERFORM statement
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #2723] PERFORM statement
                ...
                // [T-Up#INFO][COACTUPC.cbl, LINE #2726] PERFORM statement
                controlManager.run(context, _3202ShowOriginalValues,
                        _3202ShowOriginalValuesExit);
                if (controlManager.isTerminate(context)) {
                    return;
    ...
    void _3200SetupScreenVarsExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2732] EXIT statement
    }

    void _3201ShowInitialValues(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2736] MOVE statement
    ...
    void _3201ShowInitialValuesExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2788] EXIT statement
    }

    void _3202ShowOriginalValues(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2793] MOVE statement
        container.getWsMiscStorage().setWsNonKeyFlags(
                CoactupcWsMiscStorage.CoactupcWsNonKeyFlags
                        .createDefaultValueInstance());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2795] SET statement
        container.getWsMiscStorage().setWsInfoMsg(PROMPT_FOR_CHANGES);
        // [T-Up#INFO][COACTUPC.cbl, LINE #2797] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                ...
                || CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsFileReadFlags().getWsCustMasterReadFlag(),
                        FOUND_CUST_IN_MASTER) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2799] MOVE statement
            container.setAcsttuso(container.getWsThisProgcommarea()
                    .getAcupOldDetails().getAcupOldAcctData()
                    .getAcupOldActiveStatus());
            // [T-Up#INFO][COACTUPC.cbl, LINE #2801] MOVE statement
            container
                    .getWsMiscStorage()
                    ...
                    .setWsEditCurrency92F(
                            container.getWsThisProgcommarea()
                                    .getAcupOldDetails().getAcupOldAcctData()
                                    .getAcupOldCurrBalN());
            // [T-Up#INFO][COACTUPC.cbl, LINE #2802] MOVE statement
            container.setAcurbalo(container.getWsMiscStorage()
                    .getCicsOutputEditVars().getWsEditCurrency92F());
            // [T-Up#INFO][COACTUPC.cbl, LINE #2804] MOVE statement
            container
                    .getWsMiscStorage()
                    .getCicsOutputEditVars()
                    .setWsEditCurrency92F(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2805] MOVE statement
            container.setAcrdlimo(container.getWsMiscStorage()
                    .getCicsOutputEditVars().getWsEditCurrency92F());
            // [T-Up#INFO][COACTUPC.cbl, LINE #2807] MOVE statement
            container
                    .getWsMiscStorage()
                    .getCicsOutputEditVars()
                    .setWsEditCurrency92F(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2809] MOVE statement
            container.setAcshlimo(container.getWsMiscStorage()
                    .getCicsOutputEditVars().getWsEditCurrency92F());
            // [T-Up#INFO][COACTUPC.cbl, LINE #2811] MOVE statement
            container
                    .getWsMiscStorage()
                    .getCicsOutputEditVars()
                    .setWsEditCurrency92F(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2812] MOVE statement
            container.setAcrcycro(container.getWsMiscStorage()
                    .getCicsOutputEditVars().getWsEditCurrency92F());
            // [T-Up#INFO][COACTUPC.cbl, LINE #2814] MOVE statement
            container
                    .getWsMiscStorage()
                    .getCicsOutputEditVars()
                    .setWsEditCurrency92F(
    ...
    void _3202ShowOriginalValuesExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2872] EXIT statement
    }

    void _3203ShowUpdatedValues(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #2876] MOVE statement
        container.setAcsttuso(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewAcctData()
                .getAcupNewActiveStatus());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2878] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsNonKeyFlags().getWsEditCreditLimit(),
                FLG_CRED_LIMIT_ISVALID) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2879] MOVE statement
            container
                    .getWsMiscStorage()
                    .getCicsOutputEditVars()
                    .setWsEditCurrency92F(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2880] MOVE statement
            container.setAcrdlimo(container.getWsMiscStorage()
                    .getCicsOutputEditVars().getWsEditCurrency92F());
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2882] MOVE statement
            container.setAcrdlimo(container.getWsMiscStorage()
                    .getAlphaVarsForDataEditing().getAcupNewCreditLimitX());
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2885] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsNonKeyFlags().getWsEditCashCreditLimit(),
                FLG_CASH_CREDIT_LIMIT_ISVALID) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2886] MOVE statement
            container
                    .getWsMiscStorage()
                    .getCicsOutputEditVars()
                    .setWsEditCurrency92F(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2888] MOVE statement
            container.setAcshlimo(container.getWsMiscStorage()
                    .getCicsOutputEditVars().getWsEditCurrency92F());
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2890] MOVE statement
            container.setAcshlimo(container.getWsMiscStorage()
                    .getAlphaVarsForDataEditing().getAcupNewCashCreditLimitX());
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2894] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsNonKeyFlags().getWsEditCurrBal(), FLG_CURR_BAL_ISVALID) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2895] MOVE statement
            container
                    .getWsMiscStorage()
                    .getCicsOutputEditVars()
                    .setWsEditCurrency92F(
                            container.getWsThisProgcommarea()
                                    .getAcupNewDetails().getAcupNewAcctData()
                                    .getAcupNewCurrBalN());
            // [T-Up#INFO][COACTUPC.cbl, LINE #2896] MOVE statement
            container.setAcurbalo(container.getWsMiscStorage()
                    .getCicsOutputEditVars().getWsEditCurrency92F());
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2898] MOVE statement
            container.setAcurbalo(container.getWsMiscStorage()
                    .getAlphaVarsForDataEditing().getAcupNewCurrBalX());
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2901] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsNonKeyFlags().getWsEditCurrCycCredit(),
                FLG_CURR_CYC_CREDIT_ISVALID) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2902] MOVE statement
            container
                    .getWsMiscStorage()
                    .getCicsOutputEditVars()
                    .setWsEditCurrency92F(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2903] MOVE statement
            container.setAcrcycro(container.getWsMiscStorage()
                    .getCicsOutputEditVars().getWsEditCurrency92F());
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2905] MOVE statement
            container.setAcrcycro(container.getWsMiscStorage()
                    .getAlphaVarsForDataEditing().getAcupNewCurrCycCreditX());
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2908] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsNonKeyFlags().getWsEditCurrCycDebit(),
                FLG_CURR_CYC_DEBIT_ISVALID) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2909] MOVE statement
            container
                    .getWsMiscStorage()
                    .getCicsOutputEditVars()
                    .setWsEditCurrency92F(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #2910] MOVE statement
            container.setAcrcydbo(container.getWsMiscStorage()
                    .getCicsOutputEditVars().getWsEditCurrency92F());
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2912] MOVE statement
            container.setAcrcydbo(container.getWsMiscStorage()
                    .getAlphaVarsForDataEditing().getAcupNewCurrCycDebitX());
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2915] MOVE statement
        container.setOpnyearo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewAcctData().getAcupNewOpenYear());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2916] MOVE statement
        container.setOpnmono(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewAcctData().getAcupNewOpenMon());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2917] MOVE statement
        container.setOpndayo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewAcctData().getAcupNewOpenDay());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2919] MOVE statement
        container.setExpyearo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewAcctData().getAcupNewExpYear());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2920] MOVE statement
        container.setExpmono(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewAcctData().getAcupNewExpMon());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2921] MOVE statement
        container.setExpdayo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewAcctData().getAcupNewExpDay());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2922] MOVE statement
        container.setRisyearo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewAcctData()
                .getAcupNewReissueYear());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2923] MOVE statement
        container.setRismono(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewAcctData()
                .getAcupNewReissueMon());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2924] MOVE statement
        container.setRisdayo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewAcctData()
                .getAcupNewReissueDay());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2925] MOVE statement
        container.setAaddgrpo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewAcctData().getAcupNewGroupId());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2926] MOVE statement
        container.setAcstnumo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData().getAcupNewCustIdX());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2927] MOVE statement
        container.setActssn1o(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData().getAcupNewCustSsnX()
                .getAcupNewCustSsn1());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2928] MOVE statement
        container.setActssn2o(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData().getAcupNewCustSsnX()
                .getAcupNewCustSsn2());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2929] MOVE statement
        container.setActssn3o(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData().getAcupNewCustSsnX()
                .getAcupNewCustSsn3());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2930] MOVE statement
        container.setAcstfcoo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustFicoScoreX());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2931] MOVE statement
        container.setDobyearo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustDobYear());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2932] MOVE statement
        container.setDobmono(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustDobMon());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2933] MOVE statement
        container.setDobdayo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustDobDay());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2934] MOVE statement
        container.setAcsfnamo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustFirstName());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2935] MOVE statement
        container.setAcsmnamo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustMiddleName());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2936] MOVE statement
        container.setAcslnamo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustLastName());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2937] MOVE statement
        container.setAcsadl1o(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustAddrLine1());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2938] MOVE statement
        container.setAcsadl2o(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustAddrLine2());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2939] MOVE statement
        container.setAcscityo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustAddrLine3());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2940] MOVE statement
        container.setAcsstteo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustAddrStateCd());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2941] MOVE statement
        container.setAcszipco(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustAddrZip());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2942] MOVE statement
        container.setAcsctryo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustAddrCountryCd());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2943] MOVE statement
        container.setAcsph1ao(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustPhoneNum1a());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2944] MOVE statement
        container.setAcsph1bo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustPhoneNum1b());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2945] MOVE statement
        container.setAcsph1co(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustPhoneNum1c());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2946] MOVE statement
        container.setAcsph2ao(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustPhoneNum2a());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2947] MOVE statement
        container.setAcsph2bo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustPhoneNum2b());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2948] MOVE statement
        container.setAcsph2co(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustPhoneNum2c());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2949] MOVE statement
        container.setAcsgovto(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustGovtIssuedId());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2950] MOVE statement
        container.setAcseftco(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustEftAccountId());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2951] MOVE statement
        container.setAcspflgo(container.getWsThisProgcommarea()
                .getAcupNewDetails().getAcupNewCustData()
                .getAcupNewCustPriHolderInd());
    }
    ...
    void _3203ShowUpdatedValuesExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2956] EXIT statement
    }
    ...
    void _3250SetupInfomsg(OpenFrameContext context) {
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #2961] EVALUATE statement
        if (container.getCarddemoCommarea().getCdemoGeneralInfo()
                .getCdemoPgmContext() == CDEMO_PGM_ENTER) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2963] SET statement
            container.getWsMiscStorage().setWsInfoMsg(PROMPT_FOR_SEARCH_KEYS);
                ...
                || CobStringUtils.compare(container.getWsThisProgcommarea()
                        .getAcctUpdateScreenData().getAcupChangeAction(),
                        ACUP_DETAILS_NOT_FETCHED_2) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2965] SET statement
            container.getWsMiscStorage().setWsInfoMsg(PROMPT_FOR_SEARCH_KEYS);
        } else if (CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_SHOW_DETAILS) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2967] SET statement
            container.getWsMiscStorage().setWsInfoMsg(PROMPT_FOR_CHANGES);
        } else if (CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_CHANGES_NOT_OK) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2969] SET statement
            container.getWsMiscStorage().setWsInfoMsg(PROMPT_FOR_CHANGES);
        } else if (CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_CHANGES_OK_NOT_CONFIRMED) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2971] SET statement
            container.getWsMiscStorage().setWsInfoMsg(PROMPT_FOR_CONFIRMATION);
        } else if (CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_CHANGES_OKAYED_AND_DONE) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2973] SET statement
            container.getWsMiscStorage().setWsInfoMsg(CONFIRM_UPDATE_SUCCESS);
        } else if (CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_CHANGES_OKAYED_LOCK_ERROR) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2976] SET statement
            container.getWsMiscStorage().setWsInfoMsg(INFORM_FAILURE);
        } else if (CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_CHANGES_OKAYED_BUT_FAILED) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2978] SET statement
            container.getWsMiscStorage().setWsInfoMsg(INFORM_FAILURE);
        } else if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsInfoMsg(), WS_NO_INFO_MESSAGE_1) == 0
                || CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsInfoMsg(), WS_NO_INFO_MESSAGE_2) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #2980] SET statement
            container.getWsMiscStorage().setWsInfoMsg(PROMPT_FOR_SEARCH_KEYS);
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #2983] MOVE statement
        container.setInfomsgo(container.getWsMiscStorage().getWsInfoMsg());
        // [T-Up#INFO][COACTUPC.cbl, LINE #2985] MOVE statement
        container.setErrmsgo(container.getWsMiscStorage().getWsReturnMsg());
    }

    void _3250SetupInfomsgExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #2988] EXIT statement
    }
    ...
    void _3300SetupScreenAttrs(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // *    PROTECT ALL FIELDS                                           
        // [T-Up#INFO][COACTUPC.cbl, LINE #2993] PERFORM statement
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #2997] EVALUATE statement
        if (CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_DETAILS_NOT_FETCHED_1) == 0
                || CobStringUtils.compare(container.getWsThisProgcommarea()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #3000] MOVE statement
            container.getCactupai().setAcctsida(
                ...
                || (CobStringUtils.compare(container.getWsThisProgcommarea()
                        .getAcctUpdateScreenData().getAcupChangeAction(),
                        ACUP_CHANGES_NOT_OK) == 0)) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3003] PERFORM statement
            ...
            if (controlManager.isTerminate(context)) {
                ...
                || (CobStringUtils.compare(container.getWsThisProgcommarea()
                        .getAcctUpdateScreenData().getAcupChangeAction(),
                        ACUP_CHANGES_OKAYED_AND_DONE) == 0)) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3007] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3009] MOVE statement
            container.getCactupai().setAcctsida(
                    container.getDfhbmsca().getDfhbmfse());
        }
        // *    POSITION CURSOR - ORDER BASED ON SCREEN LOCATION             
        // [T-Up#INFO][COACTUPC.cbl, LINE #3013] EVALUATE statement
        if ((CobStringUtils
                .compare(container.getWsMiscStorage().getWsInfoMsg(),
                        FOUND_ACCOUNT_DATA) == 0)
                || (CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsReturnMsg(), NO_CHANGES_DETECTED) == 0)) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3016] MOVE statement
            container.getCactupai().setAcsttusl(-1);
        } else if ((CobStringUtils.compare(container.getWsMiscStorage()
                .getWsEditAcctFlag(), FLG_ACCTFILTER_NOT_OK) == 0)
                || (CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsEditAcctFlag(), FLG_ACCTFILTER_BLANK) == 0)) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3019] MOVE statement
            ...
            // *    Account Status                                               
            // [T-Up#INFO][COACTUPC.cbl, LINE #3023] MOVE statement
            container.getCactupai().setAcsttusl(-1);
        } else if ((CobStringUtils.compare(container.getWsMiscStorage()
            ...
            // *    Open Year                                                    
            // [T-Up#INFO][COACTUPC.cbl, LINE #3027] MOVE statement
            ...
            // *    Open Month                                                   
            // [T-Up#INFO][COACTUPC.cbl, LINE #3031] MOVE statement
            ...
            // *    Open Day                                                     
            // [T-Up#INFO][COACTUPC.cbl, LINE #3035] MOVE statement
            ...
            // *    Credit Limit                                                 
            // [T-Up#INFO][COACTUPC.cbl, LINE #3039] MOVE statement
            ...
            // *    Expiry Year                                                  
            // [T-Up#INFO][COACTUPC.cbl, LINE #3043] MOVE statement
            ...
            // *    Expiry Month                                                 
            // [T-Up#INFO][COACTUPC.cbl, LINE #3047] MOVE statement
            ...
            // *    Expiry Day                                                   
            // [T-Up#INFO][COACTUPC.cbl, LINE #3051] MOVE statement
            ...
            // *    Cash credit limit                                            
            // [T-Up#INFO][COACTUPC.cbl, LINE #3055] MOVE statement
            ...
            // *    Reissue Year                                                 
            // [T-Up#INFO][COACTUPC.cbl, LINE #3059] MOVE statement
            ...
            // *    Expiry Month                                                 
            // [T-Up#INFO][COACTUPC.cbl, LINE #3063] MOVE statement
            ...
            // *    Expiry Day                                                   
            // [T-Up#INFO][COACTUPC.cbl, LINE #3067] MOVE statement
            ...
            // *    Current Balance                                              
            // [T-Up#INFO][COACTUPC.cbl, LINE #3072] MOVE statement
            ...
            // *    Current Cycle Credit                                         
            // [T-Up#INFO][COACTUPC.cbl, LINE #3076] MOVE statement
            ...
            // *    Current Cycle Debit                                          
            // [T-Up#INFO][COACTUPC.cbl, LINE #3080] MOVE statement
            ...
            // *    SSN Part 1                                                   
            // [T-Up#INFO][COACTUPC.cbl, LINE #3084] MOVE statement
            ...
            // *    SSN Part 2                                                   
            // [T-Up#INFO][COACTUPC.cbl, LINE #3088] MOVE statement
            ...
            // *    SSN Part 3                                                   
            // [T-Up#INFO][COACTUPC.cbl, LINE #3092] MOVE statement
            ...
            // *    Date of Birth Year                                           
            // [T-Up#INFO][COACTUPC.cbl, LINE #3096] MOVE statement
            ...
            // *    Date of Birth Month                                          
            // [T-Up#INFO][COACTUPC.cbl, LINE #3100] MOVE statement
            ...
            // *    Date of Birth Day                                            
            // [T-Up#INFO][COACTUPC.cbl, LINE #3104] MOVE statement
            ...
            // *    FICO Score                                                   
            // [T-Up#INFO][COACTUPC.cbl, LINE #3108] MOVE statement
            ...
            // *    First Name                                                   
            // [T-Up#INFO][COACTUPC.cbl, LINE #3112] MOVE statement
            container.getCactupai().setAcsfnaml(-1);
        } else if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsNonKeyFlags().getWsEditNameFlags()
                .getWsEditMiddleNameFlgs(), FLG_MIDDLE_NAME_NOT_OK) == 0) {
            // *    Middle Name                                                  
            // [T-Up#INFO][COACTUPC.cbl, LINE #3115] MOVE statement
            ...
            // *    Last Name                                                    
            // [T-Up#INFO][COACTUPC.cbl, LINE #3119] MOVE statement
            ...
            // *    Address Line 1                                               
            // [T-Up#INFO][COACTUPC.cbl, LINE #3123] MOVE statement
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #3127] MOVE statement
            ...
            // *    Zip code                                                     
            // [T-Up#INFO][COACTUPC.cbl, LINE #3132] MOVE statement
            ...
            // *    Address Line 3 (City)                                        
            // [T-Up#INFO][COACTUPC.cbl, LINE #3136] MOVE statement
            ...
            // *    Country edits.                                               
            // [T-Up#INFO][COACTUPC.cbl, LINE #3140] MOVE statement
            ...
            // *    Phone 1                                                      
            // [T-Up#INFO][COACTUPC.cbl, LINE #3144] MOVE statement
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #3147] MOVE statement
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #3150] MOVE statement
            ...
            // *    Phone 2                                                      
            // [T-Up#INFO][COACTUPC.cbl, LINE #3154] MOVE statement
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #3157] MOVE statement
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #3160] MOVE statement
            ...
            // *    EFT Account Id                                               
            // [T-Up#INFO][COACTUPC.cbl, LINE #3164] MOVE statement
            ...
            // *    Primary Card Holder                                          
            // [T-Up#INFO][COACTUPC.cbl, LINE #3168] MOVE statement
            container.getCactupai().setAcspflgl(-1);
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3170] MOVE statement
            container.getCactupai().setAcctsidl(-1);
        }
        // *    SETUP COLOR                                                  
        // [T-Up#INFO][COACTUPC.cbl, LINE #3175] IF statement
        if (CobStringUtils.compare(container.getCarddemoCommarea()
                .getCdemoMoreInfo().getCdemoLastMapset(), container
                .getWsLiterals().getLitCclistmapset()) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3176] MOVE statement
            container.setAcctsidc(container.getDfhbmsca().getDfhdfcol());
        }
        // *    Account Filter                                               
        // [T-Up#INFO][COACTUPC.cbl, LINE #3180] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsEditAcctFlag(), FLG_ACCTFILTER_NOT_OK) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3181] MOVE statement
            container.setAcctsidc(container.getDfhbmsca().getDfhred());
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #3184] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsEditAcctFlag(), FLG_ACCTFILTER_BLANK) == 0
                && container.getCarddemoCommarea().getCdemoGeneralInfo()
                        .getCdemoPgmContext() == CDEMO_PGM_REENTER) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3186] MOVE statement
            container.setAcctsido("*");
            // [T-Up#INFO][COACTUPC.cbl, LINE #3187] MOVE statement
            container.setAcctsidc(container.getDfhbmsca().getDfhred());
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #3190] IF statement
        if (((CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_DETAILS_NOT_FETCHED_1) == 0 || CobStringUtils.compare(
                container.getWsThisProgcommarea().getAcctUpdateScreenData()
                        .getAcupChangeAction(), ACUP_DETAILS_NOT_FETCHED_2) == 0) || CobStringUtils
                .compare(container.getWsMiscStorage().getWsEditAcctFlag(),
                        FLG_ACCTFILTER_BLANK) == 0)
                || CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsEditAcctFlag(), FLG_ACCTFILTER_NOT_OK) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3193] GOTO statement
            context.setGotoTarget(_3300SetupScreenAttrsExit);
            return;
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3195] CONTINUE statement
        }
        // ******************************************************************
        ...
        //       *      ==(SCRNVAR2)== BY ==ACSTTUS==                              
        //       *      ==(MAPNAME3)== BY ==CACTUPA== .                            
        // *(/home/oflab/repository/ref/COBOL_COPYBOOK/CARDDEMO/CSSETATY.cpy)
        // ******************************************************************
        // * Copyright Amazon.com, Inc. or its affiliates.                   
        // * All Rights Reserved.                                            
        // *                                                                 
        ...
        // [T-Up#INFO][CSSETATY.cpy, LINE #19] IF statement
        if ((CobStringUtils.compare(container.getWsMiscStorage()
                .getWsNonKeyFlags().getWsEditAcctStatus(),
                ...
                && container.getCarddemoCommarea().getCdemoGeneralInfo()
                        .getCdemoPgmContext() == CDEMO_PGM_REENTER) {
            // [T-Up#INFO][CSSETATY.cpy, LINE #22] MOVE statement
            container.setAcsttusc(container.getDfhbmsca().getDfhred());
            // [T-Up#INFO][CSSETATY.cpy, LINE #24] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsNonKeyFlags().getWsEditAcctStatus(),
                    FLG_ACCT_STATUS_BLANK) == 0) {
                // [T-Up#INFO][CSSETATY.cpy, LINE #25] MOVE statement
    ...
    void _3300SetupScreenAttrsExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #3442] EXIT statement
    }

    void _3310ProtectAllAttrs(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #3446] MOVE statement
        container.getCactupai().setAcctsida(
    ...
    void _3310ProtectAllAttrsExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #3501] EXIT statement
    }

    void _3320UnprotectFewAttrs(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #3506] MOVE statement
        container.getCactupai().setAcsttusa(
                container.getDfhbmsca().getDfhbmfse());
        container.getCactupai().setAcrdlima(
                container.getDfhbmsca().getDfhbmfse());
        ...
        // *Date of Birth                                                    
        // *Customer data                                                    
        // [T-Up#INFO][COACTUPC.cbl, LINE #3535] MOVE statement
        container.getCactupai().setAcstnuma(
                container.getDfhbmsca().getDfhbmprf());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3536] MOVE statement
        container.getCactupai().setActssn1a(
                container.getDfhbmsca().getDfhbmfse());
        container.getCactupai().setActssn2a(
                container.getDfhbmsca().getDfhbmfse());
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3551] MOVE statement
        container.getCactupai().setAcsctrya(
                container.getDfhbmsca().getDfhbmprf());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3553] MOVE statement
        container.getCactupai().setAcsph1aa(
                container.getDfhbmsca().getDfhbmfse());
        container.getCactupai().setAcsph1ba(
                container.getDfhbmsca().getDfhbmfse());
        container.getCactupai().setAcsph1ca(
                container.getDfhbmsca().getDfhbmfse());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3557] MOVE statement
        container.getCactupai().setAcsph2aa(
                container.getDfhbmsca().getDfhbmfse());
        container.getCactupai().setAcsph2ba(
                container.getDfhbmsca().getDfhbmfse());
        ...
        container.getCactupai().setAcspflga(
                container.getDfhbmsca().getDfhbmfse());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3564] MOVE statement
        container.getCactupai().setInfomsga(
                container.getDfhbmsca().getDfhbmprf());
    }

    void _3320UnprotectFewAttrsExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #3567] EXIT statement
    }

    void _3390SetupInfomsgAttrs(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #3571] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage().getWsInfoMsg(),
                WS_NO_INFO_MESSAGE_1) == 0
                || CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsInfoMsg(), WS_NO_INFO_MESSAGE_2) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3572] MOVE statement
            container.getCactupai().setInfomsga(
                    container.getDfhbmsca().getDfhbmdar());
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3574] MOVE statement
            container.getCactupai().setInfomsga(
                    container.getDfhbmsca().getDfhbmasb());
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #3577] IF statement
        if ((CobStringUtils.compare(container.getWsThisProgcommarea()
                .getAcctUpdateScreenData().getAcupChangeAction(),
                ACUP_CHANGES_MADE_1) == 0
                || CobStringUtils.compare(container.getWsThisProgcommarea()
                ...
                && !(CobStringUtils.compare(container.getWsThisProgcommarea()
                        .getAcctUpdateScreenData().getAcupChangeAction(),
                        ACUP_CHANGES_OKAYED_AND_DONE) == 0)) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3579] MOVE statement
            container.getCactupai().setFkey12a(
                    container.getDfhbmsca().getDfhbmasb());
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #3582] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage().getWsInfoMsg(),
                PROMPT_FOR_CONFIRMATION) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3583] MOVE statement
            container.getCactupai().setFkey05a(
                    container.getDfhbmsca().getDfhbmasb());
            // [T-Up#INFO][COACTUPC.cbl, LINE #3584] MOVE statement
            container.getCactupai().setFkey12a(
                    container.getDfhbmsca().getDfhbmasb());
        }
    }
    ...
    void _3390SetupInfomsgAttrsExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #3589] EXIT statement
    }

    void _3400SendScreen(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #3595] MOVE statement
        container
                .getCcWorkAreas()
                .getCcWorkArea()
                .setCcardNextMapset(
                        container.getWsLiterals().getLitThismapset());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3596] MOVE statement
        container.getCcWorkAreas().getCcWorkArea()
                .setCcardNextMap(container.getWsLiterals().getLitThismap());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3598] EXEC_CICS statement
        /*
    ...
    void _9000ReadAcct(OpenFrameContext context) {
        ...
        container
                ...
                .setWsCardRidAcctId(
                        Long.parseLong(container.getCcWorkAreas()
                                .getCcWorkArea().getCcAcctId().trim()));
        // [T-Up#INFO][COACTUPC.cbl, LINE #3621] PERFORM statement
        controlManager.run(context, _9200GetcardxrefByacct,
                _9200GetcardxrefByacctExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #3624] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsEditAcctFlag(), FLG_ACCTFILTER_NOT_OK) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3625] GOTO statement
            context.setGotoTarget(_9000ReadAcctExit);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #3628] PERFORM statement
        controlManager.run(context, _9300GetacctdataByacct,
                _9300GetacctdataByacctExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #3631] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsReturnMsg(), DID_NOT_FIND_ACCT_IN_ACCTDAT) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3632] GOTO statement
            context.setGotoTarget(_9000ReadAcctExit);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #3635] MOVE statement
        container
                .getWsMiscStorage()
                .getWsXrefRid()
                .setWsCardRidCustId(
                        container.getCarddemoCommarea().getCdemoCustomerInfo()
                                .getCdemoCustId());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3637] PERFORM statement
        controlManager.run(context, _9400GetcustdataBycust,
                _9400GetcustdataBycustExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #3640] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsReturnMsg(), DID_NOT_FIND_CUST_IN_CUSTDAT) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3641] GOTO statement
            context.setGotoTarget(_9000ReadAcctExit);
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #3646] PERFORM statement
    ...
    void _9000ReadAcctExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #3652] EXIT statement
    }
    ...
    void _9200GetcardxrefByacct(OpenFrameContext context) {
        ...
        // *                                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #3658] EXEC_CICS statement
        /*
                       EXEC CICS READ                                               
        ...
        try {
            ...
            container
                    .setCardXrefRecord(CoactupcCardXrefRecordToAwsM2CarddemoCardxrefVsamKsdsDto.INSTANCE
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3668] EVALUATE statement
        if (container.getWsMiscStorage().getWsCicsProcessngVars().getWsRespCd() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3670] MOVE statement
            container
                    .getCarddemoCommarea()
                    .getCdemoCustomerInfo()
                    .setCdemoCustId(
                            container.getCardXrefRecord().getXrefCustId());
            // [T-Up#INFO][COACTUPC.cbl, LINE #3671] MOVE statement
            container
                    .getCarddemoCommarea()
                    .getCdemoCardInfo()
                    .setCdemoCardNum(
                ...
                .getWsRespCd() == 13) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3673] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3674] SET statement
            container.getWsMiscStorage().setWsEditAcctFlag(
                    FLG_ACCTFILTER_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3675] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #3676] MOVE statement
                container
                        .getWsMiscStorage()
                        ...
                        .setErrorResp(
                                StringUtils.leftPad(
                                        String.valueOf(Math.abs(container
                                                ...
                                                .getWsRespCd())), 9, '0'));
                // [T-Up#INFO][COACTUPC.cbl, LINE #3677] MOVE statement
                container
                        .getWsMiscStorage()
                        .getWsFileErrorMessage()
                        .setErrorResp2(
                                StringUtils.leftPad(
                                        String.valueOf(Math.abs(container
                                                ...
                                                .getWsCicsProcessngVars()
                                                .getWsReasCd())), 9, '0'));
                // [T-Up#INFO][COACTUPC.cbl, LINE #3678] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #3691] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3692] SET statement
            container.getWsMiscStorage().setWsEditAcctFlag(
                    FLG_ACCTFILTER_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3693] MOVE statement
            container.getWsMiscStorage().getWsFileErrorMessage()
                    .setErrorOpname("READ");
            // [T-Up#INFO][COACTUPC.cbl, LINE #3694] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsFileErrorMessage()
                    .setErrorFile(
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #3695] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsFileErrorMessage()
                    .setErrorResp(
                            StringUtils.leftPad(
                                    String.valueOf(Math.abs(container
                                            ...
                                            .getWsCicsProcessngVars()
                                            .getWsRespCd())), 9, '0'));
            // [T-Up#INFO][COACTUPC.cbl, LINE #3696] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsFileErrorMessage()
                    .setErrorResp2(
                            StringUtils.leftPad(
                                    String.valueOf(Math.abs(container
                                            ...
                                            .getWsCicsProcessngVars()
                                            .getWsReasCd())), 9, '0'));
            // [T-Up#INFO][COACTUPC.cbl, LINE #3697] MOVE statement
            container.getWsMiscStorage().setWsReturnMsg(
    ...
    void _9200GetcardxrefByacctExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #3703] EXIT statement
    }
    ...
    void _9300GetacctdataByacct(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #3707] EXEC_CICS statement
        /*
                       EXEC CICS READ                                               
            ...
            AwsM2CarddemoAcctdataVsamKsdsDto awsM2CarddemoAcctdataVsamKsdsDto = recordKeyAccessor
                    .read("awsM2CarddemoAcctdataVsamKsdsDao", new BigDecimal(
                            container.getWsMiscStorage().getWsXrefRid()
                                    .getWsCardRidAcctIdX()));
            container
                    .setAccountRecord(CoactupcAccountRecordToAwsM2CarddemoAcctdataVsamKsdsDto.INSTANCE
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3717] EVALUATE statement
        if (container.getWsMiscStorage().getWsCicsProcessngVars().getWsRespCd() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3719] SET statement
            container.getWsMiscStorage().getWsFileReadFlags()
                    .setWsAccountMasterReadFlag(FOUND_ACCT_IN_MASTER);
        } else if (container.getWsMiscStorage().getWsCicsProcessngVars()
                .getWsRespCd() == 13) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3721] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3722] SET statement
            container.getWsMiscStorage().setWsEditAcctFlag(
                    FLG_ACCTFILTER_NOT_OK);
            // *           SET DID-NOT-FIND-ACCT-IN-ACCTDAT TO TRUE              
            // [T-Up#INFO][COACTUPC.cbl, LINE #3724] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #3725] MOVE statement
                container
                        .getWsMiscStorage()
                        .getWsFileErrorMessage()
                        .setErrorResp(
                                StringUtils.leftPad(
                                        String.valueOf(Math.abs(container
                                                ...
                                                .getWsCicsProcessngVars()
                                                .getWsRespCd())), 9, '0'));
                // [T-Up#INFO][COACTUPC.cbl, LINE #3726] MOVE statement
                container
                        .getWsMiscStorage()
                        .getWsFileErrorMessage()
                        .setErrorResp2(
                                StringUtils.leftPad(
                                        String.valueOf(Math.abs(container
                                                ...
                                                .getWsCicsProcessngVars()
                                                .getWsReasCd())), 9, '0'));
                // [T-Up#INFO][COACTUPC.cbl, LINE #3727] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1
            ...
            // *                                                                 
            // [T-Up#INFO][COACTUPC.cbl, LINE #3741] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3742] SET statement
            container.getWsMiscStorage().setWsEditAcctFlag(
                    FLG_ACCTFILTER_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3743] MOVE statement
            container.getWsMiscStorage().getWsFileErrorMessage()
                    .setErrorOpname("READ");
            // [T-Up#INFO][COACTUPC.cbl, LINE #3744] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsFileErrorMessage()
                    .setErrorFile(
                            container.getWsLiterals().getLitAcctfilename());
            // [T-Up#INFO][COACTUPC.cbl, LINE #3745] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsFileErrorMessage()
                    .setErrorResp(
                            StringUtils.leftPad(
                                    String.valueOf(Math.abs(container
                                            ...
                                            .getWsCicsProcessngVars()
                                            .getWsRespCd())), 9, '0'));
            // [T-Up#INFO][COACTUPC.cbl, LINE #3746] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsFileErrorMessage()
                    .setErrorResp2(
                            StringUtils.leftPad(
                                    String.valueOf(Math.abs(container
                                            ...
                                            .getWsCicsProcessngVars()
                                            .getWsReasCd())), 9, '0'));
            // [T-Up#INFO][COACTUPC.cbl, LINE #3747] MOVE statement
            container.getWsMiscStorage().setWsReturnMsg(
                    container.getWsMiscStorage().getWsFileErrorMessage().get());
        }
    }
    ...
    void _9300GetacctdataByacctExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #3753] EXIT statement
    }
    ...
    void _9400GetcustdataBycust(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #3757] EXEC_CICS statement
        /*
                       EXEC CICS READ                                               
            ...
            AwsM2CarddemoCustdataVsamKsdsDto awsM2CarddemoCustdataVsamKsdsDto = recordKeyAccessor
                    .read("awsM2CarddemoCustdataVsamKsdsDao", new BigDecimal(
                            container.getWsMiscStorage().getWsXrefRid()
                                    .getWsCardRidCustIdX()));
            container
                    .setCustomerRecord(CoactupcCustomerRecordToAwsM2CarddemoCustdataVsamKsdsDto.INSTANCE
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3767] EVALUATE statement
        if (container.getWsMiscStorage().getWsCicsProcessngVars().getWsRespCd() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3769] SET statement
            container.getWsMiscStorage().getWsFileReadFlags()
                    .setWsCustMasterReadFlag(FOUND_CUST_IN_MASTER);
        } else if (container.getWsMiscStorage().getWsCicsProcessngVars()
                .getWsRespCd() == 13) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3771] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3772] SET statement
            container.getWsMiscStorage().setWsEditCustFlag(
                    FLG_CUSTFILTER_NOT_OK);
            // *           SET DID-NOT-FIND-CUST-IN-CUSTDAT TO TRUE              
            // [T-Up#INFO][COACTUPC.cbl, LINE #3774] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsFileErrorMessage()
                    .setErrorResp(
                            StringUtils.leftPad(
                                    String.valueOf(Math.abs(container
                                            ...
                                            .getWsCicsProcessngVars()
                                            .getWsRespCd())), 9, '0'));
            // [T-Up#INFO][COACTUPC.cbl, LINE #3775] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsFileErrorMessage()
                    .setErrorResp2(
                            StringUtils.leftPad(
                                    String.valueOf(Math.abs(container
                                            ...
                                            .getWsCicsProcessngVars()
                                            .getWsReasCd())), 9, '0'));
            // [T-Up#INFO][COACTUPC.cbl, LINE #3776] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #3777] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #3790] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3791] SET statement
            container.getWsMiscStorage().setWsEditCustFlag(
                    FLG_CUSTFILTER_NOT_OK);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3792] MOVE statement
            container.getWsMiscStorage().getWsFileErrorMessage()
                    .setErrorOpname("READ");
            // [T-Up#INFO][COACTUPC.cbl, LINE #3793] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsFileErrorMessage()
                    .setErrorFile(
                            container.getWsLiterals().getLitCustfilename());
            // [T-Up#INFO][COACTUPC.cbl, LINE #3794] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsFileErrorMessage()
                    .setErrorResp(
                            StringUtils.leftPad(
                                    String.valueOf(Math.abs(container
                                            ...
                                            .getWsCicsProcessngVars()
                                            .getWsRespCd())), 9, '0'));
            // [T-Up#INFO][COACTUPC.cbl, LINE #3795] MOVE statement
            container
                    .getWsMiscStorage()
                    .getWsFileErrorMessage()
                    .setErrorResp2(
                            StringUtils.leftPad(
                                    String.valueOf(Math.abs(container
                                            ...
                                            .getWsCicsProcessngVars()
                                            .getWsReasCd())), 9, '0'));
            // [T-Up#INFO][COACTUPC.cbl, LINE #3796] MOVE statement
            container.getWsMiscStorage().setWsReturnMsg(
                    container.getWsMiscStorage().getWsFileErrorMessage().get());
        }
    }
    ...
    void _9400GetcustdataBycustExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #3802] EXIT statement
    }
    ...
    void _9500StoreFetchedData(OpenFrameContext context) {
        ...
        // *                                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #3809] MOVE statement
        container.getCarddemoCommarea().getCdemoAccountInfo()
                .setCdemoAcctId(container.getAccountRecord().getAcctId());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3810] MOVE statement
        container.getCarddemoCommarea().getCdemoCustomerInfo()
                .setCdemoCustId(container.getCustomerRecord().getCustId());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3811] MOVE statement
        container
                .getCarddemoCommarea()
                .getCdemoCustomerInfo()
                .setCdemoCustFname(
                        container.getCustomerRecord().getCustFirstName());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3812] MOVE statement
        container
                .getCarddemoCommarea()
                .getCdemoCustomerInfo()
                .setCdemoCustMname(
                        container.getCustomerRecord().getCustMiddleName());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3813] MOVE statement
        container
                .getCarddemoCommarea()
                .getCdemoCustomerInfo()
                .setCdemoCustLname(
                        container.getCustomerRecord().getCustLastName());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3814] MOVE statement
        container
                .getCarddemoCommarea()
                .getCdemoAccountInfo()
                .setCdemoAcctStatus(
                        container.getAccountRecord().getAcctActiveStatus());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3815] MOVE statement
        container
                .getCarddemoCommarea()
                .getCdemoCardInfo()
                .setCdemoCardNum(
                        Long.parseLong(container.getCardXrefRecord()
                                .getXrefCardNum().trim()));
        // [T-Up#INFO][COACTUPC.cbl, LINE #3817] INITIALIZE statement
        container.getWsThisProgcommarea().setAcupOldDetails(
                CoactupcWsThisProgcommarea.CoactupcAcupOldDetails
                        .createDefaultValueInstance());
        // ******************************************************************
        // *    Account Master data                                          
        // ******************************************************************
        // [T-Up#INFO][COACTUPC.cbl, LINE #3821] MOVE statement
        container.getWsThisProgcommarea().getAcupOldDetails()
                .getAcupOldAcctData()
                .setAcupOldAcctId(container.getAccountRecord().getAcctId());
        // * Active Status                                                   
        // [T-Up#INFO][COACTUPC.cbl, LINE #3823] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
                .setAcupOldActiveStatus(
                        container.getAccountRecord().getAcctActiveStatus());
        // * Current Balance                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #3825] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
        ...
        // * Credit Limit                                                    
        // [T-Up#INFO][COACTUPC.cbl, LINE #3827] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
        ...
        // * Cash Limit                                                      
        // [T-Up#INFO][COACTUPC.cbl, LINE #3829] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
        ...
        // * Current Cycle Credit                                            
        // [T-Up#INFO][COACTUPC.cbl, LINE #3831] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
        ...
        // * Current Cycle Debit                                             
        // [T-Up#INFO][COACTUPC.cbl, LINE #3833] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3836] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
                .setAcupOldOpenYear(
                        container.getAccountRecord().getAcctOpenDate()
                                .substring(0, 4));
        // [T-Up#INFO][COACTUPC.cbl, LINE #3837] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
                .setAcupOldOpenMon(
                        container.getAccountRecord().getAcctOpenDate()
                                .substring(5, 7));
        // [T-Up#INFO][COACTUPC.cbl, LINE #3838] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3841] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
                .setAcupOldExpYear(
                        container.getAccountRecord().getAcctExpiraionDate()
                                .substring(0, 4));
        // [T-Up#INFO][COACTUPC.cbl, LINE #3842] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
                .setAcupOldExpMon(
                        container.getAccountRecord().getAcctExpiraionDate()
                                .substring(5, 7));
        // [T-Up#INFO][COACTUPC.cbl, LINE #3843] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3847] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
                .setAcupOldReissueYear(
                        container.getAccountRecord().getAcctReissueDate()
                                .substring(0, 4));
        // [T-Up#INFO][COACTUPC.cbl, LINE #3848] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
                .setAcupOldReissueMon(
                        container.getAccountRecord().getAcctReissueDate()
                                .substring(5, 7));
        // [T-Up#INFO][COACTUPC.cbl, LINE #3849] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
                .setAcupOldReissueDay(
                        container.getAccountRecord().getAcctReissueDate()
                                .substring(8, 10));
        // * Account Group                                                   
        // [T-Up#INFO][COACTUPC.cbl, LINE #3851] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldAcctData()
        ...
        container
                ...
                .setAcupOldCustDobYear(
                        container.getCustomerRecord().getCustDobYyyyMmDd()
                                .substring(0, 4));
        // [T-Up#INFO][COACTUPC.cbl, LINE #3862] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
                .setAcupOldCustDobMon(
                        container.getCustomerRecord().getCustDobYyyyMmDd()
                                .substring(5, 7));
        // [T-Up#INFO][COACTUPC.cbl, LINE #3863] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
                .setAcupOldCustDobDay(
                        container.getCustomerRecord().getCustDobYyyyMmDd()
                                .substring(8, 10));
        // *FICO                                                             
        // [T-Up#INFO][COACTUPC.cbl, LINE #3865] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
        ...
        // *First Name                                                       
        // [T-Up#INFO][COACTUPC.cbl, LINE #3867] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
                .setAcupOldCustFirstName(
                        container.getCustomerRecord().getCustFirstName());
        // *Middle Name                                                      
        // [T-Up#INFO][COACTUPC.cbl, LINE #3869] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
                .setAcupOldCustMiddleName(
                        container.getCustomerRecord().getCustMiddleName());
        // *Last Name                                                        
        // [T-Up#INFO][COACTUPC.cbl, LINE #3871] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
                .setAcupOldCustLastName(
                        container.getCustomerRecord().getCustLastName());
        // *Address                                                          
        // [T-Up#INFO][COACTUPC.cbl, LINE #3873] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3874] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3875] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3876] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3877] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3879] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3880] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3881] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
        ...
        // *Government Id                                                    
        // [T-Up#INFO][COACTUPC.cbl, LINE #3883] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
        ...
        // *EFT Code                                                         
        // [T-Up#INFO][COACTUPC.cbl, LINE #3885] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
        ...
        // *Primary Holder Indicator                                         
        // [T-Up#INFO][COACTUPC.cbl, LINE #3887] MOVE statement
        container
                .getWsThisProgcommarea()
                .getAcupOldDetails()
                .getAcupOldCustData()
    ...
    void _9500StoreFetchedDataExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #3890] EXIT statement
    }
    ...
    void _9600WriteProcessing(OpenFrameContext context) {
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #3896] MOVE statement
        container
                .getWsMiscStorage()
                .getWsXrefRid()
                .setWsCardRidAcctId(
                        Long.parseLong(container.getCcWorkAreas()
                                .getCcWorkArea().getCcAcctId().trim()));
        // [T-Up#INFO][COACTUPC.cbl, LINE #3898] EXEC_CICS statement
        /*
                       EXEC CICS READ                                               
        ...
        // ***************************************************************** 
        // [T-Up#INFO][COACTUPC.cbl, LINE #3911] IF statement
        if (container.getWsMiscStorage().getWsCicsProcessngVars().getWsRespCd() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3912] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3914] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3915] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #3916] SET statement
                container.getWsMiscStorage().setWsReturnMsg(
                        COULD_NOT_LOCK_ACCT_FOR_UPDATE);
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #3918] GOTO statement
            context.setGotoTarget(_9600WriteProcessingExit);
            return;
        }
        // *    Read the customer file for update                            
        // [T-Up#INFO][COACTUPC.cbl, LINE #3923] MOVE statement
        container
                .getWsMiscStorage()
                .getWsXrefRid()
                .setWsCardRidCustId(
                        container.getCarddemoCommarea().getCdemoCustomerInfo()
                                .getCdemoCustId());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3925] EXEC_CICS statement
        /*
                       EXEC CICS READ                                               
        ...
        // ***************************************************************** 
        // [T-Up#INFO][COACTUPC.cbl, LINE #3938] IF statement
        if (container.getWsMiscStorage().getWsCicsProcessngVars().getWsRespCd() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3939] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3941] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][COACTUPC.cbl, LINE #3942] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][COACTUPC.cbl, LINE #3943] SET statement
                container.getWsMiscStorage().setWsReturnMsg(
                        COULD_NOT_LOCK_CUST_FOR_UPDATE);
            }
            // [T-Up#INFO][COACTUPC.cbl, LINE #3945] GOTO statement
            context.setGotoTarget(_9600WriteProcessingExit);
            return;
        }
        // ***************************************************************** 
        ...
        // ***************************************************************** 
        // [T-Up#INFO][COACTUPC.cbl, LINE #3951] PERFORM statement
        controlManager.run(context, _9700CheckChangeInRec,
                _9700CheckChangeInRecExit);
        if (controlManager.isTerminate(context)) {
            return;
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #3954] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsReturnMsg(), DATA_WAS_CHANGED_BEFORE_UPDATE) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #3955] GOTO statement
            context.setGotoTarget(_9600WriteProcessingExit);
            return;
        }
        // ***************************************************************** 
        // * Prepare the update                                              
        // ***************************************************************** 
        // [T-Up#INFO][COACTUPC.cbl, LINE #3960] INITIALIZE statement
        ...
        // *    Account Master data                                          
        // ******************************************************************
        // [T-Up#INFO][COACTUPC.cbl, LINE #3964] MOVE statement
        container
                .getWsMiscStorage()
                .getAcctUpdateRecord()
                .setAcctUpdateId(
        ...
        // * Active Status                                                   
        // [T-Up#INFO][COACTUPC.cbl, LINE #3966] MOVE statement
        container
                .getWsMiscStorage()
                .getAcctUpdateRecord()
                .setAcctUpdateActiveStatus(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewAcctData().getAcupNewActiveStatus());
        // * Current Balance                                                 
        // [T-Up#INFO][COACTUPC.cbl, LINE #3968] MOVE statement
        container
                .getWsMiscStorage()
                .getAcctUpdateRecord()
        ...
        // * Credit Limit                                                    
        // [T-Up#INFO][COACTUPC.cbl, LINE #3970] MOVE statement
        container
                .getWsMiscStorage()
                .getAcctUpdateRecord()
        ...
        // * Cash Limit                                                      
        // [T-Up#INFO][COACTUPC.cbl, LINE #3972] MOVE statement
        container
                .getWsMiscStorage()
                .getAcctUpdateRecord()
                .setAcctUpdateCashCreditLimit(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                ...
                                .getAcupNewCashCreditLimitN());
        // * Current Cycle Credit                                            
        // [T-Up#INFO][COACTUPC.cbl, LINE #3975] MOVE statement
        container
                .getWsMiscStorage()
                .getAcctUpdateRecord()
                .setAcctUpdateCurrCycCredit(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                ...
                                .getAcupNewCurrCycCreditN());
        // * Current Cycle Debit                                             
        // [T-Up#INFO][COACTUPC.cbl, LINE #3978] MOVE statement
        container
                .getWsMiscStorage()
                .getAcctUpdateRecord()
        ...
        // * Open date                                                       
        // [T-Up#INFO][COACTUPC.cbl, LINE #3980] STRING statement
        tempStringBuilder1 = new StringBuilder();
        ...
        // * Expiry date                                                     
        // [T-Up#INFO][COACTUPC.cbl, LINE #3988] STRING statement
        tempStringBuilder1 = new StringBuilder();
        tempStringBuilder2 = new StringBuilder(container.getWsMiscStorage()
        ...
        // * Reissue date                                                    
        // [T-Up#INFO][COACTUPC.cbl, LINE #3997] MOVE statement
        container
                .getWsMiscStorage()
                .getAcctUpdateRecord()
                .setAcctUpdateReissueDate(
                        container.getAccountRecord().getAcctReissueDate());
        // [T-Up#INFO][COACTUPC.cbl, LINE #3998] STRING statement
        tempStringBuilder1 = new StringBuilder();
        tempStringBuilder2 = new StringBuilder(container.getWsMiscStorage()
        ...
        // * Account Group                                                   
        // [T-Up#INFO][COACTUPC.cbl, LINE #4006] MOVE statement
        container
                .getWsMiscStorage()
                .getAcctUpdateRecord()
        ...
        // *    Customer data                                                
        // ******************************************************************
        // [T-Up#INFO][COACTUPC.cbl, LINE #4011] INITIALIZE statement
        container.getWsMiscStorage().setCustUpdateRecord(
                CoactupcWsMiscStorage.CoactupcCustUpdateRecord
                        .createDefaultValueInstance());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4013] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateId(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #4014] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateFirstName(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData().getAcupNewCustFirstName());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4016] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateMiddleName(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData()
                                .getAcupNewCustMiddleName());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4018] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateLastName(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData().getAcupNewCustLastName());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4019] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateAddrLine1(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData().getAcupNewCustAddrLine1());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4021] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #4023] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateAddrLine3(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData().getAcupNewCustAddrLine3());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4025] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateAddrStateCd(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData()
                                .getAcupNewCustAddrStateCd());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4027] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateAddrCountryCd(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData()
                                .getAcupNewCustAddrCountryCd());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4029] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateAddrZip(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData().getAcupNewCustAddrZip());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4031] STRING statement
        tempStringBuilder1 = new StringBuilder();
        tempStringBuilder2 = new StringBuilder(container.getWsMiscStorage()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #4039] STRING statement
        tempStringBuilder1 = new StringBuilder();
        tempStringBuilder2 = new StringBuilder(container.getWsMiscStorage()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #4048] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateSsn(
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #4049] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateGovtIssuedId(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData()
                                .getAcupNewCustGovtIssuedId());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4051] STRING statement
        tempStringBuilder1 = new StringBuilder();
        tempStringBuilder2 = new StringBuilder(container.getWsMiscStorage()
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #4058] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdateEftAccountId(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData()
                                .getAcupNewCustEftAccountId());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4060] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
                .setCustUpdatePriCardInd(
                        container.getWsThisProgcommarea().getAcupNewDetails()
                                .getAcupNewCustData()
                                .getAcupNewCustPriHolderInd());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4062] MOVE statement
        container
                .getWsMiscStorage()
                .getCustUpdateRecord()
        ...
        // * Update account *                                                
        // ***************************************************************** 
        // [T-Up#INFO][COACTUPC.cbl, LINE #4069] EXEC_CICS statement
        /*
                       EXEC CICS                                                    
        ...
        // ***************************************************************** 
        // [T-Up#INFO][COACTUPC.cbl, LINE #4080] IF statement
        if (container.getWsMiscStorage().getWsCicsProcessngVars().getWsRespCd() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #4081] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #4083] SET statement
            container.getWsMiscStorage().setWsReturnMsg(
                    LOCKED_BUT_UPDATE_FAILED);
            // [T-Up#INFO][COACTUPC.cbl, LINE #4084] GOTO statement
            context.setGotoTarget(_9600WriteProcessingExit);
            return;
        }
        // ***************************************************************** 
        // * Update customer *                                               
        // ***************************************************************** 
        // [T-Up#INFO][COACTUPC.cbl, LINE #4089] EXEC_CICS statement
        /*
                       EXEC CICS                                                    
        ...
        // ***************************************************************** 
        // [T-Up#INFO][COACTUPC.cbl, LINE #4099] IF statement
        if (container.getWsMiscStorage().getWsCicsProcessngVars().getWsRespCd() == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #4100] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #4102] SET statement
            container.getWsMiscStorage().setWsReturnMsg(
                    LOCKED_BUT_UPDATE_FAILED);
            // [T-Up#INFO][COACTUPC.cbl, LINE #4103] EXEC_CICS statement
            /*
                             EXEC CICS                                                  
                                SYNCPOINT ROLLBACK                                      
                             END-EXEC
             */
            // [T-Up#ERROR][COACTUPC.cbl, LINE #4103] Migration failed for EXEC_CICS statement : UN_SUPPORTED_COMMAND
            // [T-Up#INFO][COACTUPC.cbl, LINE #4106] GOTO statement
            context.setGotoTarget(_9600WriteProcessingExit);
            return;
        }
    }
    ...
    void _9600WriteProcessingExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #4110] EXIT statement
    }
    ...
    void _9700CheckChangeInRec(OpenFrameContext context) {
        ...
        // *    Account Master data                                          
        // ******************************************************************
        // [T-Up#INFO][COACTUPC.cbl, LINE #4119] IF statement
        if (CobStringUtils.compare(container.getAccountRecord()
            ...
            // * Reissue date                                                    
            // * Account Group                                                   
            // [T-Up#INFO][COACTUPC.cbl, LINE #4145] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #4147] SET statement
            container.getWsMiscStorage().setWsReturnMsg(
                    DATA_WAS_CHANGED_BEFORE_UPDATE);
            // [T-Up#INFO][COACTUPC.cbl, LINE #4148] GOTO statement
            context.setGotoTarget(_9600WriteProcessingExit);
            return;
        }
        // ******************************************************************
        ...
        // ******************************************************************
        // [T-Up#INFO][COACTUPC.cbl, LINE #4156] IF statement
        if (CobStringUtils.compare(container.getCustomerRecord()
            ...
            // [T-Up#INFO][COACTUPC.cbl, LINE #4191] CONTINUE statement
        } else {
            // [T-Up#INFO][COACTUPC.cbl, LINE #4193] SET statement
            container.getWsMiscStorage().setWsReturnMsg(
                    DATA_WAS_CHANGED_BEFORE_UPDATE);
            // [T-Up#INFO][COACTUPC.cbl, LINE #4194] GOTO statement
            context.setGotoTarget(_9600WriteProcessingExit);
            return;
        }
    }
    ...
    void _9700CheckChangeInRecExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #4198] EXIT statement
    }
    ...
    void abendRoutine(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][COACTUPC.cbl, LINE #4209] IF statement
        if (CobStringUtils.compare(container.getAbendData().getAbendMsg(),
                StringUtils.repeat((char) 0x00, 72)) == 0) {
            // [T-Up#INFO][COACTUPC.cbl, LINE #4210] MOVE statement
            container.getAbendData().setAbendMsg("UNEXPECTED ABEND OCCURRED.");
        }
        // [T-Up#INFO][COACTUPC.cbl, LINE #4213] MOVE statement
        container.getAbendData().setAbendCulprit(
                container.getWsLiterals().getLitThispgm());
        // [T-Up#INFO][COACTUPC.cbl, LINE #4215] EXEC_CICS statement
        /*
                       EXEC CICS SEND                                               
                                        FROM (ABEND-DATA)                           
        ...
        // [T-Up#INFO][COACTUPC.cbl, LINE #4222] EXEC_CICS statement
        /*
                       EXEC CICS HANDLE ABEND                                       
                            CANCEL                                                  
                       END-EXEC
         */
        abendHandler.cancel();
        // [T-Up#INFO][COACTUPC.cbl, LINE #4226] EXEC_CICS statement
        /*
                       EXEC CICS ABEND                                              
                            ABCODE('9999')                                          
                       END-EXEC
    ...
    void abendRoutineExit(OpenFrameContext context) {
        // [T-Up#INFO][COACTUPC.cbl, LINE #4231] EXIT statement
    }
    ...
    //       *COPY CSUTLDPY                                                    
    //       *    .                                                            
    // *(/home/oflab/repository/ref/COBOL_COPYBOOK/CARDDEMO/CSUTLDPY.cpy)
    // ******************************************************************
    ...
    void editDateCcyymmdd(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #20] SET statement
    ...
    void editYearCcyy(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #28] SET statement
        container.getWsMiscStorage().getWsCalculationVars().getWsEditDateFlgs()
                .setWsEditYearFlg(FLG_YEAR_NOT_OK);
        // *    Not supplied                                                 
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #31] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #33] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #34] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditYearFlg(FLG_YEAR_BLANK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #35] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #36] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #43] GOTO statement
            context.setGotoTarget(editYearCcyyExit);
            return;
        } else {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #45] CONTINUE statement
        }
        // *    Not numeric                                                  
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #49] IF statement
        if (!StringUtils.isNumeric(container.getWsMiscStorage()
                .getWsCalculationVars().getWsEditDateCcyymmdd()
                .getWsEditDateCcyy().toString())) {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #50] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #51] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditYearFlg(FLG_YEAR_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #52] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #53] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #59] GOTO statement
            context.setGotoTarget(editYearCcyyExit);
            return;
        } else {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #61] CONTINUE statement
        }
        // ******************************************************************
        ...
        // ******************************************************************
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #71] IF statement
        if (container.getWsMiscStorage().getWsCalculationVars()
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #73] CONTINUE statement
        } else {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #75] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #76] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditYearFlg(FLG_YEAR_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #77] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #78] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #84] GOTO statement
            context.setGotoTarget(editYearCcyyExit);
            return;
        }
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #87] SET statement
        container.getWsMiscStorage().getWsCalculationVars().getWsEditDateFlgs()
                .setWsEditYearFlg(FLG_YEAR_ISVALID);
    }

    void editYearCcyyExit(OpenFrameContext context) {
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #90] EXIT statement
    }
    ...
    void editMonth(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #93] SET statement
        container.getWsMiscStorage().getWsCalculationVars().getWsEditDateFlgs()
                .setWsEditMonth(FLG_MONTH_NOT_OK);
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #95] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsCalculationVars().getWsEditDateCcyymmdd()
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #97] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #98] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditMonth(FLG_MONTH_BLANK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #99] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #100] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #106] GOTO statement
            context.setGotoTarget(editMonthExit);
            return;
        } else {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #108] CONTINUE statement
        }
        // *    Month not reasonable                                         
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #112] IF statement
        if (container.getWsMiscStorage().getWsCalculationVars()
                .getWsEditDateCcyymmdd().getWsEditDateMmN() >= WS_VALID_MONTH_START
                && container.getWsMiscStorage().getWsCalculationVars()
                        .getWsEditDateCcyymmdd().getWsEditDateMmN() <= WS_VALID_MONTH_END) {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #113] CONTINUE statement
        } else {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #115] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #116] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditMonth(FLG_MONTH_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #117] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #118] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #124] GOTO statement
            context.setGotoTarget(editMonthExit);
            return;
        }
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #127] IF statement
        if (IntrinsicFunction.functionTestNumval(container.getWsMiscStorage()
                .getWsCalculationVars().getWsEditDateCcyymmdd()
                .getWsEditDateMm()) == 0) {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #128] COMPUTE statement
            container
                    .getWsMiscStorage()
                    .getWsCalculationVars()
                    .getWsEditDateCcyymmdd()
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #132] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #133] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditMonth(FLG_MONTH_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #134] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #135] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #141] GOTO statement
            context.setGotoTarget(editMonthExit);
            return;
        }
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #144] SET statement
        container.getWsMiscStorage().getWsCalculationVars().getWsEditDateFlgs()
                .setWsEditMonth(FLG_MONTH_ISVALID);
    }

    void editMonthExit(OpenFrameContext context) {
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #147] EXIT statement
    }
    ...
    void editDay(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #153] SET statement
        container.getWsMiscStorage().getWsCalculationVars().getWsEditDateFlgs()
                .setWsEditDay(FLG_DAY_ISVALID);
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #155] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsCalculationVars().getWsEditDateCcyymmdd()
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #157] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #158] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditDay(FLG_DAY_BLANK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #159] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #160] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #166] GOTO statement
            context.setGotoTarget(editDayExit);
            return;
        } else {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #168] CONTINUE statement
        }
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #171] IF statement
        if (IntrinsicFunction.functionTestNumval(container.getWsMiscStorage()
                .getWsCalculationVars().getWsEditDateCcyymmdd()
                .getWsEditDateDd()) == 0) {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #172] COMPUTE statement
            container
                    .getWsMiscStorage()
                    .getWsCalculationVars()
                    .getWsEditDateCcyymmdd()
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #176] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #177] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditDay(FLG_DAY_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #178] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #179] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #185] GOTO statement
            context.setGotoTarget(editDayExit);
            return;
        }
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #188] IF statement
        if (container.getWsMiscStorage().getWsCalculationVars()
                .getWsEditDateCcyymmdd().getWsEditDateDdN() >= WS_VALID_DAY_START
                && container.getWsMiscStorage().getWsCalculationVars()
                        .getWsEditDateCcyymmdd().getWsEditDateDdN() <= WS_VALID_DAY_END) {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #189] CONTINUE statement
        } else {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #191] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #192] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditDay(FLG_DAY_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #193] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #194] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #200] GOTO statement
            context.setGotoTarget(editDayExit);
            return;
        }
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #204] SET statement
        container.getWsMiscStorage().getWsCalculationVars().getWsEditDateFlgs()
                .setWsEditDay(FLG_DAY_ISVALID);
    }

    void editDayExit(OpenFrameContext context) {
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #207] EXIT statement
    }
    ...
    void editDayMonthYear(OpenFrameContext context) {
        ...
        // ******************************************************************
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #214] IF statement
        if (!(container.getWsMiscStorage().getWsCalculationVars()
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #216] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #217] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditDay(FLG_DAY_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #218] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditMonth(FLG_MONTH_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #219] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #220] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #226] GOTO statement
            context.setGotoTarget(editDateCcyymmddExit);
            return;
        }
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #229] IF statement
        if (container.getWsMiscStorage().getWsCalculationVars()
                .getWsEditDateCcyymmdd().getWsEditDateMmN() == WS_FEBRUARY
                && container.getWsMiscStorage().getWsCalculationVars()
                        .getWsEditDateCcyymmdd().getWsEditDateDdN() == WS_DAY_30) {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #231] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #232] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditDay(FLG_DAY_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #233] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditMonth(FLG_MONTH_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #234] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #235] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #241] GOTO statement
            context.setGotoTarget(editDateCcyymmddExit);
            return;
        }
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #244] IF statement
        if (container.getWsMiscStorage().getWsCalculationVars()
                .getWsEditDateCcyymmdd().getWsEditDateMmN() == WS_FEBRUARY
                && container.getWsMiscStorage().getWsCalculationVars()
                        .getWsEditDateCcyymmdd().getWsEditDateDdN() == WS_DAY_29) {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #246] IF statement
            if (container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateCcyymmdd().getWsEditDateCcyy()
                    .getWsEditDateYyN() == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #247] MOVE statement
                container.getWsMiscStorage().getWsCalculationVars()
                        .setWsDivBy(400);
            } else {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #249] MOVE statement
                container.getWsMiscStorage().getWsCalculationVars()
                        .setWsDivBy(4);
            }
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #252] DIVIDE statement
                                                    ...
                                                    .multiply(
                                                            BigDecimal
                                                                    ...
                                                                    .setScale(
                                                                            ...
                                                                            RoundingMode.DOWN)))
                                    .intValue());
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #257] IF statement
            if (container.getWsMiscStorage().getWsCalculationVars()
                    .getWsRemainder() == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #258] CONTINUE statement
            } else {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #260] SET statement
                container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #261] SET statement
                container.getWsMiscStorage().getWsCalculationVars()
                        .getWsEditDateFlgs().setWsEditDay(FLG_DAY_NOT_OK);
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #262] SET statement
                container.getWsMiscStorage().getWsCalculationVars()
                        .getWsEditDateFlgs().setWsEditMonth(FLG_MONTH_NOT_OK);
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #263] SET statement
                container.getWsMiscStorage().getWsCalculationVars()
                        .getWsEditDateFlgs().setWsEditYearFlg(FLG_YEAR_NOT_OK);
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #264] IF statement
                if (CobStringUtils.compare(container.getWsMiscStorage()
                        .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                    // [T-Up#INFO][CSUTLDPY.cpy, LINE #265] STRING statement
                    tempStringBuilder1 = new StringBuilder();
                    tempStringBuilder2 = new StringBuilder(container
                            .getWsMiscStorage().getWsReturnMsg());
                    tempStringBuilder1
                ...
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #271] GOTO statement
                context.setGotoTarget(editDateCcyymmddExit);
                return;
            }
        }
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #275] IF statement
        if (CobStringUtils.compare(container.getWsMiscStorage()
                .getWsCalculationVars().getWsEditDateFlgs().get(),
                WS_EDIT_DATE_IS_VALID) == 0) {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #276] CONTINUE statement
        } else {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #278] GOTO statement
            context.setGotoTarget(editDateCcyymmddExit);
            return;
        }
    }
    ...
    void editDayMonthYearExit(OpenFrameContext context) {
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #282] EXIT statement
    }
    ...
    void editDateLe(OpenFrameContext context) {
        ...
        // ******************************************************************
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #291] INITIALIZE statement
        container
                .getWsMiscStorage()
                .getWsCalculationVars()
                .setWsDateValidationResult(
                        CoactupcWsMiscStorage.CoactupcWsCalculationVars.CoactupcWsDateValidationResult
                                .createDefaultValueInstance());
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #292] MOVE statement
        container.getWsMiscStorage().getWsCalculationVars()
                .setWsDateFormat("YYYYMMDD");
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #294] CALL statement
        ...
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #299] IF statement
        if (container.getWsMiscStorage().getWsCalculationVars()
                .getWsDateValidationResult().getWsSeverityN() == 0) {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #300] CONTINUE statement
        } else {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #302] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #303] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditDay(FLG_DAY_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #304] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditMonth(FLG_MONTH_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #305] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditYearFlg(FLG_YEAR_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #306] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #307] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #316] GOTO statement
            context.setGotoTarget(editDateLeExit);
            return;
        }
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #319] IF statement
        if (!(CobStringUtils.compare(container.getWsMiscStorage()
                .getWsInputFlag(), INPUT_ERROR) == 0)) {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #320] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
    ...
    void editDateLeExit(OpenFrameContext context) {
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #325] EXIT statement
        // *    If we got here all edits were cleared                        
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #328] SET statement
        container.getWsMiscStorage().getWsCalculationVars().getWsEditDateFlgs()
                .set(WS_EDIT_DATE_IS_VALID);
    }

    void editDateCcyymmddExit(OpenFrameContext context) {
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #331] EXIT statement
    }
    ...
    void editDateOfBirth(OpenFrameContext context) {
        ...
        CoactupcVariableContainer container = (CoactupcVariableContainer) context
                .getProgramVariableContainer("Coactupc");
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #344] MOVE statement
        container
                .getWsMiscStorage()
                .getWsCalculationVars()
                .getWsCurrentDate()
        ...
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #346] COMPUTE statement
        container
                .getWsMiscStorage()
                .getWsCalculationVars()
                .setWsEditDateBinary(
        ...
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #348] COMPUTE statement
        container
                .getWsMiscStorage()
                .getWsCalculationVars()
                .getWsCurrentDate()
        ...
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #351] IF statement
        if (container.getWsMiscStorage().getWsCalculationVars()
            ...
            // *                             ,DAYS) > 0                          
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #355] CONTINUE statement
        } else {
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #357] SET statement
            container.getWsMiscStorage().setWsInputFlag(INPUT_ERROR);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #358] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditDay(FLG_DAY_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #359] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditMonth(FLG_MONTH_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #360] SET statement
            container.getWsMiscStorage().getWsCalculationVars()
                    .getWsEditDateFlgs().setWsEditYearFlg(FLG_YEAR_NOT_OK);
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #361] IF statement
            if (CobStringUtils.compare(container.getWsMiscStorage()
                    .getWsReturnMsg(), WS_RETURN_MSG_OFF) == 0) {
                // [T-Up#INFO][CSUTLDPY.cpy, LINE #362] STRING statement
                tempStringBuilder1 = new StringBuilder();
                tempStringBuilder2 = new StringBuilder(container
                        .getWsMiscStorage().getWsReturnMsg());
                tempStringBuilder1.append(
            ...
            // [T-Up#INFO][CSUTLDPY.cpy, LINE #368] GOTO statement
    ...
    void editDateOfBirthExit(OpenFrameContext context) {
        // [T-Up#INFO][CSUTLDPY.cpy, LINE #372] EXIT statement
    }
