 ...
 */
public @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdslcCarddemoCommarea {
    // [T-Up#INFO][COCOM01Y.cpy, LINE #21] CDEMO-GENERAL-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdslcCdemoGeneralInfo cdemoGeneralInfo = new CocrdslcCdemoGeneralInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #33] CDEMO-CUSTOMER-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdslcCdemoCustomerInfo cdemoCustomerInfo = new CocrdslcCdemoCustomerInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #38] CDEMO-ACCOUNT-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdslcCdemoAccountInfo cdemoAccountInfo = new CocrdslcCdemoAccountInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #41] CDEMO-CARD-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdslcCdemoCardInfo cdemoCardInfo = new CocrdslcCdemoCardInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #43] CDEMO-MORE-INFO (level: 5)
    private @Getter @Setter @Builder.Default CocrdslcCdemoMoreInfo cdemoMoreInfo = new CocrdslcCdemoMoreInfo();

    public static CocrdslcCarddemoCommarea createDefaultValueInstance() {
        return new CocrdslcCarddemoCommarea.builder()
                .cdemoGeneralInfo(
                        CocrdslcCdemoGeneralInfo.createDefaultValueInstance())
                .cdemoCustomerInfo(
                        CocrdslcCdemoCustomerInfo.createDefaultValueInstance())
                .cdemoAccountInfo(
                        CocrdslcCdemoAccountInfo.createDefaultValueInstance())
                .cdemoCardInfo(
                        CocrdslcCdemoCardInfo.createDefaultValueInstance())
                .cdemoMoreInfo(
                        CocrdslcCdemoMoreInfo.createDefaultValueInstance())
                .build();
    }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdslcCdemoGeneralInfo {
        ...
        public static CocrdslcCdemoGeneralInfo createDefaultValueInstance() {
            return new CocrdslcCdemoGeneralInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdslcCdemoCustomerInfo {
        ...
        public static CocrdslcCdemoCustomerInfo createDefaultValueInstance() {
            return new CocrdslcCdemoCustomerInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdslcCdemoAccountInfo {
        ...
        public static CocrdslcCdemoAccountInfo createDefaultValueInstance() {
            return new CocrdslcCdemoAccountInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdslcCdemoCardInfo {
        // [T-Up#INFO][COCOM01Y.cpy, LINE #42] CDEMO-CARD-NUM (level: 10)
        private @Getter @Setter long cdemoCardNum;

        public static CocrdslcCdemoCardInfo createDefaultValueInstance() {
            return new CocrdslcCdemoCardInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdslcCdemoMoreInfo {
        ...
        public static CocrdslcCdemoMoreInfo createDefaultValueInstance() {
            return new CocrdslcCdemoMoreInfo.builder().build();
        }
