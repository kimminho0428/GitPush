 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Coadm01cCarddemoCommarea {
    // [T-Up#INFO][COCOM01Y.cpy, LINE #21] CDEMO-GENERAL-INFO (level: 5)
    private @Getter @Setter Coadm01cCdemoGeneralInfo cdemoGeneralInfo = new Coadm01cCdemoGeneralInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #33] CDEMO-CUSTOMER-INFO (level: 5)
    private @Getter @Setter Coadm01cCdemoCustomerInfo cdemoCustomerInfo = new Coadm01cCdemoCustomerInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #38] CDEMO-ACCOUNT-INFO (level: 5)
    private @Getter @Setter Coadm01cCdemoAccountInfo cdemoAccountInfo = new Coadm01cCdemoAccountInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #41] CDEMO-CARD-INFO (level: 5)
    private @Getter @Setter Coadm01cCdemoCardInfo cdemoCardInfo = new Coadm01cCdemoCardInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #43] CDEMO-MORE-INFO (level: 5)
    private @Getter @Setter Coadm01cCdemoMoreInfo cdemoMoreInfo = new Coadm01cCdemoMoreInfo();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Coadm01cCdemoGeneralInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Coadm01cCdemoCustomerInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Coadm01cCdemoAccountInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Coadm01cCdemoCardInfo {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Coadm01cCdemoMoreInfo {
