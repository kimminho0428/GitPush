 ...
 */
public @AllArgsConstructor @NoArgsConstructor class CocrdlicCcWorkAreas {
    // [T-Up#INFO][CVCRD01Y.cpy, LINE #3] CC-WORK-AREA (level: 5)
    private @Getter @Setter CocrdlicCcWorkArea ccWorkArea = new CocrdlicCcWorkArea();
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdlicCcWorkArea {
        ...
        public static CocrdlicCcWorkArea createDefaultValueInstance() {
            return new CocrdlicCcWorkArea.builder()
