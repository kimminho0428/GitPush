...
public class Cbact03cVariableContainer {
    ...
    private @Getter @Setter Cbact03cCardXrefRecord cardXrefRecord = new Cbact03cCardXrefRecord();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:16:00 CDT 
    // *                                                                 
    // [T-Up#INFO][CBACT03C.cbl, LINE #46] XREFFILE-STATUS (level: 1)
    private @Getter @Setter Cbact03cXreffileStatus xreffileStatus = new Cbact03cXreffileStatus();
    // [T-Up#INFO][CBACT03C.cbl, LINE #50] IO-STATUS (level: 1)
    private @Getter @Setter Cbact03cIoStatus ioStatus = new Cbact03cIoStatus();
    // [T-Up#INFO][CBACT03C.cbl, LINE #53] TWO-BYTES-BINARY (level: 1)
    ...
    // [T-Up#INFO][CBACT03C.cbl, LINE #57] IO-STATUS-04 (level: 1)
    private @Getter @Setter Cbact03cIoStatus04 ioStatus04 = new Cbact03cIoStatus04();
    // [T-Up#INFO][CBACT03C.cbl, LINE #61] APPL-RESULT (level: 1)
    private @Getter @Setter int applResult;
    // [T-Up#INFO][CBACT03C.cbl, LINE #62] APPL-AOK (level: 88)
    public static final int APPL_AOK = 0;
    // [T-Up#INFO][CBACT03C.cbl, LINE #63] APPL-EOF (level: 88)
    public static final int APPL_EOF = 16;
    // [T-Up#INFO][CBACT03C.cbl, LINE #65] END-OF-FILE (level: 1)
    private @Getter String endOfFile = "N";
    // [T-Up#INFO][CBACT03C.cbl, LINE #66] ABCODE (level: 1)
    private @Getter @Setter int abcode;
    // [T-Up#INFO][CBACT03C.cbl, LINE #67] TIMING (level: 1)
    private @Getter @Setter int timing;
    // [T-Up#INFO][CBACT03C.cbl, LINE #38] FD-XREFFILE-REC (level: 1)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class Cbact03cTwoBytesAlpha {
        // [T-Up#INFO][CBACT03C.cbl, LINE #55] TWO-BYTES-LEFT (level: 5)
        private @Getter String twoBytesLeft = StringUtils.repeat(' ', 1);
        // [T-Up#INFO][CBACT03C.cbl, LINE #56] TWO-BYTES-RIGHT (level: 5)
