 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cotrn01cWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter Cotrn01cWsCurdateData wsCurdateData = new Cotrn01cWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter Cotrn01cWsCurdateMmDdYy wsCurdateMmDdYy = new Cotrn01cWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter Cotrn01cWsCurtimeHhMmSs wsCurtimeHhMmSs = new Cotrn01cWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter Cotrn01cWsTimestamp wsTimestamp = new Cotrn01cWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cotrn01cWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter Cotrn01cWsCurdate wsCurdate = new Cotrn01cWsCurdate();
        ...
        private @Getter @Setter Cotrn01cWsCurtime wsCurtime = new Cotrn01cWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cotrn01cWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cotrn01cWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cotrn01cWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cotrn01cWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cotrn01cWsTimestamp {
