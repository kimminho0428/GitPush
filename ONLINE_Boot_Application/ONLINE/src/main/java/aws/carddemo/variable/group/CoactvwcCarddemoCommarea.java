 ...
 */
public @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactvwcCarddemoCommarea {
    // [T-Up#INFO][COCOM01Y.cpy, LINE #21] CDEMO-GENERAL-INFO (level: 5)
    private @Getter @Setter @Builder.Default CoactvwcCdemoGeneralInfo cdemoGeneralInfo = new CoactvwcCdemoGeneralInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #33] CDEMO-CUSTOMER-INFO (level: 5)
    private @Getter @Setter @Builder.Default CoactvwcCdemoCustomerInfo cdemoCustomerInfo = new CoactvwcCdemoCustomerInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #38] CDEMO-ACCOUNT-INFO (level: 5)
    private @Getter @Setter @Builder.Default CoactvwcCdemoAccountInfo cdemoAccountInfo = new CoactvwcCdemoAccountInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #41] CDEMO-CARD-INFO (level: 5)
    private @Getter @Setter @Builder.Default CoactvwcCdemoCardInfo cdemoCardInfo = new CoactvwcCdemoCardInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #43] CDEMO-MORE-INFO (level: 5)
    private @Getter @Setter @Builder.Default CoactvwcCdemoMoreInfo cdemoMoreInfo = new CoactvwcCdemoMoreInfo();

    public static CoactvwcCarddemoCommarea createDefaultValueInstance() {
        return new CoactvwcCarddemoCommarea.builder()
                .cdemoGeneralInfo(
                        CoactvwcCdemoGeneralInfo.createDefaultValueInstance())
                .cdemoCustomerInfo(
                        CoactvwcCdemoCustomerInfo.createDefaultValueInstance())
                .cdemoAccountInfo(
                        CoactvwcCdemoAccountInfo.createDefaultValueInstance())
                .cdemoCardInfo(
                        CoactvwcCdemoCardInfo.createDefaultValueInstance())
                .cdemoMoreInfo(
                        CoactvwcCdemoMoreInfo.createDefaultValueInstance())
                .build();
    }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactvwcCdemoGeneralInfo {
        ...
        public static CoactvwcCdemoGeneralInfo createDefaultValueInstance() {
            return new CoactvwcCdemoGeneralInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactvwcCdemoCustomerInfo {
        ...
        public static CoactvwcCdemoCustomerInfo createDefaultValueInstance() {
            return new CoactvwcCdemoCustomerInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactvwcCdemoAccountInfo {
        ...
        public static CoactvwcCdemoAccountInfo createDefaultValueInstance() {
            return new CoactvwcCdemoAccountInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactvwcCdemoCardInfo {
        // [T-Up#INFO][COCOM01Y.cpy, LINE #42] CDEMO-CARD-NUM (level: 10)
        private @Getter @Setter long cdemoCardNum;

        public static CoactvwcCdemoCardInfo createDefaultValueInstance() {
            return new CoactvwcCdemoCardInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactvwcCdemoMoreInfo {
        ...
        public static CoactvwcCdemoMoreInfo createDefaultValueInstance() {
            return new CoactvwcCdemoMoreInfo.builder().build();
        }
