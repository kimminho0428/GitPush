...
public @AllArgsConstructor @NoArgsConstructor class CoactupcWsLiterals {
    // [T-Up#INFO][COACTUPC.cbl, LINE #534] LIT-THISPGM (level: 5)
    private @Getter String litThispgm = "COACTUPC";
    // [T-Up#INFO][COACTUPC.cbl, LINE #536] LIT-THISTRANID (level: 5)
    private @Getter String litThistranid = "CAUP";
    // [T-Up#INFO][COACTUPC.cbl, LINE #538] LIT-THISMAPSET (level: 5)
    private @Getter String litThismapset = "COACTUP ";
    // [T-Up#INFO][COACTUPC.cbl, LINE #540] LIT-THISMAP (level: 5)
    private @Getter String litThismap = "CACTUPA";
    // [T-Up#INFO][COACTUPC.cbl, LINE #542] LIT-CARDUPDATE-PGM (level: 5)
    private @Getter String litCardupdatePgm = "COCRDUPC";
    // [T-Up#INFO][COACTUPC.cbl, LINE #544] LIT-CARDUPDATE-TRANID (level: 5)
    private @Getter String litCardupdateTranid = "CCUP";
    // [T-Up#INFO][COACTUPC.cbl, LINE #546] LIT-CARDUPDATE-MAPSET (level: 5)
    private @Getter String litCardupdateMapset = "COCRDUP ";
    // [T-Up#INFO][COACTUPC.cbl, LINE #548] LIT-CARDUPDATE-MAP (level: 5)
    private @Getter String litCardupdateMap = "CCRDUPA";
    // [T-Up#INFO][COACTUPC.cbl, LINE #550] LIT-CCLISTPGM (level: 5)
    private @Getter String litCclistpgm = "COCRDLIC";
    // [T-Up#INFO][COACTUPC.cbl, LINE #552] LIT-CCLISTTRANID (level: 5)
    private @Getter String litCclisttranid = "CCLI";
    // [T-Up#INFO][COACTUPC.cbl, LINE #554] LIT-CCLISTMAPSET (level: 5)
    private @Getter String litCclistmapset = "COCRDLI";
    // [T-Up#INFO][COACTUPC.cbl, LINE #556] LIT-CCLISTMAP (level: 5)
    private @Getter String litCclistmap = "CCRDSLA";
    // [T-Up#INFO][COACTUPC.cbl, LINE #558] LIT-MENUPGM (level: 5)
    private @Getter String litMenupgm = "COMEN01C";
    // [T-Up#INFO][COACTUPC.cbl, LINE #560] LIT-MENUTRANID (level: 5)
    private @Getter String litMenutranid = "CM00";
    // [T-Up#INFO][COACTUPC.cbl, LINE #562] LIT-MENUMAPSET (level: 5)
    private @Getter String litMenumapset = "COMEN01";
    // [T-Up#INFO][COACTUPC.cbl, LINE #564] LIT-MENUMAP (level: 5)
    private @Getter String litMenumap = "COMEN1A";
    // [T-Up#INFO][COACTUPC.cbl, LINE #566] LIT-CARDDTLPGM (level: 5)
    private @Getter String litCarddtlpgm = "COCRDSLC";
    // [T-Up#INFO][COACTUPC.cbl, LINE #568] LIT-CARDDTLTRANID (level: 5)
    private @Getter String litCarddtltranid = "CCDL";
    // [T-Up#INFO][COACTUPC.cbl, LINE #570] LIT-CARDDTLMAPSET (level: 5)
    private @Getter String litCarddtlmapset = "COCRDSL";
    // [T-Up#INFO][COACTUPC.cbl, LINE #572] LIT-CARDDTLMAP (level: 5)
    private @Getter String litCarddtlmap = "CCRDSLA";
    // [T-Up#INFO][COACTUPC.cbl, LINE #574] LIT-ACCTFILENAME (level: 5)
    private @Getter String litAcctfilename = "ACCTDAT ";
    // [T-Up#INFO][COACTUPC.cbl, LINE #576] LIT-CUSTFILENAME (level: 5)
    private @Getter String litCustfilename = "CUSTDAT ";
    // [T-Up#INFO][COACTUPC.cbl, LINE #578] LIT-CARDFILENAME (level: 5)
    private @Getter String litCardfilename = "CARDDAT ";
    // [T-Up#INFO][COACTUPC.cbl, LINE #580] LIT-CARDFILENAME-ACCT-PATH (level: 5)
    private @Getter String litCardfilenameAcctPath = "CARDAIX ";
    // [T-Up#INFO][COACTUPC.cbl, LINE #582] LIT-CARDXREFNAME-ACCT-PATH (level: 5)
    private @Getter String litCardxrefnameAcctPath = "CXACAIX ";
    // ******************************************************************
    // * Literals for use in INSPECT statements                          
    // ******************************************************************
    // [T-Up#INFO][COACTUPC.cbl, LINE #587] LIT-ALL-ALPHANUM-FROM-X (level: 5)
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CoactupcLitAllAlphanumFromX {
        // [T-Up#INFO][COACTUPC.cbl, LINE #588] LIT-ALL-ALPHA-FROM-X (level: 10)
        private @Getter @Setter CoactupcLitAllAlphaFromX litAllAlphaFromX = new CoactupcLitAllAlphaFromX();
        // [T-Up#INFO][COACTUPC.cbl, LINE #593] LIT-NUMBERS (level: 10)
        ...
        public void set(String source) {
            ...
            litAllAlphaFromX.set(source.substring(0, 52));
            litNumbers = source.substring(52, 62);
        }

        public String get() {
            StringBuilder sb = new StringBuilder();
            sb.append(litAllAlphaFromX.get());
            sb.append(litNumbers);
            return sb.toString();
        }
        ...
        public static @AllArgsConstructor @NoArgsConstructor class CoactupcLitAllAlphaFromX {
            // [T-Up#INFO][COACTUPC.cbl, LINE #589] LIT-UPPER (level: 15)
            private @Getter String litUpper = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
            // [T-Up#INFO][COACTUPC.cbl, LINE #591] LIT-LOWER (level: 15)
            private @Getter String litLower = "abcdefghijklmnopqrstuvwxyz";

            public void setLitUpper(String source) {
                litUpper = StringUtils.truncate(
                        StringUtils.rightPad(source, 26), 26);
            }

            public void setLitLower(String source) {
                litLower = StringUtils.truncate(
                        StringUtils.rightPad(source, 26), 26);
            }

            public void set(String source) {
                source = StringUtils.truncate(StringUtils.rightPad(source, 52),
                        52);
                litUpper = source.substring(0, 26);
                litLower = source.substring(26, 52);
            }
