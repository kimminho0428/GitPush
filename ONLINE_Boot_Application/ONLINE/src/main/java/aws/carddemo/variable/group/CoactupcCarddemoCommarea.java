 ...
 */
public @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactupcCarddemoCommarea {
    // [T-Up#INFO][COCOM01Y.cpy, LINE #21] CDEMO-GENERAL-INFO (level: 5)
    private @Getter @Setter @Builder.Default CoactupcCdemoGeneralInfo cdemoGeneralInfo = new CoactupcCdemoGeneralInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #33] CDEMO-CUSTOMER-INFO (level: 5)
    private @Getter @Setter @Builder.Default CoactupcCdemoCustomerInfo cdemoCustomerInfo = new CoactupcCdemoCustomerInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #38] CDEMO-ACCOUNT-INFO (level: 5)
    private @Getter @Setter @Builder.Default CoactupcCdemoAccountInfo cdemoAccountInfo = new CoactupcCdemoAccountInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #41] CDEMO-CARD-INFO (level: 5)
    private @Getter @Setter @Builder.Default CoactupcCdemoCardInfo cdemoCardInfo = new CoactupcCdemoCardInfo();
    // [T-Up#INFO][COCOM01Y.cpy, LINE #43] CDEMO-MORE-INFO (level: 5)
    private @Getter @Setter @Builder.Default CoactupcCdemoMoreInfo cdemoMoreInfo = new CoactupcCdemoMoreInfo();

    public static CoactupcCarddemoCommarea createDefaultValueInstance() {
        return new CoactupcCarddemoCommarea.builder()
                .cdemoGeneralInfo(
                        CoactupcCdemoGeneralInfo.createDefaultValueInstance())
                .cdemoCustomerInfo(
                        CoactupcCdemoCustomerInfo.createDefaultValueInstance())
                .cdemoAccountInfo(
                        CoactupcCdemoAccountInfo.createDefaultValueInstance())
                .cdemoCardInfo(
                        CoactupcCdemoCardInfo.createDefaultValueInstance())
                .cdemoMoreInfo(
                        CoactupcCdemoMoreInfo.createDefaultValueInstance())
                .build();
    }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactupcCdemoGeneralInfo {
        ...
        public static CoactupcCdemoGeneralInfo createDefaultValueInstance() {
            return new CoactupcCdemoGeneralInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactupcCdemoCustomerInfo {
        ...
        public static CoactupcCdemoCustomerInfo createDefaultValueInstance() {
            return new CoactupcCdemoCustomerInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactupcCdemoAccountInfo {
        ...
        public static CoactupcCdemoAccountInfo createDefaultValueInstance() {
            return new CoactupcCdemoAccountInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactupcCdemoCardInfo {
        // [T-Up#INFO][COCOM01Y.cpy, LINE #42] CDEMO-CARD-NUM (level: 10)
        private @Getter @Setter long cdemoCardNum;

        public static CoactupcCdemoCardInfo createDefaultValueInstance() {
            return new CoactupcCdemoCardInfo.builder().build();
        }
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactupcCdemoMoreInfo {
        ...
        public static CoactupcCdemoMoreInfo createDefaultValueInstance() {
            return new CoactupcCdemoMoreInfo.builder().build();
        }
