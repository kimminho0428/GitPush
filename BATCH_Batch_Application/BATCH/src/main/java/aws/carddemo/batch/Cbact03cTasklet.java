 ...
 * <ul>
 * <li>converted COBOL program: {@link aws.carddemo.Cbact03c}</li>
 * </ul>
 */
@Getter
@Setter
...
public class Cbact03cTasklet implements Tasklet {
    private Map<String, Dd> dd;
    private String parm;
    private final Cbact03c program;
