 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cbcus01cIoStatus {
    // [T-Up#INFO][CBCUS01C.cbl, LINE #51] IO-STAT1 (level: 5)
    private @Getter String ioStat1 = StringUtils.repeat(' ', 1);
    // [T-Up#INFO][CBCUS01C.cbl, LINE #52] IO-STAT2 (level: 5)
    ...
    public void set(Cbcus01cCustfileStatus source) {
        ioStat1 = source.getCustfileStat1();
        ioStat2 = source.getCustfileStat2();
    }
