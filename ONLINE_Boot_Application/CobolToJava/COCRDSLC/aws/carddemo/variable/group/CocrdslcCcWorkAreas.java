 ...
 */
public @AllArgsConstructor @NoArgsConstructor class CocrdslcCcWorkAreas {
    // [T-Up#INFO][CVCRD01Y.cpy, LINE #3] CC-WORK-AREA (level: 5)
    private @Getter @Setter CocrdslcCcWorkArea ccWorkArea = new CocrdslcCcWorkArea();
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CocrdslcCcWorkArea {
        ...
        public static CocrdslcCcWorkArea createDefaultValueInstance() {
            return new CocrdslcCcWorkArea.builder()
