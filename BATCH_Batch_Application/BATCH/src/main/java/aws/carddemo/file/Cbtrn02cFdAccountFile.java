 ...
 * <li>file operation class: {@link Cbtrn02cFileOpAccountFile}</li>
...
public class Cbtrn02cFdAccountFile extends Cbtrn02cFileOpAccountFile {
    ...
    public void open(OpenFrameContext context) {
        ...
        context.initFileWriteBuffer("Cbtrn02c", "AccountFile");
        committer.setThreshold(5000);
    }

    public void start(OpenFrameContext context, Long key, KeyOperationType type) {
        Cbtrn02cFdAcctfileRec startPoint = new Cbtrn02cFdAcctfileRec();
        startPoint.setFdAcctId(key);
        AwsM2CarddemoAcctdataVsamKsdsDto dto = Cbtrn02cMapperInterface.Cbtrn02cFdAcctfileRecKeyToAwsM2CarddemoAcctdataVsamKsdsDto.INSTANCE
                .toTarget(startPoint);
        switch (type) {
        case EQ:
        case GTEQ: {
    ...
    public Cbtrn02cFdAcctfileRec readNextRecord(OpenFrameContext context) {
        ...
        if (iterator.hasNext()) {
            ...
            setFileStatus(context, FileStatus.NORMAL);
            return Cbtrn02cMapperInterface.Cbtrn02cFdAcctfileRecToAwsM2CarddemoAcctdataVsamKsdsDto.INSTANCE
                    .toSource(nextRecord);
        } else {
            setFileStatus(context, FileStatus.AT_END_CONDITION_SEQ_READ);
            return null;
    ...
    public Cbtrn02cFdAcctfileRec readKey(OpenFrameContext context, Long key) {
        commit(context);
        Cbtrn02cFdAcctfileRec readKeyPoint = new Cbtrn02cFdAcctfileRec();
    ...
    public void write(OpenFrameContext context, Cbtrn02cFdAcctfileRec data) {
        List<AwsM2CarddemoAcctdataVsamKsdsDto> writeBuffer = getWriteBuffer(context);
        writeBuffer
                .add(Cbtrn02cMapperInterface.Cbtrn02cFdAcctfileRecToAwsM2CarddemoAcctdataVsamKsdsDto.INSTANCE
                        .toTarget(data));
    ...
    public void rewrite(OpenFrameContext context, Cbtrn02cFdAcctfileRec data,
            Long key) {
        commit(context);
        data.setFdAcctId(key);
        AwsM2CarddemoAcctdataVsamKsdsDto updateDto = Cbtrn02cMapperInterface.Cbtrn02cFdAcctfileRecToAwsM2CarddemoAcctdataVsamKsdsDto.INSTANCE
                .toTarget(data);
        dao.flush();
    ...
    public void delete(OpenFrameContext context, Long key) {
        ...
        commit(context);
        Cbtrn02cFdAcctfileRec deletePoint = new Cbtrn02cFdAcctfileRec();
    ...
    private void setIterator(OpenFrameContext context,
        ...
        context.setFileIterator("Cbtrn02c", "AccountFile", iterator);
    }

    private Iterator<AwsM2CarddemoAcctdataVsamKsdsDto> getIterator(
            OpenFrameContext context) {
        return context.getFileIterator("Cbtrn02c", "AccountFile");
    }

    private List<AwsM2CarddemoAcctdataVsamKsdsDto> getWriteBuffer(
            OpenFrameContext context) {
        return context.getFileWriteBuffer("Cbtrn02c", "AccountFile");
    }
}
