 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cobil00cWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter Cobil00cWsCurdateData wsCurdateData = new Cobil00cWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter Cobil00cWsCurdateMmDdYy wsCurdateMmDdYy = new Cobil00cWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter Cobil00cWsCurtimeHhMmSs wsCurtimeHhMmSs = new Cobil00cWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter Cobil00cWsTimestamp wsTimestamp = new Cobil00cWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cobil00cWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter Cobil00cWsCurdate wsCurdate = new Cobil00cWsCurdate();
        ...
        private @Getter @Setter Cobil00cWsCurtime wsCurtime = new Cobil00cWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cobil00cWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cobil00cWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cobil00cWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cobil00cWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class Cobil00cWsTimestamp {
        ...
        private @Getter @Builder.Default String OFFILLER8 = ":";
        ...
        private @Getter @Builder.Default String OFFILLER10 = ".";
        ...
        public static Cobil00cWsTimestamp createDefaultValueInstance() {
            return new Cobil00cWsTimestamp.builder()
                    .OFFILLER5(StringUtils.repeat(' ', 1))
                    .OFFILLER6(StringUtils.repeat(' ', 1))
                    .OFFILLER7(StringUtils.repeat(' ', 1))
                    .OFFILLER8(StringUtils.repeat(' ', 1))
                    .OFFILLER9(StringUtils.repeat(' ', 1))
                    .OFFILLER10(StringUtils.repeat(' ', 1)).build();
        }

        public void set(String source) {
            source = StringUtils.truncate(StringUtils.rightPad(source, 26), 26);
            try {
                wsTimestampDtYyyy = (int) DataConverter.convZonedStringToLong(
                        source.substring(0, 4), 4);
            } catch (NumberFormatException exception) {
                exception.printStackTrace();
                wsTimestampDtYyyy = 0;
            }
            OFFILLER5 = source.substring(4, 5);
            try {
                wsTimestampDtMm = (int) DataConverter.convZonedStringToLong(
                        source.substring(5, 7), 2);
            } catch (NumberFormatException exception) {
                exception.printStackTrace();
                wsTimestampDtMm = 0;
            }
            OFFILLER6 = source.substring(7, 8);
            try {
                wsTimestampDtDd = (int) DataConverter.convZonedStringToLong(
                        source.substring(8, 10), 2);
            } catch (NumberFormatException exception) {
                exception.printStackTrace();
                wsTimestampDtDd = 0;
            }
            OFFILLER7 = source.substring(10, 11);
            try {
                wsTimestampTmHh = (int) DataConverter.convZonedStringToLong(
                        source.substring(11, 13), 2);
            } catch (NumberFormatException exception) {
                exception.printStackTrace();
                wsTimestampTmHh = 0;
            }
            OFFILLER8 = source.substring(13, 14);
            try {
                wsTimestampTmMm = (int) DataConverter.convZonedStringToLong(
                        source.substring(14, 16), 2);
            } catch (NumberFormatException exception) {
                exception.printStackTrace();
                wsTimestampTmMm = 0;
            }
            OFFILLER9 = source.substring(16, 17);
            try {
                wsTimestampTmSs = (int) DataConverter.convZonedStringToLong(
                        source.substring(17, 19), 2);
            } catch (NumberFormatException exception) {
                exception.printStackTrace();
                wsTimestampTmSs = 0;
            }
            OFFILLER10 = source.substring(19, 20);
            try {
                wsTimestampTmMs6 = (int) DataConverter.convZonedStringToLong(
        ...
        public String get() {
            StringBuilder sb = new StringBuilder();
            sb.append(DataConverter.convZonedLongToString(wsTimestampDtYyyy, 4));
            sb.append(OFFILLER5);
            sb.append(DataConverter.convZonedLongToString(wsTimestampDtMm, 2));
            sb.append(OFFILLER6);
            sb.append(DataConverter.convZonedLongToString(wsTimestampDtDd, 2));
            sb.append(OFFILLER7);
            sb.append(DataConverter.convZonedLongToString(wsTimestampTmHh, 2));
            sb.append(OFFILLER8);
            sb.append(DataConverter.convZonedLongToString(wsTimestampTmMm, 2));
            sb.append(OFFILLER9);
            sb.append(DataConverter.convZonedLongToString(wsTimestampTmSs, 2));
            sb.append(OFFILLER10);
            sb.append(DataConverter.convZonedLongToString(wsTimestampTmMs6, 6));
            return sb.toString();
        }
