 ...
 */
public @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class Cobil00cTranRecord {
    // [T-Up#INFO][CVTRA05Y.cpy, LINE #6] TRAN-ID (level: 5)
    private @Getter @Builder.Default String tranId = StringUtils
            .repeat(' ', 16);
    // [T-Up#INFO][CVTRA05Y.cpy, LINE #7] TRAN-TYPE-CD (level: 5)
    private @Getter @Builder.Default String tranTypeCd = StringUtils.repeat(
            ' ', 2);
    ...
    private @Getter @Builder.Default String tranSource = StringUtils.repeat(
            ' ', 10);
    // [T-Up#INFO][CVTRA05Y.cpy, LINE #10] TRAN-DESC (level: 5)
    private @Getter @Builder.Default String tranDesc = StringUtils.repeat(' ',
            100);
    // [T-Up#INFO][CVTRA05Y.cpy, LINE #11] TRAN-AMT (level: 5)
    private @Getter @Builder.Default BigDecimal tranAmt = BigDecimal.ZERO;
    ...
    private @Getter @Builder.Default String tranMerchantName = StringUtils
            .repeat(' ', 50);
    // [T-Up#INFO][CVTRA05Y.cpy, LINE #14] TRAN-MERCHANT-CITY (level: 5)
    private @Getter @Builder.Default String tranMerchantCity = StringUtils
            .repeat(' ', 50);
    // [T-Up#INFO][CVTRA05Y.cpy, LINE #15] TRAN-MERCHANT-ZIP (level: 5)
    private @Getter @Builder.Default String tranMerchantZip = StringUtils
            .repeat(' ', 10);
    // [T-Up#INFO][CVTRA05Y.cpy, LINE #16] TRAN-CARD-NUM (level: 5)
    private @Getter @Builder.Default String tranCardNum = StringUtils.repeat(
            ' ', 16);
    // [T-Up#INFO][CVTRA05Y.cpy, LINE #17] TRAN-ORIG-TS (level: 5)
    private @Getter @Builder.Default String tranOrigTs = StringUtils.repeat(
            ' ', 26);
    // [T-Up#INFO][CVTRA05Y.cpy, LINE #18] TRAN-PROC-TS (level: 5)
    private @Getter @Builder.Default String tranProcTs = StringUtils.repeat(
            ' ', 26);
    ...
    public static Cobil00cTranRecord createDefaultValueInstance() {
        return new Cobil00cTranRecord.builder().build();
    }
