...
public @AllArgsConstructor @NoArgsConstructor class Comen01cWsVariables {
    // [T-Up#INFO][COMEN01C.cbl, LINE #36] WS-PGMNAME (level: 5)
    private @Getter String wsPgmname = "COMEN01C";
    // [T-Up#INFO][COMEN01C.cbl, LINE #37] WS-TRANID (level: 5)
    private @Getter String wsTranid = "CM00";
    // [T-Up#INFO][COMEN01C.cbl, LINE #38] WS-MESSAGE (level: 5)
    private @Getter String wsMessage = StringUtils.repeat(' ', 80);
    // [T-Up#INFO][COMEN01C.cbl, LINE #39] WS-USRSEC-FILE (level: 5)
    private @Getter String wsUsrsecFile = "USRSEC  ";
    // [T-Up#INFO][COMEN01C.cbl, LINE #40] WS-ERR-FLG (level: 5)
    private @Getter String wsErrFlg = "N";
    // [T-Up#INFO][COMEN01C.cbl, LINE #41] ERR-FLG-ON (level: 88)
    public static final String ERR_FLG_ON = "Y";
    // [T-Up#INFO][COMEN01C.cbl, LINE #42] ERR-FLG-OFF (level: 88)
    public static final String ERR_FLG_OFF = "N";
    // [T-Up#INFO][COMEN01C.cbl, LINE #43] WS-RESP-CD (level: 5)
    private @Getter @Setter int wsRespCd = 0;
    // [T-Up#INFO][COMEN01C.cbl, LINE #44] WS-REAS-CD (level: 5)
    private @Getter @Setter int wsReasCd = 0;
    // [T-Up#INFO][COMEN01C.cbl, LINE #45] WS-OPTION-X (level: 5)
    private @Getter String wsOptionX = StringUtils.repeat(' ', 2);
    // [T-Up#INFO][COMEN01C.cbl, LINE #46] WS-OPTION (level: 5)
    private @Getter @Setter int wsOption = 0;
    // [T-Up#INFO][COMEN01C.cbl, LINE #47] WS-IDX (level: 5)
    private @Getter @Setter int wsIdx = 0;
    // [T-Up#INFO][COMEN01C.cbl, LINE #48] WS-MENU-OPT-TXT (level: 5)
