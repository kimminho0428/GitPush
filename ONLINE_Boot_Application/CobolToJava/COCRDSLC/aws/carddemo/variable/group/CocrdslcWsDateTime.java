 ...
 */
public @AllArgsConstructor @NoArgsConstructor class CocrdslcWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter CocrdslcWsCurdateData wsCurdateData = new CocrdslcWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter CocrdslcWsCurdateMmDdYy wsCurdateMmDdYy = new CocrdslcWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter CocrdslcWsCurtimeHhMmSs wsCurtimeHhMmSs = new CocrdslcWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter CocrdslcWsTimestamp wsTimestamp = new CocrdslcWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdslcWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter CocrdslcWsCurdate wsCurdate = new CocrdslcWsCurdate();
        ...
        private @Getter @Setter CocrdslcWsCurtime wsCurtime = new CocrdslcWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class CocrdslcWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class CocrdslcWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdslcWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdslcWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdslcWsTimestamp {
