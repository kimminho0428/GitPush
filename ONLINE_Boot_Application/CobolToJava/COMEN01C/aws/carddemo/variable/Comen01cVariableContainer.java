...
public class Comen01cVariableContainer {
    ...
    // *----------------------------------------------------------------*
    // [T-Up#INFO][COMEN01C.cbl, LINE #35] WS-VARIABLES (level: 1)
    ...
    private @Getter @Setter Comen01cCarddemoCommarea carddemoCommarea = new Comen01cCarddemoCommarea();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:15:57 CDT 
    // *                                                                 
    //       *COPY COMEN02Y.                                                   
    // *(/home/oflab/repository/ref/COBOL_COPYBOOK/CARDDEMO/COMEN02Y.cpy)
    // ******************************************************************
    ...
    // * language governing permissions and limitations under the License
    // ******************************************************************
    // [T-Up#INFO][COMEN02Y.cpy, LINE #20] CARDDEMO-MAIN-MENU-OPTIONS (level: 1)
    private @Getter @Setter Comen01cCarddemoMainMenuOptions carddemoMainMenuOptions = new Comen01cCarddemoMainMenuOptions();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:15:58 CDT 
    // *                                                                 
    //       *COPY COMEN01.                                                    
    // *(/home/oflab/repository/ref/COBOL_COPYBOOK/CARDDEMO/COMEN01.CPY) 
    // ******************************************************************
    // * Copyright Amazon.com, Inc. or its affiliates.                   
    // * All Rights Reserved.                                            
    // *                                                                 
    ...
    // * language governing permissions and limitations under the License
    // ******************************************************************
    // [T-Up#INFO][COMEN01.CPY, LINE #18] COMEN1AI (level: 1)
    private @Getter @Setter Comen01cComen1ai comen1ai = new Comen01cComen1ai();

    public Comen01cComen1ao getComen1ao() {
        return Comen01cComen1ao.builder().OFFILLER1(getOFFILLER1())
    ...
    public void setOFFILLER2(String source) {
        ...
        try {
            ...
            tempByteBuffer1.flip();
            getComen1ai().setTrnnamel(tempByteBuffer1.getShort());
    ...
    public String getTrnnamec() {
        return getComen1ai().getOFFILLER3().substring(0, 1);
    }

    public void setTrnnamec(String source) {
        getComen1ai()
                .setOFFILLER3(
                        StringUtils.overlay(getComen1ai().getOFFILLER3(),
                                source, 0, 1));
    }

    public String getTrnnamep() {
        return getComen1ai().getOFFILLER3().substring(1, 2);
    }
    ...
    public String getTrnnameh() {
        return getComen1ai().getOFFILLER3().substring(2, 3);
    }
    ...
    public String getTrnnamev() {
        return getComen1ai().getOFFILLER3().substring(3);
    }
    ...
    public String getOFFILLER3() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getTitle01l());
        tempByteBuffer1.flip();
        String temp2 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp2 + getComen1ai().getTitle01f();
    }
    ...
    public void setOFFILLER3(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setTitle01l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getTitle01c() {
        return getComen1ai().getOFFILLER5().substring(0, 1);
    }

    public void setTitle01c(String source) {
        getComen1ai()
                .setOFFILLER5(
                        StringUtils.overlay(getComen1ai().getOFFILLER5(),
                                source, 0, 1));
    }

    public String getTitle01p() {
        return getComen1ai().getOFFILLER5().substring(1, 2);
    }
    ...
    public String getTitle01h() {
        return getComen1ai().getOFFILLER5().substring(2, 3);
    }
    ...
    public String getTitle01v() {
        return getComen1ai().getOFFILLER5().substring(3);
    }
    ...
    public String getOFFILLER4() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getCurdatel());
        tempByteBuffer1.flip();
        String temp3 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp3 + getComen1ai().getCurdatef();
    }
    ...
    public void setOFFILLER4(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setCurdatel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getCurdatec() {
        return getComen1ai().getOFFILLER7().substring(0, 1);
    }

    public void setCurdatec(String source) {
        getComen1ai()
                .setOFFILLER7(
                        StringUtils.overlay(getComen1ai().getOFFILLER7(),
                                source, 0, 1));
    }

    public String getCurdatep() {
        return getComen1ai().getOFFILLER7().substring(1, 2);
    }
    ...
    public String getCurdateh() {
        return getComen1ai().getOFFILLER7().substring(2, 3);
    }
    ...
    public String getCurdatev() {
        return getComen1ai().getOFFILLER7().substring(3);
    }
    ...
    public String getOFFILLER5() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getPgmnamel());
        tempByteBuffer1.flip();
        String temp4 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp4 + getComen1ai().getPgmnamef();
    }
    ...
    public void setOFFILLER5(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setPgmnamel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getPgmnamec() {
        return getComen1ai().getOFFILLER9().substring(0, 1);
    }

    public void setPgmnamec(String source) {
        getComen1ai()
                .setOFFILLER9(
                        StringUtils.overlay(getComen1ai().getOFFILLER9(),
                                source, 0, 1));
    }

    public String getPgmnamep() {
        return getComen1ai().getOFFILLER9().substring(1, 2);
    }
    ...
    public String getPgmnameh() {
        return getComen1ai().getOFFILLER9().substring(2, 3);
    }
    ...
    public String getPgmnamev() {
        return getComen1ai().getOFFILLER9().substring(3);
    }
    ...
    public String getOFFILLER6() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getTitle02l());
        tempByteBuffer1.flip();
        String temp5 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp5 + getComen1ai().getTitle02f();
    }
    ...
    public void setOFFILLER6(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setTitle02l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getTitle02c() {
        return getComen1ai().getOFFILLER11().substring(0, 1);
    }

    public void setTitle02c(String source) {
        getComen1ai().setOFFILLER11(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER11(), source, 0, 1));
    }

    public String getTitle02p() {
        return getComen1ai().getOFFILLER11().substring(1, 2);
    }

    public void setTitle02p(String source) {
        getComen1ai().setOFFILLER11(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER11(), source, 1, 2));
    }

    public String getTitle02h() {
        return getComen1ai().getOFFILLER11().substring(2, 3);
    }

    public void setTitle02h(String source) {
        getComen1ai().setOFFILLER11(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER11(), source, 2, 3));
    }

    public String getTitle02v() {
        return getComen1ai().getOFFILLER11().substring(3);
    }

    public void setTitle02v(String source) {
        getComen1ai().setOFFILLER11(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER11(), source, 3, 4));
    }
    ...
    public String getOFFILLER7() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getCurtimel());
        tempByteBuffer1.flip();
        String temp6 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp6 + getComen1ai().getCurtimef();
    }
    ...
    public void setOFFILLER7(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setCurtimel(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getCurtimec() {
        return getComen1ai().getOFFILLER13().substring(0, 1);
    }

    public void setCurtimec(String source) {
        getComen1ai().setOFFILLER13(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER13(), source, 0, 1));
    }

    public String getCurtimep() {
        return getComen1ai().getOFFILLER13().substring(1, 2);
    }

    public void setCurtimep(String source) {
        getComen1ai().setOFFILLER13(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER13(), source, 1, 2));
    }

    public String getCurtimeh() {
        return getComen1ai().getOFFILLER13().substring(2, 3);
    }

    public void setCurtimeh(String source) {
        getComen1ai().setOFFILLER13(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER13(), source, 2, 3));
    }

    public String getCurtimev() {
        return getComen1ai().getOFFILLER13().substring(3);
    }

    public void setCurtimev(String source) {
        getComen1ai().setOFFILLER13(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER13(), source, 3, 4));
    }
    ...
    public String getOFFILLER8() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn001l());
        tempByteBuffer1.flip();
        String temp7 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp7 + getComen1ai().getOptn001f();
    }
    ...
    public void setOFFILLER8(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn001l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn001c() {
        return getComen1ai().getOFFILLER15().substring(0, 1);
    }

    public void setOptn001c(String source) {
        getComen1ai().setOFFILLER15(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER15(), source, 0, 1));
    }

    public String getOptn001p() {
        return getComen1ai().getOFFILLER15().substring(1, 2);
    }

    public void setOptn001p(String source) {
        getComen1ai().setOFFILLER15(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER15(), source, 1, 2));
    }

    public String getOptn001h() {
        return getComen1ai().getOFFILLER15().substring(2, 3);
    }

    public void setOptn001h(String source) {
        getComen1ai().setOFFILLER15(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER15(), source, 2, 3));
    }

    public String getOptn001v() {
        return getComen1ai().getOFFILLER15().substring(3);
    }

    public void setOptn001v(String source) {
        getComen1ai().setOFFILLER15(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER15(), source, 3, 4));
    }
    ...
    public String getOFFILLER9() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn002l());
        tempByteBuffer1.flip();
        String temp8 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp8 + getComen1ai().getOptn002f();
    }
    ...
    public void setOFFILLER9(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn002l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn002c() {
        return getComen1ai().getOFFILLER17().substring(0, 1);
    }

    public void setOptn002c(String source) {
        getComen1ai().setOFFILLER17(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER17(), source, 0, 1));
    }

    public String getOptn002p() {
        return getComen1ai().getOFFILLER17().substring(1, 2);
    }

    public void setOptn002p(String source) {
        getComen1ai().setOFFILLER17(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER17(), source, 1, 2));
    }

    public String getOptn002h() {
        return getComen1ai().getOFFILLER17().substring(2, 3);
    }

    public void setOptn002h(String source) {
        getComen1ai().setOFFILLER17(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER17(), source, 2, 3));
    }

    public String getOptn002v() {
        return getComen1ai().getOFFILLER17().substring(3);
    }

    public void setOptn002v(String source) {
        getComen1ai().setOFFILLER17(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER17(), source, 3, 4));
    }
    ...
    public String getOFFILLER10() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn003l());
        tempByteBuffer1.flip();
        String temp9 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp9 + getComen1ai().getOptn003f();
    }
    ...
    public void setOFFILLER10(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn003l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn003c() {
        return getComen1ai().getOFFILLER19().substring(0, 1);
    }

    public void setOptn003c(String source) {
        getComen1ai().setOFFILLER19(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER19(), source, 0, 1));
    }

    public String getOptn003p() {
        return getComen1ai().getOFFILLER19().substring(1, 2);
    }

    public void setOptn003p(String source) {
        getComen1ai().setOFFILLER19(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER19(), source, 1, 2));
    }

    public String getOptn003h() {
        return getComen1ai().getOFFILLER19().substring(2, 3);
    }

    public void setOptn003h(String source) {
        getComen1ai().setOFFILLER19(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER19(), source, 2, 3));
    }

    public String getOptn003v() {
        return getComen1ai().getOFFILLER19().substring(3);
    }

    public void setOptn003v(String source) {
        getComen1ai().setOFFILLER19(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER19(), source, 3, 4));
    }
    ...
    public String getOFFILLER11() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn004l());
        tempByteBuffer1.flip();
        String temp10 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp10 + getComen1ai().getOptn004f();
    }
    ...
    public void setOFFILLER11(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn004l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn004c() {
        return getComen1ai().getOFFILLER21().substring(0, 1);
    }

    public void setOptn004c(String source) {
        getComen1ai().setOFFILLER21(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER21(), source, 0, 1));
    }

    public String getOptn004p() {
        return getComen1ai().getOFFILLER21().substring(1, 2);
    }

    public void setOptn004p(String source) {
        getComen1ai().setOFFILLER21(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER21(), source, 1, 2));
    }

    public String getOptn004h() {
        return getComen1ai().getOFFILLER21().substring(2, 3);
    }

    public void setOptn004h(String source) {
        getComen1ai().setOFFILLER21(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER21(), source, 2, 3));
    }

    public String getOptn004v() {
        return getComen1ai().getOFFILLER21().substring(3);
    }

    public void setOptn004v(String source) {
        getComen1ai().setOFFILLER21(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER21(), source, 3, 4));
    }
    ...
    public String getOFFILLER12() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn005l());
        tempByteBuffer1.flip();
        String temp11 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp11 + getComen1ai().getOptn005f();
    }
    ...
    public void setOFFILLER12(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn005l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn005c() {
        return getComen1ai().getOFFILLER23().substring(0, 1);
    }

    public void setOptn005c(String source) {
        getComen1ai().setOFFILLER23(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER23(), source, 0, 1));
    }

    public String getOptn005p() {
        return getComen1ai().getOFFILLER23().substring(1, 2);
    }

    public void setOptn005p(String source) {
        getComen1ai().setOFFILLER23(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER23(), source, 1, 2));
    }

    public String getOptn005h() {
        return getComen1ai().getOFFILLER23().substring(2, 3);
    }

    public void setOptn005h(String source) {
        getComen1ai().setOFFILLER23(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER23(), source, 2, 3));
    }

    public String getOptn005v() {
        return getComen1ai().getOFFILLER23().substring(3);
    }

    public void setOptn005v(String source) {
        getComen1ai().setOFFILLER23(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER23(), source, 3, 4));
    }
    ...
    public String getOFFILLER13() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn006l());
        tempByteBuffer1.flip();
        String temp12 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp12 + getComen1ai().getOptn006f();
    }
    ...
    public void setOFFILLER13(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn006l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn006c() {
        return getComen1ai().getOFFILLER25().substring(0, 1);
    }

    public void setOptn006c(String source) {
        getComen1ai().setOFFILLER25(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER25(), source, 0, 1));
    }

    public String getOptn006p() {
        return getComen1ai().getOFFILLER25().substring(1, 2);
    }

    public void setOptn006p(String source) {
        getComen1ai().setOFFILLER25(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER25(), source, 1, 2));
    }

    public String getOptn006h() {
        return getComen1ai().getOFFILLER25().substring(2, 3);
    }

    public void setOptn006h(String source) {
        getComen1ai().setOFFILLER25(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER25(), source, 2, 3));
    }

    public String getOptn006v() {
        return getComen1ai().getOFFILLER25().substring(3);
    }

    public void setOptn006v(String source) {
        getComen1ai().setOFFILLER25(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER25(), source, 3, 4));
    }
    ...
    public String getOFFILLER14() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn007l());
        tempByteBuffer1.flip();
        String temp13 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp13 + getComen1ai().getOptn007f();
    }
    ...
    public void setOFFILLER14(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn007l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn007c() {
        return getComen1ai().getOFFILLER27().substring(0, 1);
    }

    public void setOptn007c(String source) {
        getComen1ai().setOFFILLER27(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER27(), source, 0, 1));
    }

    public String getOptn007p() {
        return getComen1ai().getOFFILLER27().substring(1, 2);
    }

    public void setOptn007p(String source) {
        getComen1ai().setOFFILLER27(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER27(), source, 1, 2));
    }

    public String getOptn007h() {
        return getComen1ai().getOFFILLER27().substring(2, 3);
    }

    public void setOptn007h(String source) {
        getComen1ai().setOFFILLER27(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER27(), source, 2, 3));
    }

    public String getOptn007v() {
        return getComen1ai().getOFFILLER27().substring(3);
    }

    public void setOptn007v(String source) {
        getComen1ai().setOFFILLER27(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER27(), source, 3, 4));
    }
    ...
    public String getOFFILLER15() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn008l());
        tempByteBuffer1.flip();
        String temp14 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp14 + getComen1ai().getOptn008f();
    }
    ...
    public void setOFFILLER15(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn008l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn008c() {
        return getComen1ai().getOFFILLER29().substring(0, 1);
    }

    public void setOptn008c(String source) {
        getComen1ai().setOFFILLER29(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER29(), source, 0, 1));
    }

    public String getOptn008p() {
        return getComen1ai().getOFFILLER29().substring(1, 2);
    }

    public void setOptn008p(String source) {
        getComen1ai().setOFFILLER29(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER29(), source, 1, 2));
    }

    public String getOptn008h() {
        return getComen1ai().getOFFILLER29().substring(2, 3);
    }

    public void setOptn008h(String source) {
        getComen1ai().setOFFILLER29(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER29(), source, 2, 3));
    }

    public String getOptn008v() {
        return getComen1ai().getOFFILLER29().substring(3);
    }

    public void setOptn008v(String source) {
        getComen1ai().setOFFILLER29(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER29(), source, 3, 4));
    }
    ...
    public String getOFFILLER16() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn009l());
        tempByteBuffer1.flip();
        String temp15 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp15 + getComen1ai().getOptn009f();
    }
    ...
    public void setOFFILLER16(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn009l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn009c() {
        return getComen1ai().getOFFILLER31().substring(0, 1);
    }

    public void setOptn009c(String source) {
        getComen1ai().setOFFILLER31(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER31(), source, 0, 1));
    }

    public String getOptn009p() {
        return getComen1ai().getOFFILLER31().substring(1, 2);
    }

    public void setOptn009p(String source) {
        getComen1ai().setOFFILLER31(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER31(), source, 1, 2));
    }

    public String getOptn009h() {
        return getComen1ai().getOFFILLER31().substring(2, 3);
    }

    public void setOptn009h(String source) {
        getComen1ai().setOFFILLER31(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER31(), source, 2, 3));
    }

    public String getOptn009v() {
        return getComen1ai().getOFFILLER31().substring(3);
    }

    public void setOptn009v(String source) {
        getComen1ai().setOFFILLER31(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER31(), source, 3, 4));
    }
    ...
    public String getOFFILLER17() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn010l());
        tempByteBuffer1.flip();
        String temp16 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp16 + getComen1ai().getOptn010f();
    }
    ...
    public void setOFFILLER17(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn010l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn010c() {
        return getComen1ai().getOFFILLER33().substring(0, 1);
    }

    public void setOptn010c(String source) {
        getComen1ai().setOFFILLER33(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER33(), source, 0, 1));
    }

    public String getOptn010p() {
        return getComen1ai().getOFFILLER33().substring(1, 2);
    }

    public void setOptn010p(String source) {
        getComen1ai().setOFFILLER33(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER33(), source, 1, 2));
    }

    public String getOptn010h() {
        return getComen1ai().getOFFILLER33().substring(2, 3);
    }

    public void setOptn010h(String source) {
        getComen1ai().setOFFILLER33(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER33(), source, 2, 3));
    }

    public String getOptn010v() {
        return getComen1ai().getOFFILLER33().substring(3);
    }

    public void setOptn010v(String source) {
        getComen1ai().setOFFILLER33(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER33(), source, 3, 4));
    }
    ...
    public String getOFFILLER18() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn011l());
        tempByteBuffer1.flip();
        String temp17 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp17 + getComen1ai().getOptn011f();
    }
    ...
    public void setOFFILLER18(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn011l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn011c() {
        return getComen1ai().getOFFILLER35().substring(0, 1);
    }

    public void setOptn011c(String source) {
        getComen1ai().setOFFILLER35(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER35(), source, 0, 1));
    }

    public String getOptn011p() {
        return getComen1ai().getOFFILLER35().substring(1, 2);
    }

    public void setOptn011p(String source) {
        getComen1ai().setOFFILLER35(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER35(), source, 1, 2));
    }

    public String getOptn011h() {
        return getComen1ai().getOFFILLER35().substring(2, 3);
    }

    public void setOptn011h(String source) {
        getComen1ai().setOFFILLER35(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER35(), source, 2, 3));
    }

    public String getOptn011v() {
        return getComen1ai().getOFFILLER35().substring(3);
    }

    public void setOptn011v(String source) {
        getComen1ai().setOFFILLER35(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER35(), source, 3, 4));
    }
    ...
    public String getOFFILLER19() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptn012l());
        tempByteBuffer1.flip();
        String temp18 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp18 + getComen1ai().getOptn012f();
    }
    ...
    public void setOFFILLER19(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptn012l(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptn012c() {
        return getComen1ai().getOFFILLER37().substring(0, 1);
    }

    public void setOptn012c(String source) {
        getComen1ai().setOFFILLER37(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER37(), source, 0, 1));
    }

    public String getOptn012p() {
        return getComen1ai().getOFFILLER37().substring(1, 2);
    }

    public void setOptn012p(String source) {
        getComen1ai().setOFFILLER37(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER37(), source, 1, 2));
    }

    public String getOptn012h() {
        return getComen1ai().getOFFILLER37().substring(2, 3);
    }

    public void setOptn012h(String source) {
        getComen1ai().setOFFILLER37(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER37(), source, 2, 3));
    }

    public String getOptn012v() {
        return getComen1ai().getOFFILLER37().substring(3);
    }

    public void setOptn012v(String source) {
        getComen1ai().setOFFILLER37(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER37(), source, 3, 4));
    }
    ...
    public String getOFFILLER20() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getOptionl());
        tempByteBuffer1.flip();
        String temp19 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp19 + getComen1ai().getOptionf();
    }
    ...
    public void setOFFILLER20(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setOptionl(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getOptionc() {
        return getComen1ai().getOFFILLER39().substring(0, 1);
    }

    public void setOptionc(String source) {
        getComen1ai().setOFFILLER39(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER39(), source, 0, 1));
    }

    public String getOptionp() {
        return getComen1ai().getOFFILLER39().substring(1, 2);
    }

    public void setOptionp(String source) {
        getComen1ai().setOFFILLER39(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER39(), source, 1, 2));
    }

    public String getOptionh() {
        return getComen1ai().getOFFILLER39().substring(2, 3);
    }

    public void setOptionh(String source) {
        getComen1ai().setOFFILLER39(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER39(), source, 2, 3));
    }

    public String getOptionv() {
        return getComen1ai().getOFFILLER39().substring(3);
    }

    public void setOptionv(String source) {
        getComen1ai().setOFFILLER39(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER39(), source, 3, 4));
    }
    ...
    public String getOFFILLER21() {
        ByteBuffer tempByteBuffer1;
        tempByteBuffer1 = ByteBuffer.allocate(Short.BYTES);
        tempByteBuffer1.putShort((short) getComen1ai().getErrmsgl());
        tempByteBuffer1.flip();
        String temp20 = StandardCharsets.ISO_8859_1.decode(tempByteBuffer1)
                .toString();
        return temp20 + getComen1ai().getErrmsgf();
    }
    ...
    public void setOFFILLER21(String source) {
        ...
        try {
            ...
            tempByteBuffer1.put(source.substring(0, 2).getBytes(
                    StandardCharsets.ISO_8859_1));
            tempByteBuffer1.flip();
            getComen1ai().setErrmsgl(tempByteBuffer1.getShort());
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
    ...
    public String getErrmsgc() {
        return getComen1ai().getOFFILLER41().substring(0, 1);
    }

    public void setErrmsgc(String source) {
        getComen1ai().setOFFILLER41(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER41(), source, 0, 1));
    }

    public String getErrmsgp() {
        return getComen1ai().getOFFILLER41().substring(1, 2);
    }

    public void setErrmsgp(String source) {
        getComen1ai().setOFFILLER41(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER41(), source, 1, 2));
    }

    public String getErrmsgh() {
        return getComen1ai().getOFFILLER41().substring(2, 3);
    }

    public void setErrmsgh(String source) {
        getComen1ai().setOFFILLER41(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER41(), source, 2, 3));
    }

    public String getErrmsgv() {
        return getComen1ai().getOFFILLER41().substring(3);
    }

    public void setErrmsgv(String source) {
        getComen1ai().setOFFILLER41(
                StringUtils
                        .overlay(getComen1ai().getOFFILLER41(), source, 3, 4));
    }
    ...
    private @Getter @Setter Comen01cCcdaScreenTitle ccdaScreenTitle = new Comen01cCcdaScreenTitle();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:15:58 CDT 
    // *                                                                 
    //       *COPY CSDAT01Y.                                                   
    ...
    private @Getter @Setter Comen01cWsDateTime wsDateTime = new Comen01cWsDateTime();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:15:58 CDT 
    // *                                                                 
    //       *COPY CSMSG01Y.                                                   
    ...
    private @Getter @Setter Comen01cCcdaCommonMessages ccdaCommonMessages = new Comen01cCcdaCommonMessages();
    // *                                                                 
    // * Ver: CardDemo_v1.0-15-g27d6c6f-68 Date: 2022-07-19 23:15:58 CDT 
    // *                                                                 
    //       *COPY CSUSR01Y.                                                   
    ...
    private @Getter @Setter Comen01cSecUserData secUserData = new Comen01cSecUserData();
    // *                                                                 
    ...
    private @Getter @Setter Comen01cDfhaid dfhaid = new Comen01cDfhaid();
    //       *COPY DFHBMSCA.                                                   
    // *(/home/oflab/repository/ref/COBOL_COPYBOOK/.default/DFHBMSCA.cpy)
    // [T-Up#INFO][DFHBMSCA.cpy, LINE #2] DFHBMSCA (level: 1)
    private @Getter @Setter Comen01cDfhbmsca dfhbmsca = new Comen01cDfhbmsca();
    // *----------------------------------------------------------------*
    // *                        LINKAGE SECTION                          
    // *----------------------------------------------------------------*
    // [T-Up#INFO][COMEN01C.cbl, LINE #67] DFHCOMMAREA (level: 1)
