 ...
 * <li>file operation class: {@link Cbact01cFileOpAcctfileFile}</li>
...
public class Cbact01cFdAcctfileFile extends Cbact01cFileOpAcctfileFile {
    ...
    public void open(OpenFrameContext context) {
        ...
        context.initFileWriteBuffer("Cbact01c", "AcctfileFile");
        committer.setThreshold(5000);
    }

    public void start(OpenFrameContext context, Long key, KeyOperationType type) {
        Cbact01cFdAcctfileRec startPoint = new Cbact01cFdAcctfileRec();
        startPoint.setFdAcctId(key);
        AwsM2CarddemoAcctdataVsamKsdsDto dto = Cbact01cMapperInterface.Cbact01cFdAcctfileRecKeyToAwsM2CarddemoAcctdataVsamKsdsDto.INSTANCE
                .toTarget(startPoint);
        switch (type) {
        case EQ:
        case GTEQ: {
    ...
    public Cbact01cFdAcctfileRec readNextRecord(OpenFrameContext context) {
        ...
        if (iterator.hasNext()) {
            ...
            setFileStatus(context, FileStatus.NORMAL);
            return Cbact01cMapperInterface.Cbact01cFdAcctfileRecToAwsM2CarddemoAcctdataVsamKsdsDto.INSTANCE
                    .toSource(nextRecord);
        } else {
            setFileStatus(context, FileStatus.AT_END_CONDITION_SEQ_READ);
            return null;
    ...
    public Cbact01cFdAcctfileRec readKey(OpenFrameContext context, Long key) {
        commit(context);
        Cbact01cFdAcctfileRec readKeyPoint = new Cbact01cFdAcctfileRec();
    ...
    public void write(OpenFrameContext context, Cbact01cFdAcctfileRec data) {
        List<AwsM2CarddemoAcctdataVsamKsdsDto> writeBuffer = getWriteBuffer(context);
        writeBuffer
                .add(Cbact01cMapperInterface.Cbact01cFdAcctfileRecToAwsM2CarddemoAcctdataVsamKsdsDto.INSTANCE
                        .toTarget(data));
    ...
    public void rewrite(OpenFrameContext context, Cbact01cFdAcctfileRec data,
            Long key) {
        commit(context);
        data.setFdAcctId(key);
        AwsM2CarddemoAcctdataVsamKsdsDto updateDto = Cbact01cMapperInterface.Cbact01cFdAcctfileRecToAwsM2CarddemoAcctdataVsamKsdsDto.INSTANCE
                .toTarget(data);
        dao.flush();
    ...
    public void delete(OpenFrameContext context, Long key) {
        ...
        commit(context);
        Cbact01cFdAcctfileRec deletePoint = new Cbact01cFdAcctfileRec();
    ...
    private void setIterator(OpenFrameContext context,
        ...
        context.setFileIterator("Cbact01c", "AcctfileFile", iterator);
    }

    private Iterator<AwsM2CarddemoAcctdataVsamKsdsDto> getIterator(
            OpenFrameContext context) {
        return context.getFileIterator("Cbact01c", "AcctfileFile");
    }

    private List<AwsM2CarddemoAcctdataVsamKsdsDto> getWriteBuffer(
            OpenFrameContext context) {
        return context.getFileWriteBuffer("Cbact01c", "AcctfileFile");
    }
}
