...
public @AllArgsConstructor @NoArgsConstructor class Cotrn00cWsVariables {
    // [T-Up#INFO][COTRN00C.cbl, LINE #36] WS-PGMNAME (level: 5)
    private @Getter String wsPgmname = "COTRN00C";
    // [T-Up#INFO][COTRN00C.cbl, LINE #37] WS-TRANID (level: 5)
    private @Getter String wsTranid = "CT00";
    // [T-Up#INFO][COTRN00C.cbl, LINE #38] WS-MESSAGE (level: 5)
    private @Getter String wsMessage = StringUtils.repeat(' ', 80);
    // [T-Up#INFO][COTRN00C.cbl, LINE #39] WS-TRANSACT-FILE (level: 5)
    private @Getter String wsTransactFile = "TRANSACT";
    // [T-Up#INFO][COTRN00C.cbl, LINE #40] WS-ERR-FLG (level: 5)
    private @Getter String wsErrFlg = "N";
    // [T-Up#INFO][COTRN00C.cbl, LINE #41] ERR-FLG-ON (level: 88)
    public static final String ERR_FLG_ON = "Y";
    // [T-Up#INFO][COTRN00C.cbl, LINE #42] ERR-FLG-OFF (level: 88)
    public static final String ERR_FLG_OFF = "N";
    // [T-Up#INFO][COTRN00C.cbl, LINE #43] WS-TRANSACT-EOF (level: 5)
    private @Getter String wsTransactEof = "N";
    // [T-Up#INFO][COTRN00C.cbl, LINE #44] TRANSACT-EOF (level: 88)
    public static final String TRANSACT_EOF = "Y";
    // [T-Up#INFO][COTRN00C.cbl, LINE #45] TRANSACT-NOT-EOF (level: 88)
    public static final String TRANSACT_NOT_EOF = "N";
    // [T-Up#INFO][COTRN00C.cbl, LINE #46] WS-SEND-ERASE-FLG (level: 5)
    private @Getter String wsSendEraseFlg = "Y";
    // [T-Up#INFO][COTRN00C.cbl, LINE #47] SEND-ERASE-YES (level: 88)
    public static final String SEND_ERASE_YES = "Y";
    // [T-Up#INFO][COTRN00C.cbl, LINE #48] SEND-ERASE-NO (level: 88)
    public static final String SEND_ERASE_NO = "N";
    // [T-Up#INFO][COTRN00C.cbl, LINE #50] WS-RESP-CD (level: 5)
    private @Getter @Setter int wsRespCd = 0;
    // [T-Up#INFO][COTRN00C.cbl, LINE #51] WS-REAS-CD (level: 5)
    private @Getter @Setter int wsReasCd = 0;
    // [T-Up#INFO][COTRN00C.cbl, LINE #52] WS-REC-COUNT (level: 5)
    private @Getter @Setter int wsRecCount = 0;
    // [T-Up#INFO][COTRN00C.cbl, LINE #53] WS-IDX (level: 5)
    private @Getter @Setter int wsIdx = 0;
    // [T-Up#INFO][COTRN00C.cbl, LINE #54] WS-PAGE-NUM (level: 5)
    private @Getter @Setter int wsPageNum = 0;
    // [T-Up#INFO][COTRN00C.cbl, LINE #56] WS-TRAN-AMT (level: 5)
    ...
    // [T-Up#INFO][COTRN00C.cbl, LINE #57] WS-TRAN-DATE (level: 5)
