...
public @AllArgsConstructor @NoArgsConstructor class Cobil00cWsVariables {
    // [T-Up#INFO][COBIL00C.cbl, LINE #37] WS-PGMNAME (level: 5)
    private @Getter String wsPgmname = "COBIL00C";
    // [T-Up#INFO][COBIL00C.cbl, LINE #38] WS-TRANID (level: 5)
    private @Getter String wsTranid = "CB00";
    // [T-Up#INFO][COBIL00C.cbl, LINE #39] WS-MESSAGE (level: 5)
    private @Getter String wsMessage = StringUtils.repeat(' ', 80);
    // [T-Up#INFO][COBIL00C.cbl, LINE #40] WS-TRANSACT-FILE (level: 5)
    private @Getter String wsTransactFile = "TRANSACT";
    // [T-Up#INFO][COBIL00C.cbl, LINE #41] WS-ACCTDAT-FILE (level: 5)
    private @Getter String wsAcctdatFile = "ACCTDAT ";
    // [T-Up#INFO][COBIL00C.cbl, LINE #42] WS-CXACAIX-FILE (level: 5)
    private @Getter String wsCxacaixFile = "CXACAIX ";
    // [T-Up#INFO][COBIL00C.cbl, LINE #43] WS-ERR-FLG (level: 5)
    private @Getter String wsErrFlg = "N";
    // [T-Up#INFO][COBIL00C.cbl, LINE #44] ERR-FLG-ON (level: 88)
    public static final String ERR_FLG_ON = "Y";
    // [T-Up#INFO][COBIL00C.cbl, LINE #45] ERR-FLG-OFF (level: 88)
    public static final String ERR_FLG_OFF = "N";
    // [T-Up#INFO][COBIL00C.cbl, LINE #46] WS-RESP-CD (level: 5)
    private @Getter @Setter int wsRespCd = 0;
    // [T-Up#INFO][COBIL00C.cbl, LINE #47] WS-REAS-CD (level: 5)
    private @Getter @Setter int wsReasCd = 0;
    // [T-Up#INFO][COBIL00C.cbl, LINE #48] WS-USR-MODIFIED (level: 5)
    private @Getter String wsUsrModified = "N";
    // [T-Up#INFO][COBIL00C.cbl, LINE #49] USR-MODIFIED-YES (level: 88)
    public static final String USR_MODIFIED_YES = "Y";
    // [T-Up#INFO][COBIL00C.cbl, LINE #50] USR-MODIFIED-NO (level: 88)
    public static final String USR_MODIFIED_NO = "N";
    // [T-Up#INFO][COBIL00C.cbl, LINE #51] WS-CONF-PAY-FLG (level: 5)
    private @Getter String wsConfPayFlg = "N";
    // [T-Up#INFO][COBIL00C.cbl, LINE #52] CONF-PAY-YES (level: 88)
    public static final String CONF_PAY_YES = "Y";
    // [T-Up#INFO][COBIL00C.cbl, LINE #53] CONF-PAY-NO (level: 88)
    public static final String CONF_PAY_NO = "N";
    // [T-Up#INFO][COBIL00C.cbl, LINE #55] WS-TRAN-AMT (level: 5)
    ...
    // [T-Up#INFO][COBIL00C.cbl, LINE #56] WS-CURR-BAL (level: 5)
    ...
    // [T-Up#INFO][COBIL00C.cbl, LINE #57] WS-TRAN-ID-NUM (level: 5)
    private @Getter @Setter long wsTranIdNum = (long) 0;
    // [T-Up#INFO][COBIL00C.cbl, LINE #58] WS-TRAN-DATE (level: 5)
    private @Getter String wsTranDate = "00/00/00";
    // [T-Up#INFO][COBIL00C.cbl, LINE #59] WS-ABS-TIME (level: 5)
    private @Getter @Setter long wsAbsTime = (long) 0;
    // [T-Up#INFO][COBIL00C.cbl, LINE #60] WS-CUR-DATE-X10 (level: 5)
    private @Getter String wsCurDateX10 = StringUtils.repeat(' ', 10);
    // [T-Up#INFO][COBIL00C.cbl, LINE #61] WS-CUR-TIME-X08 (level: 5)
    ...
    public String toString() {
        ...
        sb.append(PictureFormatter.intFormatWithoutSign(wsTranIdNum,
                "0000000000000000"));
