...
import aws.carddemo.variable.group.CocrdlicCcrdliai;
...
@NoArgsConstructor
@AllArgsConstructor
public class CocrdlicInputDto implements SystemDtoAccessable {
  private SystemDto systemDto = new SystemDto();
  @JsonProperty("CCRDLIAI")
  private CocrdlicCcrdliai ccrdliai;
  private CocrdlicDfhcommarea dfhcommarea;
}