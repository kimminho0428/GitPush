 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cotrn00cWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter Cotrn00cWsCurdateData wsCurdateData = new Cotrn00cWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter Cotrn00cWsCurdateMmDdYy wsCurdateMmDdYy = new Cotrn00cWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter Cotrn00cWsCurtimeHhMmSs wsCurtimeHhMmSs = new Cotrn00cWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter Cotrn00cWsTimestamp wsTimestamp = new Cotrn00cWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cotrn00cWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter Cotrn00cWsCurdate wsCurdate = new Cotrn00cWsCurdate();
        ...
        private @Getter @Setter Cotrn00cWsCurtime wsCurtime = new Cotrn00cWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cotrn00cWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cotrn00cWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cotrn00cWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cotrn00cWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cotrn00cWsTimestamp {
