 ...
 * <ul>
 * <li>converted COBOL program: {@link aws.carddemo.Cbact04c}</li>
 * </ul>
 */
@Getter
@Setter
...
public class Cbact04cTasklet implements Tasklet {
    private Map<String, Dd> dd;
    private String parm;
    private final Cbact04c program;
    ...
    public RepeatStatus execute(StepContribution contribution,
        ...
        int returnValue = program.run(genericContext, parm);
