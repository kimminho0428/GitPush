 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cbact02cIoStatus {
    // [T-Up#INFO][CBACT02C.cbl, LINE #51] IO-STAT1 (level: 5)
    private @Getter String ioStat1 = StringUtils.repeat(' ', 1);
    // [T-Up#INFO][CBACT02C.cbl, LINE #52] IO-STAT2 (level: 5)
    ...
    public void set(Cbact02cCardfileStatus source) {
        ioStat1 = source.getCardfileStat1();
        ioStat2 = source.getCardfileStat2();
    }
