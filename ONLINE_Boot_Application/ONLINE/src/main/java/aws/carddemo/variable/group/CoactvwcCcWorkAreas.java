 ...
 */
public @AllArgsConstructor @NoArgsConstructor class CoactvwcCcWorkAreas {
    // [T-Up#INFO][CVCRD01Y.cpy, LINE #3] CC-WORK-AREA (level: 5)
    private @Getter @Setter CoactvwcCcWorkArea ccWorkArea = new CoactvwcCcWorkArea();
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactvwcCcWorkArea {
        ...
        public static CoactvwcCcWorkArea createDefaultValueInstance() {
            return new CoactvwcCcWorkArea.builder()
