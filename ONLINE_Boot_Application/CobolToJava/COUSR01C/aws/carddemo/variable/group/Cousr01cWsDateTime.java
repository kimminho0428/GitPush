 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cousr01cWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter Cousr01cWsCurdateData wsCurdateData = new Cousr01cWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter Cousr01cWsCurdateMmDdYy wsCurdateMmDdYy = new Cousr01cWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter Cousr01cWsCurtimeHhMmSs wsCurtimeHhMmSs = new Cousr01cWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter Cousr01cWsTimestamp wsTimestamp = new Cousr01cWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr01cWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter Cousr01cWsCurdate wsCurdate = new Cousr01cWsCurdate();
        ...
        private @Getter @Setter Cousr01cWsCurtime wsCurtime = new Cousr01cWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cousr01cWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class Cousr01cWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr01cWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr01cWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr01cWsTimestamp {
