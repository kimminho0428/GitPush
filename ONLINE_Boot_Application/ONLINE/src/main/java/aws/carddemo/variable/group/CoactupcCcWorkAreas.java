 ...
 */
public @AllArgsConstructor @NoArgsConstructor class CoactupcCcWorkAreas {
    // [T-Up#INFO][CVCRD01Y.cpy, LINE #3] CC-WORK-AREA (level: 5)
    private @Getter @Setter CoactupcCcWorkArea ccWorkArea = new CoactupcCcWorkArea();
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class CoactupcCcWorkArea {
        ...
        public static CoactupcCcWorkArea createDefaultValueInstance() {
            return new CoactupcCcWorkArea.builder()
