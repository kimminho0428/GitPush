 ...
 */
public @AllArgsConstructor @NoArgsConstructor class CocrdlicWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter CocrdlicWsCurdateData wsCurdateData = new CocrdlicWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter CocrdlicWsCurdateMmDdYy wsCurdateMmDdYy = new CocrdlicWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter CocrdlicWsCurtimeHhMmSs wsCurtimeHhMmSs = new CocrdlicWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter CocrdlicWsTimestamp wsTimestamp = new CocrdlicWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdlicWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter CocrdlicWsCurdate wsCurdate = new CocrdlicWsCurdate();
        ...
        private @Getter @Setter CocrdlicWsCurtime wsCurtime = new CocrdlicWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class CocrdlicWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class CocrdlicWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdlicWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdlicWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CocrdlicWsTimestamp {
