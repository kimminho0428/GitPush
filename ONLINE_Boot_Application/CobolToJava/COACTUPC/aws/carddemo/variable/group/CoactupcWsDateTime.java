 ...
 */
public @AllArgsConstructor @NoArgsConstructor class CoactupcWsDateTime {
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #19] WS-CURDATE-DATA (level: 5)
    private @Getter @Setter CoactupcWsCurdateData wsCurdateData = new CoactupcWsCurdateData();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #31] WS-CURDATE-MM-DD-YY (level: 5)
    private @Getter @Setter CoactupcWsCurdateMmDdYy wsCurdateMmDdYy = new CoactupcWsCurdateMmDdYy();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #37] WS-CURTIME-HH-MM-SS (level: 5)
    private @Getter @Setter CoactupcWsCurtimeHhMmSs wsCurtimeHhMmSs = new CoactupcWsCurtimeHhMmSs();
    // [T-Up#INFO][CSDAT01Y.cpy, LINE #43] WS-TIMESTAMP (level: 5)
    private @Getter @Setter CoactupcWsTimestamp wsTimestamp = new CoactupcWsTimestamp();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CoactupcWsCurdateData {
        // [T-Up#INFO][CSDAT01Y.cpy, LINE #20] WS-CURDATE (level: 10)
        private @Getter @Setter CoactupcWsCurdate wsCurdate = new CoactupcWsCurdate();
        ...
        private @Getter @Setter CoactupcWsCurtime wsCurtime = new CoactupcWsCurtime();
        ...
        public static @AllArgsConstructor @NoArgsConstructor class CoactupcWsCurdate {
        ...
        public static @AllArgsConstructor @NoArgsConstructor class CoactupcWsCurtime {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CoactupcWsCurdateMmDdYy {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CoactupcWsCurtimeHhMmSs {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CoactupcWsTimestamp {
